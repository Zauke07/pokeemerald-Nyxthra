...
#define OW_FLAG_NO_ENCOUNTER        FLAG_UNUSED_0x26A  // Wenn gesetzt, gibt es keine wilden Begegnungen.
...
#define OW_FLAG_POKE_RIDER          FLAG_UNUSED_0x269  // Wenn gesetzt, kann man per Pokenav oder Town Map mit 'R' fliegen.
