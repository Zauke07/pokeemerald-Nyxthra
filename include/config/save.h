...
#define FREE_UNION_ROOM_CHAT                FALSE   // Gibt Union Room Chat frei (212 Bytes).
#define FREE_ENIGMA_BERRY                   FALSE   // Gibt E-Reader Enigma Berry Daten frei (52 Bytes).
#define FREE_LINK_BATTLE_RECORDS            FALSE   // Gibt Link Battle Record Daten frei (88 Bytes).
...
#define FREE_BATTLE_TOWER_E_READER          FALSE   // Gibt Battle Tower E-Reader Daten frei (188 Bytes).
#define FREE_POKEMON_JUMP                   FALSE   // Gibt Pokémon Jump Daten frei (16 Bytes).
#define FREE_RECORD_MIXING_HALL_RECORDS     FALSE   // Gibt Hall Records für Record Mixing frei (1032 Bytes).
