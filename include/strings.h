...
extern const u8 gText_ExpandedPlaceholder_Hilda[];
extern const u8 gText_ExpandedPlaceholder_Nate[];
extern const u8 gText_ExpandedPlaceholder_Rosa[];
extern const u8 gText_ExpandedPlaceholder_Calem[];
extern const u8 gText_ExpandedPlaceholder_Serena[];
extern const u8 gText_ExpandedPlaceholder_Elio[];
extern const u8 gText_ExpandedPlaceholder_Selene[];
extern const u8 gText_ExpandedPlaceholder_Victor[];
extern const u8 gText_ExpandedPlaceholder_Gloria[];
extern const u8 gText_ExpandedPlaceholder_Florian[];
...
extern const u8 gText_ManualEvolution[];
extern const u8 gText_ManualEvolveOn[];
extern const u8 gText_ManualEvolveOff[];
extern const u8 gText_ManualEvolvePrompt[];
...
extern const u8 gText_GameVersionPrefix[];
extern const u8 gText_GameVersion[];
extern const u8 gText_GameVersionSpacer[];
extern const u8 gText_GameVersionSuffix[];
...
extern const u8 gText_ObjGfxIdAndStyle[];
extern const u8 gText_DebugObjGfxId[];
extern const u8 gText_ObjGfxIdExpanded[];
extern const u8 gText_Debug_PlayerFlags[];
...
extern const u8 gText_ChooseFollower[];
extern const u8 gText_ReplaceFollower[];
extern const u8 gText_RemoveFollower[];
...
// Starter Regional
extern const u8 gText_WhichStarterRegion[];
extern const u8 gText_Kanto[];
...
extern const u8 gText_DebugChatGPTTransition[];


//Neue Debug texte
extern const u8 gText_FlagIsSet[];
extern const u8 gText_FlagNotSet[];
extern const u8 gText_DebugAvatarState[];
extern const u8 gText_DebugAvatarState1[];
extern const u8 gText_DebugAvatarState2[];
extern const u8 gText_DebugAvatarState3[];
extern const u8 gText_DebugAvatarState4[];
extern const u8 gText_DebugAvatarState5[];
extern const u8 gText_DebugAvatarState6[];
extern const u8 gText_DebugAvatarFull[];
extern const u8 gText_TransitionMugshot[];
extern const u8 gText_TransitionMagma[];
extern const u8 gText_TransitionAqua[];
extern const u8 gText_TransitionChatGPTRequested[];
extern const u8 gText_TransitionStandardTrainer[];
extern const u8 gText_BattleTransitionStartOnField[];

//Musik Testlabor
extern const u8 gText_PlayMusicChoice[];


extern const u8 gText_MUS_DUMMY[];
extern const u8 gText_MUS_LITTLEROOT_TEST[];
extern const u8 gText_MUS_GSC_ROUTE38[];
extern const u8 gText_MUS_CAUGHT[];
extern const u8 gText_MUS_VICTORY_WILD[];
extern const u8 gText_MUS_VICTORY_GYM_LEADER[];
extern const u8 gText_MUS_VICTORY_LEAGUE[];
extern const u8 gText_MUS_C_COMM_CENTER[];
extern const u8 gText_MUS_GSC_PEWTER[];
extern const u8 gText_MUS_C_VS_LEGEND_BEAST[];
extern const u8 gText_MUS_ROUTE101[];
extern const u8 gText_MUS_ROUTE110[];
extern const u8 gText_MUS_ROUTE120[];
extern const u8 gText_MUS_PETALBURG[];
extern const u8 gText_MUS_OLDALE[];
extern const u8 gText_MUS_GYM[];
extern const u8 gText_MUS_SURF[];
extern const u8 gText_MUS_PETALBURG_WOODS[];
extern const u8 gText_MUS_LEVEL_UP[];
extern const u8 gText_MUS_HEAL[];
extern const u8 gText_MUS_OBTAIN_BADGE[];
extern const u8 gText_MUS_OBTAIN_ITEM[];
extern const u8 gText_MUS_EVOLVED[];
extern const u8 gText_MUS_OBTAIN_TMHM[];
extern const u8 gText_MUS_LILYCOVE_MUSEUM[];
extern const u8 gText_MUS_ROUTE122[];
extern const u8 gText_MUS_OCEANIC_MUSEUM[];
extern const u8 gText_MUS_EVOLUTION_INTRO[];
extern const u8 gText_MUS_EVOLUTION[];
extern const u8 gText_MUS_MOVE_DELETED[];
extern const u8 gText_MUS_ENCOUNTER_GIRL[];
extern const u8 gText_MUS_ENCOUNTER_MALE[];
extern const u8 gText_MUS_ABANDONED_SHIP[];
extern const u8 gText_MUS_FORTREE[];
extern const u8 gText_MUS_BIRCH_LAB[];
extern const u8 gText_MUS_B_TOWER_RS[];
extern const u8 gText_MUS_ENCOUNTER_SWIMMER[];
extern const u8 gText_MUS_CAVE_OF_ORIGIN[];
extern const u8 gText_MUS_OBTAIN_BERRY[];
extern const u8 gText_MUS_AWAKEN_LEGEND[];
extern const u8 gText_MUS_SLOTS_JACKPOT[];
extern const u8 gText_MUS_SLOTS_WIN[];
extern const u8 gText_MUS_TOO_BAD[];
extern const u8 gText_MUS_ROULETTE[];
extern const u8 gText_MUS_LINK_CONTEST_P1[];
extern const u8 gText_MUS_LINK_CONTEST_P2[];
extern const u8 gText_MUS_LINK_CONTEST_P3[];
extern const u8 gText_MUS_LINK_CONTEST_P4[];
extern const u8 gText_MUS_ENCOUNTER_RICH[];
extern const u8 gText_MUS_VERDANTURF[];
extern const u8 gText_MUS_RUSTBORO[];
extern const u8 gText_MUS_POKE_CENTER[];
extern const u8 gText_MUS_ROUTE104[];
extern const u8 gText_MUS_ROUTE119[];
extern const u8 gText_MUS_CYCLING[];
extern const u8 gText_MUS_POKE_MART[];
extern const u8 gText_MUS_LITTLEROOT[];
extern const u8 gText_MUS_MT_CHIMNEY[];
extern const u8 gText_MUS_ENCOUNTER_FEMALE[];
extern const u8 gText_MUS_LILYCOVE[];
extern const u8 gText_MUS_DESERT[];
extern const u8 gText_MUS_HELP[];
extern const u8 gText_MUS_UNDERWATER[];
extern const u8 gText_MUS_VICTORY_TRAINER[];
extern const u8 gText_MUS_TITLE[];
extern const u8 gText_MUS_INTRO[];
extern const u8 gText_MUS_ENCOUNTER_MAY[];
extern const u8 gText_MUS_ENCOUNTER_INTENSE[];
extern const u8 gText_MUS_ENCOUNTER_COOL[];
extern const u8 gText_MUS_ROUTE113[];
extern const u8 gText_MUS_ENCOUNTER_AQUA[];
extern const u8 gText_MUS_FOLLOW_ME[];
extern const u8 gText_MUS_ENCOUNTER_BRENDAN[];
extern const u8 gText_MUS_EVER_GRANDE[];
extern const u8 gText_MUS_ENCOUNTER_SUSPICIOUS[];
extern const u8 gText_MUS_VICTORY_AQUA_MAGMA[];
extern const u8 gText_MUS_CABLE_CAR[];
extern const u8 gText_MUS_GAME_CORNER[];
extern const u8 gText_MUS_DEWFORD[];
extern const u8 gText_MUS_SAFARI_ZONE[];
extern const u8 gText_MUS_VICTORY_ROAD[];
extern const u8 gText_MUS_AQUA_MAGMA_HIDEOUT[];
extern const u8 gText_MUS_SAILING[];
extern const u8 gText_MUS_MT_PYRE[];
extern const u8 gText_MUS_SLATEPORT[];
extern const u8 gText_MUS_MT_PYRE_EXTERIOR[];
extern const u8 gText_MUS_SCHOOL[];
extern const u8 gText_MUS_HALL_OF_FAME[];
extern const u8 gText_MUS_FALLARBOR[];
extern const u8 gText_MUS_SEALED_CHAMBER[];
extern const u8 gText_MUS_CONTEST_WINNER[];
extern const u8 gText_MUS_CONTEST[];
extern const u8 gText_MUS_ENCOUNTER_MAGMA[];
extern const u8 gText_MUS_INTRO_BATTLE[];
extern const u8 gText_MUS_ABNORMAL_WEATHER[];
extern const u8 gText_MUS_WEATHER_GROUDON[];
extern const u8 gText_MUS_SOOTOPOLIS[];
extern const u8 gText_MUS_CONTEST_RESULTS[];
extern const u8 gText_MUS_HALL_OF_FAME_ROOM[];
extern const u8 gText_MUS_TRICK_HOUSE[];
extern const u8 gText_MUS_ENCOUNTER_TWINS[];
extern const u8 gText_MUS_ENCOUNTER_ELITE_FOUR[];
extern const u8 gText_MUS_ENCOUNTER_HIKER[];
extern const u8 gText_MUS_CONTEST_LOBBY[];
extern const u8 gText_MUS_ENCOUNTER_INTERVIEWER[];
extern const u8 gText_MUS_ENCOUNTER_CHAMPION[];
extern const u8 gText_MUS_CREDITS[];
extern const u8 gText_MUS_END[];
extern const u8 gText_MUS_B_FRONTIER[];
extern const u8 gText_MUS_B_ARENA[];
extern const u8 gText_MUS_OBTAIN_B_POINTS[];
extern const u8 gText_MUS_REGISTER_MATCH_CALL[];
extern const u8 gText_MUS_B_PYRAMID[];
extern const u8 gText_MUS_B_PYRAMID_TOP[];
extern const u8 gText_MUS_B_PALACE[];
extern const u8 gText_MUS_RAYQUAZA_APPEARS[];
extern const u8 gText_MUS_B_TOWER[];
extern const u8 gText_MUS_OBTAIN_SYMBOL[];
extern const u8 gText_MUS_B_DOME[];
extern const u8 gText_MUS_B_PIKE[];
extern const u8 gText_MUS_B_FACTORY[];
extern const u8 gText_MUS_VS_RAYQUAZA[];
extern const u8 gText_MUS_VS_FRONTIER_BRAIN[];
extern const u8 gText_MUS_VS_MEW[];
extern const u8 gText_MUS_B_DOME_LOBBY[];
extern const u8 gText_MUS_VS_WILD[];
extern const u8 gText_MUS_VS_AQUA_MAGMA[];
extern const u8 gText_MUS_VS_TRAINER[];
extern const u8 gText_MUS_VS_GYM_LEADER[];
extern const u8 gText_MUS_VS_CHAMPION[];
extern const u8 gText_MUS_VS_REGI[];
extern const u8 gText_MUS_VS_KYOGRE_GROUDON[];
extern const u8 gText_MUS_VS_RIVAL[];
extern const u8 gText_MUS_VS_ELITE_FOUR[];
extern const u8 gText_MUS_VS_AQUA_MAGMA_LEADER[];
extern const u8 gText_MUS_RG_FOLLOW_ME[];
extern const u8 gText_MUS_RG_GAME_CORNER[];
extern const u8 gText_MUS_RG_ROCKET_HIDEOUT[];
extern const u8 gText_MUS_RG_GYM[];
extern const u8 gText_MUS_RG_JIGGLYPUFF[];
extern const u8 gText_MUS_RG_INTRO_FIGHT[];
extern const u8 gText_MUS_RG_TITLE[];
extern const u8 gText_MUS_RG_CINNABAR[];
extern const u8 gText_MUS_RG_LAVENDER[];
extern const u8 gText_MUS_RG_HEAL[];
extern const u8 gText_MUS_RG_CYCLING[];
extern const u8 gText_MUS_RG_ENCOUNTER_ROCKET[];
extern const u8 gText_MUS_RG_ENCOUNTER_GIRL[];
extern const u8 gText_MUS_RG_ENCOUNTER_BOY[];
extern const u8 gText_MUS_RG_HALL_OF_FAME[];
extern const u8 gText_MUS_RG_VIRIDIAN_FOREST[];
extern const u8 gText_MUS_RG_MT_MOON[];
extern const u8 gText_MUS_RG_POKE_MANSION[];
extern const u8 gText_MUS_RG_CREDITS[];
extern const u8 gText_MUS_RG_ROUTE1[];
extern const u8 gText_MUS_RG_ROUTE24[];
extern const u8 gText_MUS_RG_ROUTE3[];
extern const u8 gText_MUS_RG_ROUTE11[];
extern const u8 gText_MUS_RG_VICTORY_ROAD[];
extern const u8 gText_MUS_RG_VS_GYM_LEADER[];
extern const u8 gText_MUS_RG_VS_TRAINER[];
extern const u8 gText_MUS_RG_VS_WILD[];
extern const u8 gText_MUS_RG_VS_CHAMPION[];
extern const u8 gText_MUS_RG_PALLET[];
extern const u8 gText_MUS_RG_OAK_LAB[];
extern const u8 gText_MUS_RG_OAK[];
extern const u8 gText_MUS_RG_POKE_CENTER[];
extern const u8 gText_MUS_RG_SS_ANNE[];
extern const u8 gText_MUS_RG_SURF[];
extern const u8 gText_MUS_RG_POKE_TOWER[];
extern const u8 gText_MUS_RG_SILPH[];
extern const u8 gText_MUS_RG_FUCHSIA[];
extern const u8 gText_MUS_RG_CELADON[];
extern const u8 gText_MUS_RG_VICTORY_TRAINER[];
extern const u8 gText_MUS_RG_VICTORY_WILD[];
extern const u8 gText_MUS_RG_VICTORY_GYM_LEADER[];
extern const u8 gText_MUS_RG_VERMILLION[];
extern const u8 gText_MUS_RG_PEWTER[];
extern const u8 gText_MUS_RG_ENCOUNTER_RIVAL[];
extern const u8 gText_MUS_RG_RIVAL_EXIT[];
extern const u8 gText_MUS_RG_DEX_RATING[];
extern const u8 gText_MUS_RG_OBTAIN_KEY_ITEM[];
extern const u8 gText_MUS_RG_CAUGHT_INTRO[];
extern const u8 gText_MUS_RG_PHOTO[];
extern const u8 gText_MUS_RG_GAME_FREAK[];
extern const u8 gText_MUS_RG_CAUGHT[];
extern const u8 gText_MUS_RG_NEW_GAME_INSTRUCT[];
extern const u8 gText_MUS_RG_NEW_GAME_INTRO[];
extern const u8 gText_MUS_RG_NEW_GAME_EXIT[];
extern const u8 gText_MUS_RG_POKE_JUMP[];
extern const u8 gText_MUS_RG_UNION_ROOM[];
extern const u8 gText_MUS_RG_NET_CENTER[];
extern const u8 gText_MUS_RG_MYSTERY_GIFT[];
extern const u8 gText_MUS_RG_BERRY_PICK[];
extern const u8 gText_MUS_RG_SEVII_CAVE[];
extern const u8 gText_MUS_RG_TEACHY_TV_SHOW[];
extern const u8 gText_MUS_RG_SEVII_ROUTE[];
extern const u8 gText_MUS_RG_SEVII_DUNGEON[];
extern const u8 gText_MUS_RG_SEVII_123[];
extern const u8 gText_MUS_RG_SEVII_45[];
extern const u8 gText_MUS_RG_SEVII_67[];
extern const u8 gText_MUS_RG_POKE_FLUTE[];
extern const u8 gText_MUS_RG_VS_DEOXYS[];
extern const u8 gText_MUS_RG_VS_MEWTWO[];
extern const u8 gText_MUS_RG_VS_LEGEND[];
extern const u8 gText_MUS_RG_ENCOUNTER_GYM_LEADER[];
extern const u8 gText_MUS_RG_ENCOUNTER_DEOXYS[];
extern const u8 gText_MUS_RG_TRAINER_TOWER[];
extern const u8 gText_MUS_RG_SLOW_PALLET[];
extern const u8 gText_MUS_RG_TEACHY_TV_MENU[];
extern const u8 gText_PH_TRAP_BLEND[];
extern const u8 gText_PH_TRAP_HELD[];
extern const u8 gText_PH_TRAP_SOLO[];
extern const u8 gText_PH_FACE_BLEND[];
extern const u8 gText_PH_FACE_HELD[];
extern const u8 gText_PH_FACE_SOLO[];
extern const u8 gText_PH_CLOTH_BLEND[];
extern const u8 gText_PH_CLOTH_HELD[];
extern const u8 gText_PH_CLOTH_SOLO[];
extern const u8 gText_PH_DRESS_BLEND[];
extern const u8 gText_PH_DRESS_HELD[];
extern const u8 gText_PH_DRESS_SOLO[];
extern const u8 gText_PH_FLEECE_BLEND[];
extern const u8 gText_PH_FLEECE_HELD[];
extern const u8 gText_PH_FLEECE_SOLO[];
extern const u8 gText_PH_KIT_BLEND[];
extern const u8 gText_PH_KIT_HELD[];
extern const u8 gText_PH_KIT_SOLO[];
extern const u8 gText_PH_PRICE_BLEND[];
extern const u8 gText_PH_PRICE_HELD[];
extern const u8 gText_PH_PRICE_SOLO[];
extern const u8 gText_PH_LOT_BLEND[];
extern const u8 gText_PH_LOT_HELD[];
extern const u8 gText_PH_LOT_SOLO[];
extern const u8 gText_PH_GOAT_BLEND[];
extern const u8 gText_PH_GOAT_HELD[];
extern const u8 gText_PH_GOAT_SOLO[];
extern const u8 gText_PH_THOUGHT_BLEND[];
extern const u8 gText_PH_THOUGHT_HELD[];
extern const u8 gText_PH_THOUGHT_SOLO[];
extern const u8 gText_PH_CHOICE_BLEND[];
extern const u8 gText_PH_CHOICE_HELD[];
extern const u8 gText_PH_CHOICE_SOLO[];
extern const u8 gText_PH_MOUTH_BLEND[];
extern const u8 gText_PH_MOUTH_HELD[];
extern const u8 gText_PH_MOUTH_SOLO[];
extern const u8 gText_PH_FOOT_BLEND[];
extern const u8 gText_PH_FOOT_HELD[];
extern const u8 gText_PH_FOOT_SOLO[];
extern const u8 gText_PH_GOOSE_BLEND[];
extern const u8 gText_PH_GOOSE_HELD[];
extern const u8 gText_PH_GOOSE_SOLO[];
extern const u8 gText_PH_STRUT_BLEND[];
extern const u8 gText_PH_STRUT_HELD[];
extern const u8 gText_PH_STRUT_SOLO[];
extern const u8 gText_PH_CURE_BLEND[];
extern const u8 gText_PH_CURE_HELD[];
extern const u8 gText_PH_CURE_SOLO[];
extern const u8 gText_PH_NURSE_BLEND[];
extern const u8 gText_PH_NURSE_HELD[];
extern const u8 gText_PH_NURSE_SOLO[];
extern const u8 gText_MUS_HG_START[];
extern const u8 gText_MUS_HG_VS_WILD[];
extern const u8 gText_MUS_HG_VS_TRAINER[];
extern const u8 gText_MUS_HG_VS_TRAINER_KANTO[];
extern const u8 gText_MUS_HG_VS_GYM_LEADER[];
extern const u8 gText_MUS_HG_VS_GYM_LEADER_KANTO[];
extern const u8 gText_MUS_HG_VS_CHAMPION[];
extern const u8 gText_MUS_HG_VS_FRONTIER_BRAIN[];
extern const u8 gText_MUS_HG_VICTORY_FRONTIER_BRAIN[];
extern const u8 gText_MUS_HG_VICTORY_TRAINER[];
extern const u8 gText_MUS_HG_VICTORY_GYM_LEADER[];
extern const u8 gText_MUS_HG_VS_RIVAL[];
extern const u8 gText_MUS_HG_VS_ROCKET[];
extern const u8 gText_MUS_HG_VS_SUICUNE[];
extern const u8 gText_MUS_HG_VS_ENTEI[];
extern const u8 gText_MUS_HG_VS_RAIKOU[];
extern const u8 gText_MUS_HG_VS_HO_OH[];
extern const u8 gText_MUS_HG_VS_LUGIA[];
extern const u8 gText_MUS_HG_ROUTE29[];
extern const u8 gText_MUS_HG_ROUTE30[];
extern const u8 gText_MUS_HG_ROUTE34[];
extern const u8 gText_MUS_HG_ROUTE38[];
extern const u8 gText_MUS_HG_ROUTE42[];
extern const u8 gText_MUS_HG_ROUTE47[];
extern const u8 gText_MUS_HG_ICE_PATH[];
extern const u8 gText_MUS_HG_ENCOUNTER_RIVAL[];
extern const u8 gText_MUS_HG_ENCOUNTER_GIRL_1[];
extern const u8 gText_MUS_HG_ENCOUNTER_BOY_1[];
extern const u8 gText_MUS_HG_ENCOUNTER_SUSPICIOUS_1[];
extern const u8 gText_MUS_HG_ENCOUNTER_SAGE[];
extern const u8 gText_MUS_HG_ENCOUNTER_KIMONO_GIRL[];
extern const u8 gText_MUS_HG_ENCOUNTER_ROCKET[];
extern const u8 gText_MUS_HG_ENCOUNTER_GIRL_2[];
extern const u8 gText_MUS_HG_ENCOUNTER_BOY_2[];
extern const u8 gText_MUS_HG_ENCOUNTER_SUSPICIOUS_2[];
extern const u8 gText_MUS_HG_TITLE[];
extern const u8 gText_MUS_HG_CREDITS[];
extern const u8 gText_MUS_HG_END[];
extern const u8 gText_MUS_HG_NEW_BARK[];
extern const u8 gText_MUS_HG_NATIONAL_PARK[];
extern const u8 gText_MUS_HG_DANCE_THEATER[];
extern const u8 gText_MUS_HG_GAME_CORNER[];
extern const u8 gText_MUS_HG_GAME_CORNER_WIN[];
extern const u8 gText_MUS_HG_TEAM_ROCKET_HQ[];
extern const u8 gText_MUS_HG_BUG_CONTEST_PREP[];
extern const u8 gText_MUS_HG_BUG_CATCHING_CONTEST[];
extern const u8 gText_MUS_HG_BUG_CONTEST_1ST_PLACE[];
extern const u8 gText_MUS_HG_BUG_CONTEST_2ND_PLACE[];
extern const u8 gText_MUS_HG_BUG_CONTEST_3RD_PLACE[];
extern const u8 gText_MUS_HG_ROCKET_TAKEOVER[];
extern const u8 gText_MUS_HG_ELM_LAB[];
extern const u8 gText_MUS_HG_KIMONO_GIRL[];
extern const u8 gText_MUS_HG_CARD_FLIP[];
extern const u8 gText_MUS_HG_CARD_FLIP_GAME_OVER[];
extern const u8 gText_MUS_HG_B_ARCADE[];
extern const u8 gText_MUS_HG_B_CASTLE[];
extern const u8 gText_MUS_HG_B_FACTORY[];
extern const u8 gText_MUS_HG_B_HALL[];
extern const u8 gText_MUS_HG_B_TOWER[];
extern const u8 gText_MUS_HG_B_TOWER_RECEPTION[];
extern const u8 gText_MUS_HG_EVOLUTION[];
extern const u8 gText_MUS_HG_EVOLVED[];
extern const u8 gText_MUS_HG_GYM[];
extern const u8 gText_MUS_HG_LEVEL_UP[];
extern const u8 gText_MUS_HG_MAGNET_TRAIN[];
extern const u8 gText_MUS_HG_SINJOU_RUINS[];
extern const u8 gText_MUS_HG_VICTORY_WILD[];
extern const u8 gText_MUS_DP_START[];
extern const u8 gText_MUS_DP_ROUTE201_DAY[];
extern const u8 gText_MUS_DP_ROUTE203_DAY[];
extern const u8 gText_MUS_DP_ROUTE205_DAY[];
extern const u8 gText_MUS_DP_ROUTE206_DAY[];
extern const u8 gText_MUS_DP_ROUTE209_DAY[];
extern const u8 gText_MUS_DP_ROUTE210_DAY[];
extern const u8 gText_MUS_DP_ROUTE216_DAY[];
extern const u8 gText_MUS_DP_ROUTE228_DAY[];
extern const u8 gText_MUS_DP_ETERNA_FOREST[];
extern const u8 gText_MUS_DP_MT_CORONET[];
extern const u8 gText_MUS_DP_SPEAR_PILLAR[];
extern const u8 gText_MUS_DP_LAKE_CAVERNS[];
extern const u8 gText_MUS_DP_TITLE[];
extern const u8 gText_MUS_DP_VS_WILD[];
extern const u8 gText_MUS_DP_VS_GYM_LEADER[];
extern const u8 gText_MUS_DP_VS_UXIE_MESPRIT_AZELF[];
extern const u8 gText_MUS_DP_VS_TRAINER[];
extern const u8 gText_MUS_DP_VS_GALACTIC_BOSS[];
extern const u8 gText_MUS_DP_VS_DIALGA_PALKIA[];
extern const u8 gText_MUS_DP_VS_CHAMPION[];
extern const u8 gText_MUS_DP_VS_GALACTIC[];
extern const u8 gText_MUS_DP_VS_RIVAL[];
extern const u8 gText_MUS_DP_VS_ARCEUS[];
extern const u8 gText_MUS_DP_VS_LEGEND[];
extern const u8 gText_MUS_DP_VS_GALACTIC_COMMANDER[];
extern const u8 gText_MUS_DP_VS_ELITE_FOUR[];
extern const u8 gText_MUS_DP_ENCOUNTER_BOY[];
extern const u8 gText_MUS_DP_ENCOUNTER_TWINS[];
extern const u8 gText_MUS_DP_ENCOUNTER_INTENSE[];
extern const u8 gText_MUS_DP_ENCOUNTER_GALACTIC[];
extern const u8 gText_MUS_DP_ENCOUNTER_LADY[];
extern const u8 gText_MUS_DP_ENCOUNTER_HIKER[];
extern const u8 gText_MUS_DP_ENCOUNTER_RICH[];
extern const u8 gText_MUS_DP_ENCOUNTER_SAILOR[];
extern const u8 gText_MUS_DP_ENCOUNTER_SUSPICIOUS[];
extern const u8 gText_MUS_DP_ENCOUNTER_ACE_TRAINER[];
extern const u8 gText_MUS_DP_ENCOUNTER_GIRL[];
extern const u8 gText_MUS_DP_ENCOUNTER_CYCLIST[];
extern const u8 gText_MUS_DP_ENCOUNTER_ARTIST[];
extern const u8 gText_MUS_DP_ENCOUNTER_ELITE_FOUR[];
extern const u8 gText_MUS_DP_ENCOUNTER_CHAMPION[];
extern const u8 gText_MUS_DP_VICTORY_WILD[];
extern const u8 gText_MUS_DP_VICTORY_TRAINER[];
extern const u8 gText_MUS_DP_VICTORY_GYM_LEADER[];
extern const u8 gText_MUS_DP_VICTORY_CHAMPION[];
extern const u8 gText_MUS_DP_VICTORY_GALACTIC[];
extern const u8 gText_MUS_DP_VICTORY_ELITE_FOUR[];
extern const u8 gText_MUS_DP_HALL_OF_ORIGIN[];
extern const u8 gText_MUS_DP_FLOAROMA_DAY[];
extern const u8 gText_MUS_DP_HALL_OF_FAME[];
extern const u8 gText_MUS_DP_HEAL[];
extern const u8 gText_MUS_DP_FIGHT_AREA_DAY[];
extern const u8 gText_MUS_DP_INSIDE_POKEMON_LEAGUE[];
extern const u8 gText_MUS_DP_SANDGEM_DAY[];
extern const u8 gText_MUS_DP_SNOWPOINT_DAY[];
extern const u8 gText_MUS_DP_SOLACEON_DAY[];
extern const u8 gText_MUS_DP_UNDERGROUND[];
extern const u8 gText_MUS_DP_GYM[];
extern const u8 gText_MUS_DP_EVOLUTION[];
extern const u8 gText_MUS_DP_EVOLVED[];
extern const u8 gText_MUS_DP_GTS[];
extern const u8 gText_MUS_DP_LAKE[];
extern const u8 gText_MUS_DP_LEVEL_UP[];
extern const u8 gText_MUS_DP_LEGEND_APPEARS[];
extern const u8 gText_MUS_DP_GALACTIC_ETERNA_BUILDING[];
extern const u8 gText_MUS_DP_GALACTIC_HQ[];
extern const u8 gText_MUS_DP_GALACTIC_HQ_BASEMENT[];
extern const u8 gText_MUS_DP_AMITY_SQUARE[];
extern const u8 gText_MUS_DP_OLD_CHATEAU[];
extern const u8 gText_MUS_DP_ROWAN[];
extern const u8 gText_MUS_DP_OREBURGH_MINE[];
extern const u8 gText_MUS_PL_START[];
extern const u8 gText_MUS_PL_MYSTERY_GIFT[];
extern const u8 gText_MUS_PL_VS_GIRATINA[];
extern const u8 gText_MUS_PL_DISTORTION_WORLD[];
extern const u8 gText_MUS_PL_LOOKER[];
extern const u8 gText_MUS_PL_VS_REGI[];
extern const u8 gText_MUS_EXTRA_START[];
extern const u8 gText_MUS_MOVE_DELETED_SLOW[];
extern const u8 gText_MUS_DEBUG_TEST[];
extern const u8 gText_MUS_ROUTE118[];
extern const u8 gText_MUS_NONE[];

// German Plural for balls (items)

extern const u8 gText_Pokebaelle[];
extern const u8 gText_Superbaelle[];
extern const u8 gText_Hyperbaelle[];
extern const u8 gText_Masterbaelle[];
extern const u8 gText_Safaribaelle[];
extern const u8 gText_Netzbaelle[];
extern const u8 gText_Tauchbaelle[];
extern const u8 gText_Nestbaelle[];
extern const u8 gText_Wiederbaelle[];
extern const u8 gText_Timerbaelle[];
extern const u8 gText_Luxusbaelle[];
extern const u8 gText_Premierbaelle[];
extern const u8 gText_Heilbaelle[];
extern const u8 gText_Schnellbaelle[];
extern const u8 gText_Dunkelbaelle[];
extern const u8 gText_Jubelbaelle[];
extern const u8 gText_Flinkbaelle[];
extern const u8 gText_Levelbaelle[];
extern const u8 gText_Lockbaelle[];
extern const u8 gText_Schwerbaelle[];
extern const u8 gText_Liebesbaelle[];
extern const u8 gText_Freundesbaelle[];
extern const u8 gText_Mondbaelle[];
...
extern const u8 gText_StyleAndStarterRegion[];
extern const u8 gText_FollowerDebugInfo[];
extern const u8 gJokeNpc_Text_Greeting[];
extern const u8 gJokeNpc_Text_Joke1[];
extern const u8 gJokeNpc_Text_Joke2[];
extern const u8 gJokeNpc_Text_Joke3[];
extern const u8 gJokeNpc_Text_Joke4[];
extern const u8 gJokeNpc_Text_Joke5[];
extern const u8 gJokeNpc_Text_Joke6[];
extern const u8 gJokeNpc_Text_Joke7[];
extern const u8 gJokeNpc_Text_Joke8[];
extern const u8 gJokeNpc_Text_Joke9[];
extern const u8 gJokeNpc_Text_Joke10[];
extern const u8 gJokeNpc_Text_Joke11[];
extern const u8 gJokeNpc_Text_Joke12[];
extern const u8 gJokeNpc_Text_Joke13[];
extern const u8 gJokeNpc_Text_Joke14[];
extern const u8 gJokeNpc_Text_Joke15[];
extern const u8 gJokeNpc_Text_Joke16[];
extern const u8 gJokeNpc_Text_Joke17[];
extern const u8 gJokeNpc_Text_Joke18[];
extern const u8 gJokeNpc_Text_Joke19[];
extern const u8 gJokeNpc_Text_Joke20[];
extern const u8 gJokeNpc_Text_Joke21[];
extern const u8 gJokeNpc_Text_Joke22[];
extern const u8 gJokeNpc_Text_Joke23[];
extern const u8 gJokeNpc_Text_Joke24[];
extern const u8 gJokeNpc_Text_Joke25[];
extern const u8 gJokeNpc_Text_Joke26[];
extern const u8 gJokeNpc_Text_Joke27[];
extern const u8 gJokeNpc_Text_Joke28[];
extern const u8 gJokeNpc_Text_Joke29[];
extern const u8 gJokeNpc_Text_Joke30[];
extern const u8 gJokeNpc_Text_Joke31[];
extern const u8 gJokeNpc_Text_Joke32[];
extern const u8 gJokeNpc_Text_Joke33[];
extern const u8 gJokeNpc_Text_Joke34[];
extern const u8 gJokeNpc_Text_Joke35[];
extern const u8 gJokeNpc_Text_Joke36[];
extern const u8 gJokeNpc_Text_Joke37[];
extern const u8 gJokeNpc_Text_Joke38[];
extern const u8 gJokeNpc_Text_Joke39[];
extern const u8 gJokeNpc_Text_Joke40[];
extern const u8 gJokeNpc_Text_Joke41[];
extern const u8 gJokeNpc_Text_Joke42[];
extern const u8 gText_Night2[];
extern const u8 gText_Daytime2[];
extern const u8 gText_Morning2[];
extern const u8 gText_Evening2[];
