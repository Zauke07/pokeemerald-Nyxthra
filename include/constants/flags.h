...
#define FLAG_DEFEATED_CHATGPT                       0x96F

// Rogue Flags
// RogueNote: Flag block 1
#define FLAG_ROGUE_RUN_ACTIVE           0x970
#define FLAG_ROGUE_WILD_SAFARI          0x971
#define FLAG_SET_SEED_ENABLED           0x972
#define FLAG_SET_SEED_ITEMS             0x973
#define FLAG_SET_SEED_TRAINERS          0x974
#define FLAG_SET_SEED_BOSSES            0x975
#define FLAG_SET_SEED_WILDMONS          0x976
#define FLAG_ROGUE_DYNAMAX_BATTLE       0x977
#define FLAG_ROGUE_MAP_EVENT            0x978 // gets reset on every valid encounter jump (doesn't include warps within same map)
#define FLAG_ROGUE_MET_SHINY_CHEF       0x979

#define FLAG_ROGUE_ADVENTURE_REPLAY_ACTIVE   0x97A
#define FLAG_ROGUE_MET_PEONIA                0x97B

#define FLAG_ROGUE_UNLOCKED_VICTORY_LAP      0x97C
...
#define FLAG_ROGUE_FOUND_GIMIC_ROOM          0x982
#define FLAG_ROGUE_LEFT_ON_RUN               0x983
#define FLAG_ROGUE_MET_FENNEL                0x984
#define FLAG_ROGUE_FINAL_QUEST_MET_FAKE_CHAMP 0x985
#define FLAG_ROGUE_PENDING_PATCH_MSG         0x986
#define FLAG_ROGUE_UNLOCKED_PIKIN_EASTER_EGG 0x987
#define FLAG_ROGUE_MET_POKABBIE              0x988
#define FLAG_ROGUE_UNCOVERRED_POKABBIE       0x989
#define FLAG_ROGUE_GAUNTLET_MODE             0x98A
#define FLAG_ROGUE_EXPANSION_ACTIVE          0x98B
#define FLAG_ROGUE_RARE_ITEM_MART_DISABLED   0x98C
#define FLAG_ROGUE_ASSISTANT_TUTORIAL        0x98D
#define FLAG_ROGUE_SCOTT_GIFTED_EXTRAS       0x98E
#define FLAG_ROGUE_DEBUG_DISABLED            0x98F
#define FLAG_ROGUE_MET_BERRY_MERCHANT        0x990
#define FLAG_ROGUE_RIVAL_DISABLED            0x991
#define FLAG_ROGUE_QUESTS_ASK_FOR_RETIRE     0x992
#define FLAG_ROGUE_QUESTS_NEVER_ASK_FOR_RETIRE  0x993
#define FLAG_ROGUE_TEAM_BOSS_DISABLED        0x994
#define FLAG_ROGUE_RANDOM_TRADE_DISABLED     0x995
#define FLAG_ROGUE_RANDOM_TRADE_WAS_ACTIVE   0x996
#define FLAG_ROGUE_RANDOM_TRADE_WAS_FULL_PARTY 0x997
#define FLAG_ROGUE_DAYCARE_PHONE_CHARGED     0x998
#define FLAG_ROGUE_MYSTERIOUS_SIGN_KNOWN     0x999
#define FLAG_ROGUE_TRAINERS_WEAK_LEGENDARIES    0x99A
#define FLAG_ROGUE_TRAINERS_STRONG_LEGENDARIES  0x99B
#define FLAG_ROGUE_PRE_RELEASE_COMPAT_WARNING   0x99C
#define FLAG_ROGUE_REWARD_ITEM_MART_DISABLED    0x99D
#define FLAG_ROGUE_DAYCARE_EGG_READY         0x99E
#define FLAG_ROGUE_HIDE_WORKBENCHES          0x99F
#define FLAG_ROGUE_HAS_RANDOM_STARTER        0x9A0
#define FLAG_ROGUE_UNLOCKED_MAP_TELEPORT     0x9A1
#define FLAG_ROGUE_IN_SNAG_BATTLE            0x9A2
#define FLAG_ROGUE_IS_VICTORY_LAP            0x9A3
#define FLAG_FIX_RIVAL_DOOR_RAN_MAY          0x9A4
#define FLAG_BOY_NUGGET_RETURNED             0x9A5
#define FLAG_BOY_NUGGET_REFUSED              0x9A6
#define FLAG_GOT_HIDDEN_NUGGET               0x9A7
#define FLAG_FIX_RIVAL_DOOR_RAN_BRENDAN      0x9A8
#define FLAG_DEFEATED_TESTLABOR_CHATGPT      0x9A9
#define FLAG_UNLOCKED_TESTLABOR_NPC          0x9B0
#define FLAG_HIDE_ROUTE_110_BIG_SNORLAX      0x9B1
#define FLAG_WOKE_UP_BIG_SNORLAX             0x9B2
