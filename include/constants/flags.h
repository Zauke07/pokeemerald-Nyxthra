...
#define FLAG_ROGUE_RUN_ACTIVE           0x96F
#define FLAG_ROGUE_WILD_SAFARI          0x970
#define FLAG_SET_SEED_ENABLED           0x971
#define FLAG_SET_SEED_ITEMS             0x972
#define FLAG_SET_SEED_TRAINERS          0x973
#define FLAG_SET_SEED_BOSSES            0x974
#define FLAG_SET_SEED_WILDMONS          0x975
#define FLAG_ROGUE_DYNAMAX_BATTLE       0x976
#define FLAG_ROGUE_MAP_EVENT            0x977 // gets reset on every valid encounter jump (doesn't include warps within same map)
#define FLAG_ROGUE_MET_SHINY_CHEF       0x978

#define FLAG_ROGUE_ADVENTURE_REPLAY_ACTIVE   0x979
#define FLAG_ROGUE_MET_PEONIA                0x97A

#define FLAG_ROGUE_UNLOCKED_VICTORY_LAP      0x97B

#define FLAG_ROGUE_COURIER_READY             0x97C
#define FLAG_ROGUE_GIMICK_TUTORIAL           0x97D

#define FLAG_DEBUG_NO_ENCOUNTER              0x97E // Unused Flag
#define FLAG_DEBUG_NO_TRAINER_SEE            0x97F // Unused Flag
#define FLAG_DEBUG_NO_COLLISION              0x980 // Unused Flag

#define FLAG_ROGUE_ITEM_START FLAG_ROGUE_ITEM0
#define FLAG_ROGUE_ITEM_END FLAG_ROGUE_ITEM18

// RogueNote: Flag block 2
#define FLAG_ROGUE_FOUND_GIMIC_ROOM          0x981
#define FLAG_ROGUE_LEFT_ON_RUN               0x982
#define FLAG_ROGUE_MET_FENNEL                0x983
#define FLAG_ROGUE_FINAL_QUEST_MET_FAKE_CHAMP 0x984
#define FLAG_ROGUE_PENDING_PATCH_MSG         0x985
#define FLAG_ROGUE_UNLOCKED_PIKIN_EASTER_EGG 0x986
#define FLAG_ROGUE_MET_POKABBIE              0x987
#define FLAG_ROGUE_UNCOVERRED_POKABBIE       0x988
#define FLAG_ROGUE_GAUNTLET_MODE             0x989
#define FLAG_ROGUE_EXPANSION_ACTIVE          0x98A
#define FLAG_ROGUE_RARE_ITEM_MART_DISABLED   0x98B
#define FLAG_ROGUE_ASSISTANT_TUTORIAL        0x98C
#define FLAG_ROGUE_SCOTT_GIFTED_EXTRAS       0x98D
#define FLAG_ROGUE_DEBUG_DISABLED            0x98E
#define FLAG_ROGUE_MET_BERRY_MERCHANT        0x98F
#define FLAG_ROGUE_RIVAL_DISABLED            0x990
#define FLAG_ROGUE_QUESTS_ASK_FOR_RETIRE     0x991
#define FLAG_ROGUE_QUESTS_NEVER_ASK_FOR_RETIRE  0x992
#define FLAG_ROGUE_TEAM_BOSS_DISABLED        0x993
#define FLAG_ROGUE_RANDOM_TRADE_DISABLED     0x994
#define FLAG_ROGUE_RANDOM_TRADE_WAS_ACTIVE   0x995
#define FLAG_ROGUE_RANDOM_TRADE_WAS_FULL_PARTY 0x996
#define FLAG_ROGUE_DAYCARE_PHONE_CHARGED     0x997
#define FLAG_ROGUE_MYSTERIOUS_SIGN_KNOWN     0x998
#define FLAG_ROGUE_TRAINERS_WEAK_LEGENDARIES    0x999
#define FLAG_ROGUE_TRAINERS_STRONG_LEGENDARIES  0x99A
#define FLAG_ROGUE_PRE_RELEASE_COMPAT_WARNING   0x99B
#define FLAG_ROGUE_REWARD_ITEM_MART_DISABLED    0x99C
#define FLAG_ROGUE_DAYCARE_EGG_READY         0x99D
#define FLAG_ROGUE_HIDE_WORKBENCHES          0x99E
#define FLAG_ROGUE_HAS_RANDOM_STARTER        0x99F
#define FLAG_ROGUE_UNLOCKED_MAP_TELEPORT     0x9A0
#define FLAG_ROGUE_IN_SNAG_BATTLE            0x9A1
#define FLAG_ROGUE_IS_VICTORY_LAP            0x9A2
