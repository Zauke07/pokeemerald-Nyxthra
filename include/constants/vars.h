...
#define VAR_REPEL_LURE_MENU                              0x404E // Letztes benutztes Repel/Lure (Item-ID)
...
#define VAR_DEBUG_BATTLE_TRANSITION                      0x408B
...
#define VAR_METEORFALLS_B1F_3R_COLD_SPOT_TRIGGERED       VAR_UNUSED_0x40E5
