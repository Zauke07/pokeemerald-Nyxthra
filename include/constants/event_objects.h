...
#define OBJ_EVENT_PAL_CELEBI                      0x1125
...
#define OBJ_EVENT_PAL_TAG_METEORITE               0x112A
#define OBJ_EVENT_PAL_TAG_SEAGALLOP               0x112B
#define OBJ_EVENT_PAL_TAG_SS_ANNE                 0x112C
