...
enum ScrOp
{
    ...
    SCR_OP_ISSTYLEMALE = 0xE5,
    SCR_OP_HIDEOBJECT = 0xE6,
    SCR_OP_SHOWOBJECT = 0xE7,
    SCR_OP_SETOBJECTGFXID = 0xE8,
    SCR_OP_SPAWN_RIVAL_OBJECT_FROM_STYLE = 0xE9,
    SCR_OP_GETPLAYERSTYLE = 0xEA,
    SCR_OP_BUFFER_INT_TO_VAR1 = 0xEB,
    SCR_OP_BUFFER_INT_TO_VAR2 = 0xEC,
    SCR_OP_TEST_SHOW_CHATGPT_LOGO = 0xED,
    SCR_OP_GET_PLAYER_POS = 0xEE,
    SCR_OP_PLAY_MUSIC_TEST_1 = 0xEF,
    SCR_OP_PLAY_MUSIC_TEST_2 = 0xF0,
    SCR_OP_PLAY_MUSIC_TEST_3 = 0xF1,
    SCR_OP_BUFFER_STYLE_NAME_VAR1 = 0xF2,
    SCR_OP_checkpcstyle_may = 0xF3,
    SCR_OP_checkpcstyle_brendan = 0xF4,
    SCR_OP_BUFFER_FOLLOWER_NICKNAME_TO_VAR1 = 0xF5,
    SCR_OP_FORMAT_CURRENT_TIME = 0xF6,
    SCR_OP_HIDEFOLLOWER = 0xF7,
    SCR_OP_GETBRAILLESTRINGWIDTH = 0xF8,
    SCR_OP_CHECKPLAYERGENDER = 0xF9,
};
