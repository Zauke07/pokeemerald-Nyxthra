...
enum __attribute__((packed)) TrainerPicID
{
    ...
    // --- Nyxthra Extra Trainer Pics (Front) ---
    TRAINER_PIC_FRONT_KANTO_BROCK,
    TRAINER_PIC_FRONT_KANTO_MISTY,
    TRAINER_PIC_FRONT_KANTO_LTSURGE,
    TRAINER_PIC_FRONT_KANTO_ERIKA,
    TRAINER_PIC_FRONT_KANTO_KOGA,
    TRAINER_PIC_FRONT_KANTO_SABRINA,
    TRAINER_PIC_FRONT_KANTO_BLAINE,
    TRAINER_PIC_FRONT_KANTO_GIOVANNI,
    TRAINER_PIC_FRONT_KANTO_LORELEI,
    TRAINER_PIC_FRONT_KANTO_BRUNO,
    TRAINER_PIC_FRONT_KANTO_AGATHA,
    TRAINER_PIC_FRONT_KANTO_LANCE,
    TRAINER_PIC_FRONT_KANTO_BLUE,
    TRAINER_PIC_FRONT_KANTO_PROFOAK,
    TRAINER_PIC_FRONT_JOHTO_FALKNER,
    TRAINER_PIC_FRONT_JOHTO_BUGSY,
    TRAINER_PIC_FRONT_JOHTO_WHITNEY,
    TRAINER_PIC_FRONT_JOHTO_MORTY,
    TRAINER_PIC_FRONT_JOHTO_CHUCK,
    TRAINER_PIC_FRONT_JOHTO_JASMINE,
    TRAINER_PIC_FRONT_JOHTO_PRYCE,
    TRAINER_PIC_FRONT_JOHTO_CLAIR,
    TRAINER_PIC_FRONT_JOHTO_WILL,
    TRAINER_PIC_FRONT_JOHTO_KAREN,
    TRAINER_PIC_FRONT_JOHTO_RED,
    TRAINER_PIC_FRONT_SINNOH_AARON,
    TRAINER_PIC_FRONT_SINNOH_BERTHA,
    TRAINER_PIC_FRONT_SINNOH_BYRON,
    TRAINER_PIC_FRONT_SINNOH_CANDICE,
    TRAINER_PIC_FRONT_SINNOH_CRASHER_WAKE,
    TRAINER_PIC_FRONT_SINNOH_CYNTHIA,
    TRAINER_PIC_FRONT_SINNOH_FANTINA,
    TRAINER_PIC_FRONT_SINNOH_FLINT,
    TRAINER_PIC_FRONT_SINNOH_GARDENIA,
    TRAINER_PIC_FRONT_SINNOH_LUCIAN,
    TRAINER_PIC_FRONT_SINNOH_MAYLENE,
    TRAINER_PIC_FRONT_SINNOH_ROARK,
    TRAINER_PIC_FRONT_SINNOH_VOLKNER,
    TRAINER_PIC_FRONT_UNOVA_ALDER,
    TRAINER_PIC_FRONT_UNOVA_BRYCEN,
    TRAINER_PIC_FRONT_UNOVA_BURGH,
    TRAINER_PIC_FRONT_UNOVA_CAITLIN,
    TRAINER_PIC_FRONT_UNOVA_CHILI,
    TRAINER_PIC_FRONT_UNOVA_CILAN,
    TRAINER_PIC_FRONT_UNOVA_CLAY,
    TRAINER_PIC_FRONT_UNOVA_CRESS,
    TRAINER_PIC_FRONT_UNOVA_DRAYDEN,
    TRAINER_PIC_FRONT_UNOVA_ELESA,
    TRAINER_PIC_FRONT_UNOVA_GRIMSLEY,
    TRAINER_PIC_FRONT_UNOVA_IRIS,
    TRAINER_PIC_FRONT_UNOVA_LENORA,
    TRAINER_PIC_FRONT_UNOVA_MARLON,
    TRAINER_PIC_FRONT_UNOVA_MARSHAL,
    TRAINER_PIC_FRONT_UNOVA_ROXIE,
    TRAINER_PIC_FRONT_UNOVA_SHAUNTAL,
    TRAINER_PIC_FRONT_UNOVA_SKYLA,
    TRAINER_PIC_FRONT_KALOS_CLEMONT,
    TRAINER_PIC_FRONT_KALOS_DIANTHA,
    TRAINER_PIC_FRONT_KALOS_DRASNA,
    TRAINER_PIC_FRONT_KALOS_GRANT,
    TRAINER_PIC_FRONT_KALOS_KORRINA,
    TRAINER_PIC_FRONT_KALOS_MALVA,
    TRAINER_PIC_FRONT_KALOS_OLYMPIA,
    TRAINER_PIC_FRONT_KALOS_RAMOS,
    TRAINER_PIC_FRONT_KALOS_SIEBOLD,
    TRAINER_PIC_FRONT_KALOS_VALERIE,
    TRAINER_PIC_FRONT_KALOS_VIOLA,
    TRAINER_PIC_FRONT_KALOS_WIKSTROM,
    TRAINER_PIC_FRONT_KALOS_WULFRIC,
    TRAINER_PIC_FRONT_ALOLA_ACEROLA,
    TRAINER_PIC_FRONT_ALOLA_HALA,
    TRAINER_PIC_FRONT_ALOLA_HAPU,
    TRAINER_PIC_FRONT_ALOLA_ILIMA,
    TRAINER_PIC_FRONT_ALOLA_KAHILI,
    TRAINER_PIC_FRONT_ALOLA_KIAWE,
    TRAINER_PIC_FRONT_ALOLA_KUKUI,
    TRAINER_PIC_FRONT_ALOLA_LANA,
    TRAINER_PIC_FRONT_ALOLA_MALLOW,
    TRAINER_PIC_FRONT_ALOLA_MINA,
    TRAINER_PIC_FRONT_ALOLA_MOLAYNE,
    TRAINER_PIC_FRONT_ALOLA_NANU,
    TRAINER_PIC_FRONT_ALOLA_OLIVIA,
    TRAINER_PIC_FRONT_ALOLA_SOPHOCLES,
    TRAINER_PIC_FRONT_GALAR_ALLISTER,
    TRAINER_PIC_FRONT_GALAR_BEA,
    TRAINER_PIC_FRONT_GALAR_GORDIE,
    TRAINER_PIC_FRONT_GALAR_KABU,
    TRAINER_PIC_FRONT_GALAR_LEON,
    TRAINER_PIC_FRONT_GALAR_MELONY,
    TRAINER_PIC_FRONT_GALAR_MILO,
    TRAINER_PIC_FRONT_GALAR_NESSA,
    TRAINER_PIC_FRONT_GALAR_OPAL,
    TRAINER_PIC_FRONT_GALAR_PIERS,
    TRAINER_PIC_FRONT_GALAR_RAIHAN,
    TRAINER_PIC_FRONT_PALDEA_BRASSIUS,
    TRAINER_PIC_FRONT_PALDEA_GEETA,
    TRAINER_PIC_FRONT_PALDEA_GRUSHA,
    TRAINER_PIC_FRONT_PALDEA_HASSEL,
    TRAINER_PIC_FRONT_PALDEA_IONO,
    TRAINER_PIC_FRONT_PALDEA_KATY,
    TRAINER_PIC_FRONT_PALDEA_KOFU,
    TRAINER_PIC_FRONT_PALDEA_LARRY,
    TRAINER_PIC_FRONT_PALDEA_POPPY,
    TRAINER_PIC_FRONT_PALDEA_RIKA,
    TRAINER_PIC_FRONT_PALDEA_RYME,
    TRAINER_PIC_FRONT_PALDEA_TULIP,
    TRAINER_PIC_FRONT_ETHAN,
    TRAINER_PIC_FRONT_LYRA,
    TRAINER_PIC_FRONT_LUCAS,
    TRAINER_PIC_FRONT_DAWN,
    TRAINER_PIC_FRONT_HILBERT,
    TRAINER_PIC_FRONT_HILDA,
    TRAINER_PIC_FRONT_NATE,
    TRAINER_PIC_FRONT_ROSA,
    TRAINER_PIC_FRONT_CALEM,
    TRAINER_PIC_FRONT_SERENA,
    TRAINER_PIC_FRONT_ELIO,
    TRAINER_PIC_FRONT_SELENE,
    TRAINER_PIC_FRONT_VICTOR,
    TRAINER_PIC_FRONT_GLORIA,
    TRAINER_PIC_FRONT_FLORIAN,
    TRAINER_PIC_FRONT_JULIANA,
    TRAINER_PIC_FRONT_RIVAL_RED,
    TRAINER_PIC_FRONT_RIVAL_LEAF,
    TRAINER_PIC_FRONT_RIVAL_BRENDAN,
    TRAINER_PIC_FRONT_RIVAL_MAY,
    TRAINER_PIC_FRONT_RIVAL_ETHAN,
    TRAINER_PIC_FRONT_RIVAL_LYRA,
    TRAINER_PIC_FRONT_RIVAL_LUCAS,
    TRAINER_PIC_FRONT_RIVAL_DAWN,
    TRAINER_PIC_FRONT_RIVAL_HILBERT,
    TRAINER_PIC_FRONT_RIVAL_HILDA,
    TRAINER_PIC_FRONT_RIVAL_NATE,
    TRAINER_PIC_FRONT_RIVAL_ROSA,
    TRAINER_PIC_FRONT_RIVAL_CALEM,
    TRAINER_PIC_FRONT_RIVAL_SERENA,
    TRAINER_PIC_FRONT_RIVAL_ELIO,
    TRAINER_PIC_FRONT_RIVAL_SELENE,
    TRAINER_PIC_FRONT_RIVAL_VICTOR,
    TRAINER_PIC_FRONT_RIVAL_GLORIA,
    TRAINER_PIC_FRONT_RIVAL_FLORIAN,
    TRAINER_PIC_FRONT_RIVAL_JULIANA,
    TRAINER_PIC_FRONT_ROCKET_GRUNT_M,
    TRAINER_PIC_FRONT_ROCKET_GRUNT_F,
    TRAINER_PIC_FRONT_SCIENTIST,
    TRAINER_PIC_FRONT_BIKER,
    TRAINER_PIC_FRONT_GALACTIC_GRUNT_M,
    TRAINER_PIC_FRONT_GALACTIC_GRUNT_F,
    TRAINER_PIC_FRONT_GALACTIC_CYRUS,
    TRAINER_PIC_FRONT_ROCKY,
    TRAINER_PIC_FRONT_BACKPACKER_F,
    TRAINER_PIC_FRONT_BACKPACKER_M,
    TRAINER_PIC_FRONT_NURSE,
    TRAINER_PIC_FRONT_ASH,
    TRAINER_PIC_FRONT_JAMES_ROCKET,
    TRAINER_PIC_FRONT_JESSIE_ROCKET,
    TRAINER_PIC_FRONT_ADMIN_PROTON,
    TRAINER_PIC_FRONT_KLARA,
    ...
    TRAINER_PIC_FRONT_FLARE_GRUNT_M,
    TRAINER_PIC_FRONT_FLARE_GRUNT_F,
    TRAINER_PIC_FRONT_FLARE_LYSANDRE,
    TRAINER_PIC_FRONT_PLASMA_GRUNT_M,
    TRAINER_PIC_FRONT_PLASMA_GRUNT_F,
    TRAINER_PIC_FRONT_PLASMA_GHETSIS,
    TRAINER_PIC_FRONT_PLAYER_AVATAR,
    TRAINER_PIC_FRONT_PLAYER_OPPOSITE_AVATAR,
    ...
    // --- Back Pics (Starten automatisch nach den Front Pics) ---
    TRAINER_PIC_BACK_BRENDAN = TRAINER_PIC_FRONT_COUNT,
    TRAINER_PIC_BACK_MAY,
    TRAINER_PIC_BACK_RED,
    TRAINER_PIC_BACK_LEAF,
    TRAINER_PIC_BACK_ETHAN,
    TRAINER_PIC_BACK_LYRA,
    TRAINER_PIC_BACK_LUCAS,
    TRAINER_PIC_BACK_DAWN,
    TRAINER_PIC_BACK_HILBERT,
    TRAINER_PIC_BACK_HILDA,
    TRAINER_PIC_BACK_NATE,
    TRAINER_PIC_BACK_ROSA,
    TRAINER_PIC_BACK_CALEM,
    TRAINER_PIC_BACK_SERENA,
    TRAINER_PIC_BACK_ELIO,
    TRAINER_PIC_BACK_SELENE,
    TRAINER_PIC_BACK_VICTOR,
    TRAINER_PIC_BACK_GLORIA,
    TRAINER_PIC_BACK_FLORIAN,
    TRAINER_PIC_BACK_JULIANA,
...
#define FACILITY_CLASS_JAMES_ROCKET          0x69
#define FACILITY_CLASS_GALACTIC_GRUNT_M      0x6A
#define FACILITY_CLASS_GALACTIC_GRUNT_F      0x6B
#define FACILITY_CLASS_ASH                   0x6C
#define FACILITY_CLASS_KLARA                 0x6D

// FRLG Facility Classes (Shifted to start after custom classes)
#define FACILITY_CLASS_YOUNGSTER_FRLG        0x6E
#define FACILITY_CLASS_BURGLAR_FRLG          0x6F
#define FACILITY_CLASS_PSYCHIC_F_FRLG        0x70
#define FACILITY_CLASS_COOL_COUPLE_FRLG      0x71
#define FACILITY_CLASS_YOUNG_COUPLE_FRLG     0x72
#define FACILITY_CLASS_CRUSH_KIN_FRLG        0x73
#define FACILITY_CLASS_BIKER_FRLG            0x74
#define FACILITY_CLASS_CUE_BALL_FRLG         0x75
#define FACILITY_CLASS_HIKER_FRLG            0x76
#define FACILITY_CLASS_CRUSH_GIRL_FRLG       0x77
#define FACILITY_CLASS_BLACK_BELT_FRLG       0x78
#define FACILITY_CLASS_CAMPER_FRLG           0x79
#define FACILITY_CLASS_PKMN_BREEDER_FRLG     0x7A
#define FACILITY_CLASS_BUG_CATCHER_FRLG      0x7B
#define FACILITY_CLASS_TWINS_FRLG            0x7C
#define FACILITY_CLASS_PKMN_RANGER_F_FRLG    0x7D
#define FACILITY_CLASS_PKMN_RANGER_M_FRLG    0x7E
#define FACILITY_CLASS_COOLTRAINER_M_FRLG    0x7F
#define FACILITY_CLASS_PICNICKER_FRLG        0x80
#define FACILITY_CLASS_AROMA_LADY_FRLG       0x81
#define FACILITY_CLASS_COOLTRAINER_F_FRLG    0x82
#define FACILITY_CLASS_SWIMMER_M_FRLG        0x83
#define FACILITY_CLASS_SAILOR_FRLG           0x84
#define FACILITY_CLASS_SIS_AND_BRO_FRLG      0x85
#define FACILITY_CLASS_TUBER_FRLG            0x86
#define FACILITY_CLASS_LADY_FRLG             0x87
#define FACILITY_CLASS_SWIMMER_F_FRLG        0x88
#define FACILITY_CLASS_FISHERMAN_FRLG        0x89
#define FACILITY_CLASS_GENTLEMAN_FRLG        0x8A
#define FACILITY_CLASS_JUGGLER_FRLG          0x8B
#define FACILITY_CLASS_SUPER_NERD_FRLG       0x8C
#define FACILITY_CLASS_PSYCHIC_M_FRLG        0x8D
#define FACILITY_CLASS_ROCKER_FRLG           0x8E
#define FACILITY_CLASS_ENGINEER_FRLG         0x8F
#define FACILITY_CLASS_SCIENTIST_FRLG        0x90
#define FACILITY_CLASS_BEAUTY_FRLG           0x91
#define FACILITY_CLASS_LASS_FRLG             0x92

//NEW
#define FACILITY_CLASS_DP_COWGIRL            0x93
#define FACILITY_CLASS_JESSIE_ROCKET         0x94
#define FACILITY_CLASS_ADMIN_PROTON         0x95

#define FACILITY_CLASSES_COUNT               0x96
