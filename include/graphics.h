...
extern const u32 gItemIcon_Belüberry[];
extern const u16 gItemIconPalette_Belüberry[];
...
extern const u16 gObjectEventPal_Wes[];
extern const u16 gObjectEventPal_Rival_Ethan[];
extern const u16 gObjectEventPal_Rival_Lyra[];
extern const u16 gObjectEventPal_Rival_Lucas[];
extern const u16 gObjectEventPal_Rival_Dawn[];
extern const u16 gObjectEventPal_Rival_Hilbert[];
extern const u16 gObjectEventPal_Rival_Hilda[];
extern const u16 gObjectEventPal_Rival_Nate[];
extern const u16 gObjectEventPal_Rival_Rosa[];
extern const u16 gObjectEventPal_Rival_Calem[];
extern const u16 gObjectEventPal_Rival_Serena[];
extern const u16 gObjectEventPal_Rival_Elio[];
extern const u16 gObjectEventPal_Rival_Selene[];
extern const u16 gObjectEventPal_Rival_Victor[];
...
extern const u16 gTrainerPalette_Kalos_Malva[];
...
extern const u8 gTrainerBackPic_Juliana[];
...
extern const u16 gBagKantoPalette[];
extern const u16 gBagJohtoPalette[];
extern const u16 gBagKantoBlackPalette[];
...
extern const u16 gBattleArenaJudgementSymbolsPalette[];
