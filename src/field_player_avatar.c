...
u16 GetPlayerAvatarGraphicsIdByStateIdAndStyle(u8 stateId, u8 style)
{
    ...
    static const u16 playerSprites[NUM_PLAYER_CHARACTERS][9] =
    {
        ...
        {OBJ_EVENT_GFX_ETHAN, OBJ_EVENT_GFX_ETHAN_MACH_BIKE, OBJ_EVENT_GFX_ETHAN_ACRO_BIKE,
         OBJ_EVENT_GFX_ETHAN_SURFING, OBJ_EVENT_GFX_ETHAN_UNDERWATER, OBJ_EVENT_GFX_ETHAN_FIELD_MOVE,
         OBJ_EVENT_GFX_ETHAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_ETHAN_FIELD_MOVE},

        {OBJ_EVENT_GFX_LYRA, OBJ_EVENT_GFX_LYRA_MACH_BIKE, OBJ_EVENT_GFX_LYRA_ACRO_BIKE,
         OBJ_EVENT_GFX_LYRA_SURFING, OBJ_EVENT_GFX_LYRA_UNDERWATER, OBJ_EVENT_GFX_LYRA_FIELD_MOVE,
         OBJ_EVENT_GFX_LYRA_FISHING, OBJ_EVENT_GFX_LYRA_WATERING, OBJ_EVENT_GFX_LYRA_FIELD_MOVE},

        {OBJ_EVENT_GFX_LUCAS, OBJ_EVENT_GFX_LUCAS_MACH_BIKE, OBJ_EVENT_GFX_LUCAS_MACH_BIKE,
         OBJ_EVENT_GFX_LUCAS_SURFING, OBJ_EVENT_GFX_LUCAS_UNDERWATER, OBJ_EVENT_GFX_LUCAS_FIELD_MOVE,
         OBJ_EVENT_GFX_LUCAS_FISHING, OBJ_EVENT_GFX_LUCAS_WATERING, OBJ_EVENT_GFX_LUCAS_FIELD_MOVE},

        {OBJ_EVENT_GFX_DAWN, OBJ_EVENT_GFX_DAWN_MACH_BIKE, OBJ_EVENT_GFX_DAWN_MACH_BIKE,
         OBJ_EVENT_GFX_DAWN_SURFING, OBJ_EVENT_GFX_DAWN_UNDERWATER, OBJ_EVENT_GFX_DAWN_FIELD_MOVE,
         OBJ_EVENT_GFX_DAWN_FISHING, OBJ_EVENT_GFX_DAWN_WATERING, OBJ_EVENT_GFX_DAWN_FIELD_MOVE},

        {OBJ_EVENT_GFX_HILBERT, OBJ_EVENT_GFX_HILBERT_MACH_BIKE, OBJ_EVENT_GFX_HILBERT_ACRO_BIKE,
         OBJ_EVENT_GFX_HILBERT_SURFING, OBJ_EVENT_GFX_HILBERT_UNDERWATER, OBJ_EVENT_GFX_HILBERT_FIELD_MOVE,
         OBJ_EVENT_GFX_HILBERT_FISHING, OBJ_EVENT_GFX_HILBERT_WATERING, OBJ_EVENT_GFX_HILBERT_FIELD_MOVE},

        {OBJ_EVENT_GFX_HILDA, OBJ_EVENT_GFX_HILDA_MACH_BIKE, OBJ_EVENT_GFX_HILDA_ACRO_BIKE,
         OBJ_EVENT_GFX_HILDA_SURFING, OBJ_EVENT_GFX_HILDA_UNDERWATER, OBJ_EVENT_GFX_HILDA_FIELD_MOVE,
         OBJ_EVENT_GFX_HILDA_FISHING, OBJ_EVENT_GFX_HILDA_WATERING, OBJ_EVENT_GFX_HILDA_FIELD_MOVE},
    };
...
static void PlayerNotOnBikeMoving(u8 direction, u16 heldKeys)
{
    ...
    if (!(gPlayerAvatar.flags & PLAYER_AVATAR_FLAG_UNDERWATER)
     && GetPlayerSpritingState(heldKeys)
