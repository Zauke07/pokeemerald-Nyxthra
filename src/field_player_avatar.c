...
void ClearPlayerAvatarStateMask(u8 flags)
{
    gPlayerAvatar.flags &= ~flags;
}

static const u16 sRivalAvatarGfxIds[NUM_PLAYER_CHARACTERS][9] =  // [STYLE][STATE]
{
    // RIVAL BRENDAN (Style 0)
    [STYLE_BRENDAN] = {
        OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL,
        OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE,
        OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,
        OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING,
        OBJ_EVENT_GFX_BRENDAN_UNDERWATER,      // Fallback
        OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING,         // Fallback
        OBJ_EVENT_GFX_BRENDAN_WATERING,        // Fallback
        OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
    },
    ...
    [STYLE_MAY] = {
        ...
        OBJ_EVENT_GFX_MAY_UNDERWATER,          // Fallback
        OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING,             // Fallback
        OBJ_EVENT_GFX_MAY_WATERING,            // Fallback
        OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
    },
    
    // RIVAL RED (Style 2) - Nutze normale Player-Grafik als Fallback
    [STYLE_RED] = {
        OBJ_EVENT_GFX_RED,
    ...
    // RIVAL NATE (Style 10)
    [STYLE_NATE] = {
        OBJ_EVENT_GFX_RIVAL_NATE, OBJ_EVENT_GFX_RIVAL_NATE_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_NATE_ACRO_BIKE,
        OBJ_EVENT_GFX_NATE_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
    },
    // RIVAL ROSA (Style 11)
    [STYLE_ROSA] = {
        OBJ_EVENT_GFX_RIVAL_ROSA, OBJ_EVENT_GFX_RIVAL_ROSA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_ROSA_ACRO_BIKE,
        OBJ_EVENT_GFX_ROSA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
    },
    // RIVAL CALEM (Style 12)
    [STYLE_CALEM] = {
        OBJ_EVENT_GFX_RIVAL_CALEM, OBJ_EVENT_GFX_RIVAL_CALEM_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_CALEM_ACRO_BIKE,
        OBJ_EVENT_GFX_CALEM_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
    },
    // RIVAL SERENA (Style 13)
    [STYLE_SERENA] = {
        OBJ_EVENT_GFX_RIVAL_SERENA, OBJ_EVENT_GFX_RIVAL_SERENA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_SERENA_ACRO_BIKE,
        OBJ_EVENT_GFX_SERENA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
    },
    // RIVAL ELIO (Style 14)
    [STYLE_ELIO] = {
        OBJ_EVENT_GFX_RIVAL_ELIO, OBJ_EVENT_GFX_RIVAL_ELIO_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_ELIO_ACRO_BIKE,
        OBJ_EVENT_GFX_ELIO_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
    },
    // RIVAL SELENE (Style 15)
    [STYLE_SELENE] = {
        OBJ_EVENT_GFX_RIVAL_SELENE, OBJ_EVENT_GFX_RIVAL_SELENE_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_SELENE_ACRO_BIKE,
        OBJ_EVENT_GFX_SELENE_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
    },
    // RIVAL VICTOR (Style 16)
    [STYLE_VICTOR] = {
        OBJ_EVENT_GFX_RIVAL_VICTOR, OBJ_EVENT_GFX_RIVAL_VICTOR_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_VICTOR_ACRO_BIKE,
        OBJ_EVENT_GFX_VICTOR_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
    },
    // RIVAL GLORIA (Style 17)
    [STYLE_GLORIA] = {
        OBJ_EVENT_GFX_RIVAL_GLORIA, OBJ_EVENT_GFX_RIVAL_GLORIA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_GLORIA_ACRO_BIKE,
        OBJ_EVENT_GFX_GLORIA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
    },
    // RIVAL FLORIAN (Style 18)
    [STYLE_FLORIAN] = {
        OBJ_EVENT_GFX_RIVAL_FLORIAN, OBJ_EVENT_GFX_RIVAL_FLORIAN_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_FLORIAN_ACRO_BIKE,
        OBJ_EVENT_GFX_FLORIAN_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
    },
    // RIVAL JULIANA (Style 19)
    [STYLE_JULIANA] = {
        OBJ_EVENT_GFX_RIVAL_JULIANA, OBJ_EVENT_GFX_RIVAL_JULIANA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_JULIANA_ACRO_BIKE,
        OBJ_EVENT_GFX_JULIANA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_LEAF_FIELD_MOVE,
    },
};

// NEU: Style-basierte Player Avatar Grafiken
static const u16 sPlayerAvatarGfxIdsByStyle[NUM_PLAYER_CHARACTERS][9] =  // [STYLE][STATE]
{
    // BRENDAN
    [STYLE_BRENDAN] = {
        ...
        OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE, // VSSEEKER
    },
    ...
    // NATE (Style 10)
    [STYLE_NATE] = {
        OBJ_EVENT_GFX_NATE, OBJ_EVENT_GFX_NATE_MACH_BIKE, OBJ_EVENT_GFX_NATE_ACRO_BIKE,
        OBJ_EVENT_GFX_NATE_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_NATE_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_NATE_FIELD_MOVE,
    },
    // ROSA (Style 11)
    [STYLE_ROSA] = {
        OBJ_EVENT_GFX_ROSA, OBJ_EVENT_GFX_ROSA_MACH_BIKE, OBJ_EVENT_GFX_ROSA_ACRO_BIKE,
        OBJ_EVENT_GFX_ROSA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_ROSA_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_ROSA_FIELD_MOVE,
    },
    // CALEM (Style 12)
    [STYLE_CALEM] = {
        OBJ_EVENT_GFX_CALEM, OBJ_EVENT_GFX_CALEM_MACH_BIKE, OBJ_EVENT_GFX_CALEM_ACRO_BIKE,
        OBJ_EVENT_GFX_CALEM_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_CALEM_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_CALEM_FIELD_MOVE,
    },
    // SERENA (Style 13)
    [STYLE_SERENA] = {
        OBJ_EVENT_GFX_SERENA, OBJ_EVENT_GFX_SERENA_MACH_BIKE, OBJ_EVENT_GFX_SERENA_ACRO_BIKE,
        OBJ_EVENT_GFX_SERENA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_SERENA_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_SERENA_FIELD_MOVE,
    },
    // ELIO (Style 14)
    [STYLE_ELIO] = {
        OBJ_EVENT_GFX_ELIO, OBJ_EVENT_GFX_ELIO_MACH_BIKE, OBJ_EVENT_GFX_ELIO_ACRO_BIKE,
        OBJ_EVENT_GFX_ELIO_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_ELIO_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_ELIO_FIELD_MOVE,
    },
    // SELENE (Style 15)
    [STYLE_SELENE] = {
        OBJ_EVENT_GFX_SELENE, OBJ_EVENT_GFX_SELENE_MACH_BIKE, OBJ_EVENT_GFX_SELENE_ACRO_BIKE,
        OBJ_EVENT_GFX_SELENE_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_SELENE_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_SELENE_FIELD_MOVE,
    },
    // VICTOR (Style 16)
    [STYLE_VICTOR] = {
        OBJ_EVENT_GFX_VICTOR, OBJ_EVENT_GFX_VICTOR_MACH_BIKE, OBJ_EVENT_GFX_VICTOR_ACRO_BIKE,
        OBJ_EVENT_GFX_VICTOR_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_VICTOR_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_VICTOR_FIELD_MOVE,
    },
    // GLORIA (Style 17)
    [STYLE_GLORIA] = {
        OBJ_EVENT_GFX_GLORIA, OBJ_EVENT_GFX_GLORIA_MACH_BIKE, OBJ_EVENT_GFX_GLORIA_ACRO_BIKE,
        OBJ_EVENT_GFX_GLORIA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_GLORIA_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_GLORIA_FIELD_MOVE,
    },
    // FLORIAN (Style 18)
    [STYLE_FLORIAN] = {
        OBJ_EVENT_GFX_FLORIAN, OBJ_EVENT_GFX_FLORIAN_MACH_BIKE, OBJ_EVENT_GFX_FLORIAN_ACRO_BIKE,
        OBJ_EVENT_GFX_FLORIAN_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_FLORIAN_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_FLORIAN_FIELD_MOVE,
    },
    // JULIANA (Style 19)
    [STYLE_JULIANA] = {
        OBJ_EVENT_GFX_JULIANA, OBJ_EVENT_GFX_JULIANA_MACH_BIKE, OBJ_EVENT_GFX_JULIANA_ACRO_BIKE,
        OBJ_EVENT_GFX_JULIANA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_JULIANA_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_JULIANA_FIELD_MOVE,
    },
};


u16 GetPlayerAvatarGraphicsIdByStateIdAndStyle(u8 stateId, u8 style)
{
    // Greift auf das große Array zu, das wir oben definiert haben
    if (style >= NUM_PLAYER_CHARACTERS || stateId >= 9)
        return OBJ_EVENT_GFX_BRENDAN_NORMAL; // Fallback bei ungültigen Werten

    return sPlayerAvatarGfxIdsByStyle[style][stateId];
}

/*
u16 GetRivalAvatarGraphicsIdByStateIdAndStyle(u8 stateId, u8 style)
{
    static const u16 rivalSprites[NUM_PLAYER_CHARACTERS][9] =
    {
        // RIVAL BRENDAN - State:  0-NORMAL              1-MACH_BIKE                 2-ACRO_BIKE                 3-SURFING               4-UNDERWATER                5-FIELD_MOVE                6-FISHING               7-WATERING                8-VSSEEKER
        {OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL, OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE, OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE},
        
        // RIVAL MAY
        {OBJ_EVENT_GFX_RIVAL_MAY_NORMAL, OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_MAY_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE, OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE},
        
        // RIVAL RED (Fallbacks wenn keine Rival-Grafik existiert)
        {OBJ_EVENT_GFX_RED, OBJ_EVENT_GFX_RED_MACH_BIKE, OBJ_EVENT_GFX_RED_ACRO_BIKE, OBJ_EVENT_GFX_RED_SURFING, OBJ_EVENT_GFX_RED_UNDERWATER, OBJ_EVENT_GFX_RED_FIELD_MOVE, OBJ_EVENT_GFX_RED_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RED_FIELD_MOVE},
        
        // RIVAL LEAF
        {OBJ_EVENT_GFX_LEAF, OBJ_EVENT_GFX_LEAF_MACH_BIKE, OBJ_EVENT_GFX_LEAF_ACRO_BIKE, OBJ_EVENT_GFX_LEAF_SURFING, OBJ_EVENT_GFX_LEAF_UNDERWATER, OBJ_EVENT_GFX_LEAF_FIELD_MOVE, OBJ_EVENT_GFX_LEAF_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_LEAF_FIELD_MOVE},
        
        // RIVAL ETHAN
        {OBJ_EVENT_GFX_ETHAN, OBJ_EVENT_GFX_ETHAN_MACH_BIKE, OBJ_EVENT_GFX_ETHAN_ACRO_BIKE, OBJ_EVENT_GFX_ETHAN_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_ETHAN_FIELD_MOVE, OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_ETHAN_FIELD_MOVE},
        
        // RIVAL LYRA
        {OBJ_EVENT_GFX_LYRA, OBJ_EVENT_GFX_LYRA_MACH_BIKE, OBJ_EVENT_GFX_LYRA_ACRO_BIKE, OBJ_EVENT_GFX_LYRA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_LYRA_FIELD_MOVE, OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_LYRA_FIELD_MOVE},
        
        // RIVAL LUCAS
        {OBJ_EVENT_GFX_LUCAS, OBJ_EVENT_GFX_LUCAS_MACH_BIKE, OBJ_EVENT_GFX_LUCAS_MACH_BIKE, OBJ_EVENT_GFX_LUCAS_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_LUCAS_FIELD_MOVE, OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_LUCAS_FIELD_MOVE},
        
        // RIVAL DAWN
        {OBJ_EVENT_GFX_DAWN, OBJ_EVENT_GFX_DAWN_MACH_BIKE, OBJ_EVENT_GFX_DAWN_MACH_BIKE, OBJ_EVENT_GFX_DAWN_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_DAWN_FIELD_MOVE, OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_DAWN_FIELD_MOVE},
        
        // RIVAL HILBERT
        {OBJ_EVENT_GFX_HILBERT, OBJ_EVENT_GFX_HILBERT, OBJ_EVENT_GFX_HILBERT, OBJ_EVENT_GFX_HILBERT_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_HILBERT_FIELD_MOVE, OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_HILBERT_FIELD_MOVE},
        
        // RIVAL HILDA
        {OBJ_EVENT_GFX_HILDA, OBJ_EVENT_GFX_HILDA, OBJ_EVENT_GFX_HILDA, OBJ_EVENT_GFX_HILDA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_HILDA_FIELD_MOVE, OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_HILDA_FIELD_MOVE},
    };

    if (style >= NUM_PLAYER_CHARACTERS || stateId >= 9)
        return OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL;

    return rivalSprites[style][stateId];
}
*/
...
void (*const sPlayerAvatarTransitionFuncs[])(struct ObjectEvent *) =
{
...
static const u16 sPlayerAvatarGfxToStateFlag[PLAYER_STYLE_COUNT][5][2] =
{
    ...
    {
        {OBJ_EVENT_GFX_HILBERT,            PLAYER_AVATAR_FLAG_ON_FOOT},
    ...
    [PLAYER_OUTFIT_HILDA] = 
    {
        {OBJ_EVENT_GFX_HILDA,            PLAYER_AVATAR_FLAG_ON_FOOT},
    ...
    [PLAYER_OUTFIT_NATE] = 
    {
        {OBJ_EVENT_GFX_NATE,               PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_NATE_MACH_BIKE,     PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_NATE_ACRO_BIKE,     PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_NATE_SURFING,       PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_BRENDAN_UNDERWATER, PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [PLAYER_OUTFIT_ROSA] = 
    {
        {OBJ_EVENT_GFX_ROSA,               PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_ROSA_MACH_BIKE,     PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_ROSA_ACRO_BIKE,     PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_ROSA_SURFING,       PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_MAY_UNDERWATER,     PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [PLAYER_OUTFIT_CALEM] = 
    {
        {OBJ_EVENT_GFX_CALEM,               PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_CALEM_MACH_BIKE,     PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_CALEM_ACRO_BIKE,     PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_CALEM_SURFING,       PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,  PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [PLAYER_OUTFIT_SERENA] = 
    {
        {OBJ_EVENT_GFX_SERENA,              PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SERENA_MACH_BIKE,    PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SERENA_ACRO_BIKE,    PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SERENA_SURFING,      PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_MAY_UNDERWATER,      PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [PLAYER_OUTFIT_ELIO] = 
    {
        {OBJ_EVENT_GFX_ELIO,                PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_ELIO_MACH_BIKE,      PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_ELIO_ACRO_BIKE,      PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_ELIO_SURFING,        PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,  PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [PLAYER_OUTFIT_SELENE] = 
    {
        {OBJ_EVENT_GFX_SELENE,              PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_SELENE_MACH_BIKE,    PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_SELENE_ACRO_BIKE,    PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_SELENE_SURFING,      PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_MAY_UNDERWATER,      PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [PLAYER_OUTFIT_VICTOR] = 
    {
        {OBJ_EVENT_GFX_VICTOR,              PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_VICTOR_MACH_BIKE,    PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_VICTOR_ACRO_BIKE,    PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_VICTOR_SURFING,      PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,  PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [PLAYER_OUTFIT_GLORIA] = 
    {
        {OBJ_EVENT_GFX_GLORIA,              PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_GLORIA_MACH_BIKE,    PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_GLORIA_ACRO_BIKE,    PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_GLORIA_SURFING,      PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_MAY_UNDERWATER,      PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [PLAYER_OUTFIT_FLORIAN] = 
    {
        {OBJ_EVENT_GFX_FLORIAN,             PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_FLORIAN_MACH_BIKE,   PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_FLORIAN_ACRO_BIKE,   PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_FLORIAN_SURFING,     PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_BRENDAN_UNDERWATER,  PLAYER_AVATAR_FLAG_UNDERWATER},
    },
    [PLAYER_OUTFIT_JULIANA] = 
    {
        {OBJ_EVENT_GFX_JULIANA,             PLAYER_AVATAR_FLAG_ON_FOOT},
        {OBJ_EVENT_GFX_JULIANA_MACH_BIKE,   PLAYER_AVATAR_FLAG_MACH_BIKE},
        {OBJ_EVENT_GFX_JULIANA_ACRO_BIKE,   PLAYER_AVATAR_FLAG_ACRO_BIKE},
        {OBJ_EVENT_GFX_JULIANA_SURFING,     PLAYER_AVATAR_FLAG_SURFING},
        {OBJ_EVENT_GFX_MAY_UNDERWATER,      PLAYER_AVATAR_FLAG_UNDERWATER},
    },
};
...
void PlayerStep(u8 direction, u16 newKeys, u16 heldKeys)
{
    ...
    Rogue_OverworldCB(newKeys, heldKeys, TRUE);
...
{
    // ✅ NEU: Verwende gSaveBlock2Ptr->playerStyles[0] statt gPlayerAvatar.style
    ObjectEventSetGraphicsId(objEvent, GetPlayerAvatarGraphicsIdByStyleAndState(gSaveBlock2Ptr->playerStyles[0], PLAYER_AVATAR_STATE_NORMAL));
...
{
    ObjectEventSetGraphicsId(objEvent, GetPlayerAvatarGraphicsIdByStyleAndState(gSaveBlock2Ptr->playerStyles[0], PLAYER_AVATAR_STATE_MACH_BIKE));
    ObjectEventTurn(objEvent, objEvent->movementDirection);
...
{
    ObjectEventSetGraphicsId(objEvent, GetPlayerAvatarGraphicsIdByStyleAndState(gSaveBlock2Ptr->playerStyles[0], PLAYER_AVATAR_STATE_ACRO_BIKE));
    ObjectEventTurn(objEvent, objEvent->movementDirection);
...
static void PlayerAvatarTransition_Surfing(struct ObjectEvent *objEvent)
{
    ...
    ObjectEventSetGraphicsId(objEvent, GetPlayerAvatarGraphicsIdByStyleAndState(gSaveBlock2Ptr->playerStyles[0], PLAYER_AVATAR_STATE_SURFING));
    ObjectEventTurn(objEvent, objEvent->movementDirection);
...
{
    ObjectEventSetGraphicsId(objEvent, GetPlayerAvatarGraphicsIdByStyleAndState(gSaveBlock2Ptr->playerStyles[0], PLAYER_AVATAR_STATE_UNDERWATER));
    ObjectEventTurn(objEvent, objEvent->movementDirection);
...
{
    // Konvertiere Gender zu Style (nur für Brendan/May)
    u8 style = (gender == MALE) ? STYLE_BRENDAN : STYLE_MAY;
    
    if (style >= NUM_PLAYER_CHARACTERS || state >= 9)
        return OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL;
    
    return sRivalAvatarGfxIds[style][state];
}

// NEUE Funktion (Style-basiert)
u16 GetRivalAvatarGraphicsIdByStateIdAndStyle(u8 state, u8 style)
{
    if (style >= NUM_PLAYER_CHARACTERS || state >= 9)
        return OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL;
...
{
    return GetPlayerAvatarGraphicsIdByStyleAndState(gSaveBlock2Ptr->playerStyles[0], state);
}

u8 GetPlayerStateByGraphicsId(u16 gfxId)
{
    if (gfxId == GetPlayerAvatarGraphicsIdByStyleAndState(gSaveBlock2Ptr->playerStyles[0], PLAYER_AVATAR_STATE_FIELD_MOVE))
        return PLAYER_AVATAR_STATE_FIELD_MOVE;
...
u16 GetPlayerAvatarGraphicsIdByStateIdAndGender(u8 state, u8 gender)
{
    ...
    return sPlayerAvatarGfxIdsByStyle[style][state];
}

u16 GetFRLGAvatarGraphicsIdByGender(u8 gender)
{
    u8 style = (gender == MALE) ? STYLE_BRENDAN : STYLE_MAY;
    return GetPlayerAvatarGraphicsIdByStyleAndState(style, PLAYER_AVATAR_STATE_NORMAL);
}
...
u8 GetPlayerAvatarGenderByGraphicsId(u16 gfxId)
{
    ...
    case OBJ_EVENT_GFX_LYRA_RIDING:
    case OBJ_EVENT_GFX_DAWN:
    ...
    case OBJ_EVENT_GFX_HILDA_SURFING:
    ...
    case OBJ_EVENT_GFX_SERENA_SURFING:
    case OBJ_EVENT_GFX_SERENA_FIELD_MOVE:
    case OBJ_EVENT_GFX_SERENA_FISHING:
    case OBJ_EVENT_GFX_SERENA_RIDING:
    case OBJ_EVENT_GFX_SELENE:
    case OBJ_EVENT_GFX_SELENE_MACH_BIKE:
    case OBJ_EVENT_GFX_SELENE_ACRO_BIKE:
    case OBJ_EVENT_GFX_SELENE_SURFING:
    case OBJ_EVENT_GFX_SELENE_FIELD_MOVE:
    case OBJ_EVENT_GFX_SELENE_FISHING:
    case OBJ_EVENT_GFX_SELENE_RIDING:
    case OBJ_EVENT_GFX_GLORIA: // Gen 8: Gloria aus Pokémon Schwert & Schild
    case OBJ_EVENT_GFX_GLORIA_MACH_BIKE:
    case OBJ_EVENT_GFX_GLORIA_ACRO_BIKE:
    case OBJ_EVENT_GFX_GLORIA_SURFING:
    case OBJ_EVENT_GFX_GLORIA_FIELD_MOVE:
    case OBJ_EVENT_GFX_GLORIA_FISHING:
    case OBJ_EVENT_GFX_GLORIA_RIDING:
    case OBJ_EVENT_GFX_JULIANA: // Gen 9: Juliana aus Pokémon Karmesin & Purpur
    case OBJ_EVENT_GFX_JULIANA_MACH_BIKE:
    case OBJ_EVENT_GFX_JULIANA_ACRO_BIKE:
    case OBJ_EVENT_GFX_JULIANA_SURFING:
    ...
    case OBJ_EVENT_GFX_ETHAN_RIDING:
    case OBJ_EVENT_GFX_LUCAS:
    case OBJ_EVENT_GFX_LUCAS_MACH_BIKE:
    case OBJ_EVENT_GFX_LUCAS_ACRO_BIKE:
    case OBJ_EVENT_GFX_LUCAS_SURFING:
    ...
    case OBJ_EVENT_GFX_HILBERT_SURFING:
    ...
    case OBJ_EVENT_GFX_CALEM_SURFING:
    case OBJ_EVENT_GFX_CALEM_FIELD_MOVE:
    case OBJ_EVENT_GFX_CALEM_FISHING:
    case OBJ_EVENT_GFX_CALEM_RIDING:
    case OBJ_EVENT_GFX_ELIO:
    case OBJ_EVENT_GFX_ELIO_MACH_BIKE:
    case OBJ_EVENT_GFX_ELIO_ACRO_BIKE:
    case OBJ_EVENT_GFX_ELIO_SURFING:
    case OBJ_EVENT_GFX_ELIO_FIELD_MOVE:
    case OBJ_EVENT_GFX_ELIO_FISHING:
    case OBJ_EVENT_GFX_ELIO_RIDING:
    case OBJ_EVENT_GFX_VICTOR: // Gen 8: Victor aus Pokémon Schwert & Schild
    case OBJ_EVENT_GFX_VICTOR_MACH_BIKE:
    case OBJ_EVENT_GFX_VICTOR_ACRO_BIKE:
    case OBJ_EVENT_GFX_VICTOR_SURFING:
    case OBJ_EVENT_GFX_VICTOR_FIELD_MOVE:
    case OBJ_EVENT_GFX_VICTOR_FISHING:
    case OBJ_EVENT_GFX_VICTOR_RIDING:
    case OBJ_EVENT_GFX_FLORIAN: // Gen 9: Florian aus Pokémon Karmesin & Purpur
    case OBJ_EVENT_GFX_FLORIAN_MACH_BIKE:
    case OBJ_EVENT_GFX_FLORIAN_ACRO_BIKE:
    case OBJ_EVENT_GFX_FLORIAN_SURFING:
    ...
    default:
        return MALE; // Falls ein neuer Charakter vergessen wurde
    }
}
...
u8 GetPlayerAvatarStateTransitionByGraphicsId(u16 graphicsId, u8 style)
{
    ...
    for (i = 0; i < 9; i++)  // 9 bleibt als Länge (alle States)
    {
        if (sPlayerAvatarGfxIdsByStyle[style][i] == graphicsId)
        {
            switch (i)
            {
            ...
            // PLAYER_AVATAR_STATE_FISHING und PLAYER_AVATAR_STATE_WATERING werden weggelassen
            default:
...
u16 GetPlayerAvatarGraphicsIdByStyleAndState(u8 style, u8 state)
{
    if (style >= NUM_PLAYER_CHARACTERS || state >= 9)
        return OBJ_EVENT_GFX_BRENDAN_NORMAL;

    return sPlayerAvatarGfxIdsByStyle[style][state]; // ← Array-Index!
}

u16 GetPlayerAvatarGraphicsIdByStyleAndFlags(u8 style, u8 flags)
{
    // Konvertiere FLAGS zu STATE-Index:
    u8 state = PLAYER_AVATAR_STATE_NORMAL; // Default

    if (flags & PLAYER_AVATAR_FLAG_SURFING)
        state = PLAYER_AVATAR_STATE_SURFING;
    else if (flags & PLAYER_AVATAR_FLAG_UNDERWATER)
        state = PLAYER_AVATAR_STATE_UNDERWATER;
    else if (flags & PLAYER_AVATAR_FLAG_MACH_BIKE)
        state = PLAYER_AVATAR_STATE_MACH_BIKE;
    else if (flags & PLAYER_AVATAR_FLAG_ACRO_BIKE)
        state = PLAYER_AVATAR_STATE_ACRO_BIKE;

    return GetPlayerAvatarGraphicsIdByStyleAndState(style, state);
}
...
void InitPlayerAvatar(s16 x, s16 y, u8 direction, u8 playerStyle)
{
    ...
    gPlayerAvatar.style = playerStyle;  // ✅ Statt `gender` speichern wir `playerStyle`
...
static void CreateStopSurfingTask(u8 direction)
{
    ...
    SetPlayerAvatarStateMask(gPlayerAvatar.flags); // ✨ setzt auch Sprite korrekt
    gPlayerAvatar.preventStep = TRUE;
...
{
    const s16 moreDotsChance[][GENDER_COUNT] =
    {
        [OLD_ROD]   = {0, 0},
        [GOOD_ROD]  = {40, 10},
        [SUPER_ROD] = {70, 30}
...
/*
void RememberPlayerAvatarState(void)
{
    sLastKnownAvatarFlags = gPlayerAvatar.flags;
}

void RestorePlayerAvatarState(void)
{
    gPlayerAvatar.flags = sLastKnownAvatarFlags;

    if (gPlayerAvatar.objectEventId != 0xFF)
    {
        SetObjectEventGraphicsId(&gObjectEvents[gPlayerAvatar.objectEventId],
            GetPlayerAvatarGraphicsIdByStyleAndState(
