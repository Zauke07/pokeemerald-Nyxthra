...
static const u16 sRivalAvatarGfxIds[NUM_PLAYER_CHARACTERS][9] =  // [STYLE][STATE]
{
    ...
    // RIVAL NATE (Style 10)
    [STYLE_NATE] = {
        OBJ_EVENT_GFX_RIVAL_NATE, OBJ_EVENT_GFX_RIVAL_RED_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_RED_ACRO_BIKE,
        OBJ_EVENT_GFX_RED_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_RED_FIELD_MOVE,
    },
    // RIVAL ROSA (Style 11)
    [STYLE_ROSA] = {
        OBJ_EVENT_GFX_RIVAL_ROSA, OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_ROSA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
    },
    ...
    [STYLE_CALEM] = {
        ...
        OBJ_EVENT_GFX_CALEM_FISHING, OBJ_EVENT_GFX_CALEM_WATERING, OBJ_EVENT_GFX_CALEM_FIELD_MOVE,
    },
    // RIVAL SERENA (Style 13)
    [STYLE_SERENA] = {
        OBJ_EVENT_GFX_RIVAL_SERENA, OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_SERENA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
    },
    // RIVAL ELIO (Style 14)
    [STYLE_ELIO] = {
        OBJ_EVENT_GFX_RIVAL_ELIO, OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,
        OBJ_EVENT_GFX_ELIO_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
    },
    // RIVAL SELENE (Style 15)
    [STYLE_SELENE] = {
        OBJ_EVENT_GFX_RIVAL_SELENE, OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_SELENE_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
    },
    // RIVAL VICTOR (Style 16)
    [STYLE_VICTOR] = {
        OBJ_EVENT_GFX_RIVAL_VICTOR, OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,
        OBJ_EVENT_GFX_VICTOR_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
    },
    // RIVAL GLORIA (Style 17)
    [STYLE_GLORIA] = {
        OBJ_EVENT_GFX_RIVAL_GLORIA, OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_GLORIA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
    },
    // RIVAL FLORIAN (Style 18)
    [STYLE_FLORIAN] = {
        OBJ_EVENT_GFX_RIVAL_FLORIAN, OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE,
        OBJ_EVENT_GFX_FLORIAN_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_RIVAL_BRENDAN_FIELD_MOVE,
    },
    // RIVAL JULIANA (Style 19)
    [STYLE_JULIANA] = {
        OBJ_EVENT_GFX_RIVAL_JULIANA, OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_JULIANA_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_RIVAL_MAY_FIELD_MOVE,
    },
};
...
static const u16 sPlayerAvatarGfxIdsByStyle[NUM_PLAYER_CHARACTERS][9] =  // [STYLE][STATE]
{
    ...
    // NATE (Style 10)
    [STYLE_NATE] = {
        OBJ_EVENT_GFX_NATE, OBJ_EVENT_GFX_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
        OBJ_EVENT_GFX_BRENDAN_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
    },
    // ROSA (Style 11)
    [STYLE_ROSA] = {
        OBJ_EVENT_GFX_ROSA, OBJ_EVENT_GFX_MAY_MACH_BIKE, OBJ_EVENT_GFX_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_MAY_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
    },
    // CALEM (Style 12)
    [STYLE_CALEM] = {
        OBJ_EVENT_GFX_CALEM, OBJ_EVENT_GFX_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
        OBJ_EVENT_GFX_CALEM_SURFING, OBJ_EVENT_GFX_CALEM_UNDERWATER, OBJ_EVENT_GFX_CALEM_FIELD_MOVE,
        OBJ_EVENT_GFX_CALEM_FISHING, OBJ_EVENT_GFX_CALEM_WATERING, OBJ_EVENT_GFX_CALEM_FIELD_MOVE,
    },
    // SERENA (Style 13)
    [STYLE_SERENA] = {
        OBJ_EVENT_GFX_SERENA, OBJ_EVENT_GFX_MAY_MACH_BIKE, OBJ_EVENT_GFX_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_MAY_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
    },
    // ELIO (Style 14)
    [STYLE_ELIO] = {
        OBJ_EVENT_GFX_ELIO, OBJ_EVENT_GFX_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
        OBJ_EVENT_GFX_BRENDAN_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
    },
    // SELENE (Style 15)
    [STYLE_SELENE] = {
        OBJ_EVENT_GFX_SELENE, OBJ_EVENT_GFX_MAY_MACH_BIKE, OBJ_EVENT_GFX_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_MAY_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
    },
    // VICTOR (Style 16)
    [STYLE_VICTOR] = {
        OBJ_EVENT_GFX_VICTOR, OBJ_EVENT_GFX_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
        OBJ_EVENT_GFX_BRENDAN_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
    },
    // GLORIA (Style 17)
    [STYLE_GLORIA] = {
        OBJ_EVENT_GFX_GLORIA, OBJ_EVENT_GFX_MAY_MACH_BIKE, OBJ_EVENT_GFX_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_MAY_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
    },
    // FLORIAN (Style 18)
    [STYLE_FLORIAN] = {
        OBJ_EVENT_GFX_FLORIAN, OBJ_EVENT_GFX_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_BRENDAN_ACRO_BIKE,
        OBJ_EVENT_GFX_BRENDAN_SURFING, OBJ_EVENT_GFX_BRENDAN_UNDERWATER, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
        OBJ_EVENT_GFX_BRENDAN_FISHING, OBJ_EVENT_GFX_BRENDAN_WATERING, OBJ_EVENT_GFX_BRENDAN_FIELD_MOVE,
    },
    // JULIANA (Style 19)
    [STYLE_JULIANA] = {
        OBJ_EVENT_GFX_JULIANA, OBJ_EVENT_GFX_MAY_MACH_BIKE, OBJ_EVENT_GFX_MAY_ACRO_BIKE,
        OBJ_EVENT_GFX_MAY_SURFING, OBJ_EVENT_GFX_MAY_UNDERWATER, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
        OBJ_EVENT_GFX_MAY_FISHING, OBJ_EVENT_GFX_MAY_WATERING, OBJ_EVENT_GFX_MAY_FIELD_MOVE,
    },
};
