...
u8 GetBattlerLinkPlayerGender(enum BattlerId battler) { (void)battler; return 0; }
...
void RecordedBattle_CopyBattlerMoves(enum BattlerId battler) { (void)battler; }
void RecordedBattle_CheckMovesetChanges(u8 mode) { (void)mode; }
u64 GetAiScriptsInRecordedBattle(enum BattlerId battler) { (void)battler; return 0; }
