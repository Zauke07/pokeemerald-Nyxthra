...
static const u8 sText_HoldEffect[] = _("Halt-Effekt");
static const u8 sText_PP[] = _("AP");
static const u8 sText_Types[] = _("Typen");
static const u8 sText_Stats[] = _("Werte");
static const u8 sText_StatStages[] = _("Statusstufen");
...
static const u8 sText_Torment[] = _("Folter");
static const u8 sText_Bide[] = _("Verzweifler");
static const u8 sText_LockConfuse[] = _("Sperrverwirrung");
static const u8 sText_MultipleTurns[] = _("Mehrere Runden");
static const u8 sText_Wrapped[] = _("Umwickelt");
static const u8 sText_Powder[] = _("Pulver");
static const u8 sText_Infatuation[] = _("Verliebtheit");
static const u8 sText_DefenseCurl[] = _("Einigler");
static const u8 sText_Transformed[] = _("Verwandelt");
static const u8 sText_Recharge[] = _("Aufladen");
static const u8 sText_Rage[] = _("Raserei");
static const u8 sText_Substitute[] = _("Delegator");
static const u8 sText_DestinyBond[] = _("Abgangsbund");
static const u8 sText_EscapePrevention[] = _("Fluchtverhinderung");
static const u8 sText_Nightmare[] = _("Albtraum");
static const u8 sText_Cursed[] = _("Verflucht");
static const u8 sText_Foresight[] = _("Gesichte");
static const u8 sText_DragonCheer[] = _("Drachenjubel");
static const u8 sText_FocusEnergy[] = _("Energiefokus");
static const u8 sText_LeechSeedHealer[] = _("Egelsamen Heiler");
static const u8 sText_LeechSeeded[] = _("Egelsamen");
...
static const u8 sText_Underground[] = _("Untergrund");
static const u8 sText_Minimized[] = _("Mikro");
static const u8 sText_ChargedUp[] = _("Aufgeladen");
static const u8 sText_Rooted[] = _("Gewurzelt");
static const u8 sText_Yawn[] = _("Gähner");
static const u8 sText_ImprisonedOthers[] = _("Andere eingesperrt");
static const u8 sText_Grudge[] = _("Groll");
static const u8 sText_GastroAcid[] = _("Magensäure");
static const u8 sText_Embargo[] = _("Embargo");
static const u8 sText_Underwater[] = _("Unterwasser");
static const u8 sText_Trace[] = _("Fährte");
static const u8 sText_SmackedDown[] = _("Abschlag");
...
static const u8 sText_MiracleEyed[] = _("Wunderauge");
static const u8 sText_MagnetRise[] = _("Magnetflug");
static const u8 sText_HealBlock[] = _("Heilblockade");
static const u8 sText_AquaRing[] = _("Wasserring");
static const u8 sText_LaserFocus[] = _("Laserfokus");
static const u8 sText_PowerTrick[] = _("Krafttrick");
static const u8 sText_SkyDropped[] = _("Himmelssturz");
static const u8 sText_Electrified[] = _("Elektrisiert");
static const u8 sText_MudSport[] = _("Lehmsuhler");
static const u8 sText_WaterSport[] = _("Nassmacher");
static const u8 sText_InfiniteConfusion[] = _("Unendliche Verwirrung");
static const u8 sText_SaltCure[] = _("Salzheilung");
static const u8 sText_SyrupBomb[] = _("Sirupbombe");
static const u8 sText_GlaiveRush[] = _("Klingensturm");
static const u8 sText_Reflect[] = _("Reflektor");
static const u8 sText_LightScreen[] = _("Lichtschild");
static const u8 sText_StickyWeb[] = _("Klebenetz");
static const u8 sText_Spikes[] = _("Stachler");
static const u8 sText_Safeguard[] = _("Bodyguard");
static const u8 sText_FutureAttack[] = _("Zukunftsangriff");
static const u8 sText_Mist[] = _("Nebel");
...
static const u8 sText_Steelsurge[] = _("Stahlschwarm");
static const u8 sText_DamageNonTypes[] = _("Schaden Nicht-Typen");
static const u8 sText_Rainbow[] = _("Regenbogen");
static const u8 sText_SeaOfFire[] = _("Feuermeer");
static const u8 sText_Swamp[] = _("Sumpf");
static const u8 sText_CheckBadMove[] = _("Schlechten Zug prüfen");
static const u8 sText_TryToFaint[] = _("Versuchen zu besiegen");
static const u8 sText_CheckViability[] = _("Lebensfähigkeit prüfen");
static const u8 sText_ForceSetupFirstTurn[] = _("Erste Runde aufbauen erzwingen");
static const u8 sText_SetUpFirstTurn[] = _("Erste Runde aufbauen");
static const u8 sText_Risky[] = _("Riskant");
static const u8 sText_PreferStrongestMove[] = _("Bevorzugt stärkste Attacke");
static const u8 sText_PreferBatonPass[] = _("Bevorzugt Stafette");
static const u8 sText_DoubleBattle[] = _("Doppelkampf");
static const u8 sText_HpAware[] = _("KP-bewusst");
static const u8 sText_PowerfulStatus[] = _("Starker Status");
static const u8 sText_NegateUnaware[] = _("Unkenntnis negieren");
static const u8 sText_WillSuicide[] = _("Wird Selbstmord begehen");
static const u8 sText_HelpPartner[] = _("Partner helfen");
static const u8 sText_PreferStatusMoves[] = _("Bevorzugt Status-Attacken");
static const u8 sText_Stall[] = _("Hinauszögern");
static const u8 sText_SmartSwitching[] = _("Kluges Wechseln");
static const u8 sText_Conservative[] = _("Konservativ");
static const u8 sText_AcePokemon[] = _("Ass-Pokémon");
static const u8 sText_Omniscient[] = _("Allwissend");
static const u8 sText_SmartMonChoices[] = _("Kluge Mon-Wahl");
static const u8 sText_SequenceSwitching[] = _("Reihenfolge-Wechsel");
static const u8 sText_DoubleAcePokemon[] = _("Doppeltes Ass-Pokémon");
static const u8 sText_WeighAbilityPrediction[] = _("Fähigkeitsvorhersage abwägen");
static const u8 sText_PreferHighestDamageMove[] = _("Bevorzugt höchste Schadensattacke");
static const u8 sText_PredictSwitch[] = _("Wechsel vorhersagen");
static const u8 sText_PredictIncomingMon[] = _("Eintreffendes Mon vorhersagen");
static const u8 sText_DynamicFunc[] = _("Dynamische Funktion");
static const u8 sText_Roaming[] = _("Umherstreifend");
...
static const u8 sText_HoldEffectRestoreHp[] = _("KP wiederherstellen");
static const u8 sText_HoldEffectCurePar[] = _("Heilt Paralyse");
static const u8 sText_HoldEffectCureSlp[] = _("Heilt Schlaf");
static const u8 sText_HoldEffectCurePsn[] = _("Heilt Gift");
static const u8 sText_HoldEffectCureBrn[] = _("Heilt Verbrennung");
static const u8 sText_HoldEffectCureFrz[] = _("Heilt Einfrieren");
static const u8 sText_HoldEffectRestorePp[] = _("AP wiederherstellen");
static const u8 sText_HoldEffectCureConfusion[] = _("Heilt Verwirrung");
static const u8 sText_HoldEffectCureStatus[] = _("Heilt Status");
static const u8 sText_HoldEffectConfuseSpicy[] = _("Verwirrt Scharf");
static const u8 sText_HoldEffectConfuseDry[] = _("Verwirrt Trocken");
static const u8 sText_HoldEffectConfuseSweet[] = _("Verwirrt Süß");
static const u8 sText_HoldEffectConfuseBitter[] = _("Verwirrt Bitter");
static const u8 sText_HoldEffectConfuseSour[] = _("Verwirrt Sauer");
static const u8 sText_HoldEffectAttackUp[] = _("Angriff hoch");
static const u8 sText_HoldEffectDefenseUp[] = _("Verteidigung hoch");
static const u8 sText_HoldEffectSpeedUp[] = _("Initiative hoch");
static const u8 sText_HoldEffectSpAttackUp[] = _("Spez. Angriff hoch");
static const u8 sText_HoldEffectSpDefenseUp[] = _("Spez. Verteidigung hoch");
static const u8 sText_HoldEffectCriticalUp[] = _("Kritisch hoch");
static const u8 sText_HoldEffectRandomStatUp[] = _("Zufälliger Wert hoch");
static const u8 sText_HoldEffectEvasionUp[] = _("Ausweichen hoch");
static const u8 sText_HoldEffectRestoreStats[] = _("Werte wiederherstellen");
static const u8 sText_HoldEffectMachoBrace[] = _("Macho-Band");
static const u8 sText_HoldEffectExpShare[] = _("EP-Teiler");
static const u8 sText_HoldEffectQuickClaw[] = _("Flinkklaue");
static const u8 sText_HoldEffectFriendshipUp[] = _("Freundschaft hoch");
static const u8 sText_HoldEffectMentalHerb[] = _("Mentalkraut");
static const u8 sText_HoldEffectChoiceBand[] = _("Wahlband");
static const u8 sText_HoldEffectFlinch[] = _("Zurückschrecken");
static const u8 sText_HoldEffectBugPower[] = _("Käferkraft");
static const u8 sText_HoldEffectDoublePrize[] = _("Doppelter Preis");
static const u8 sText_HoldEffectRepel[] = _("Abwehr");
static const u8 sText_HoldEffectSoulDew[] = _("Seelentau");
static const u8 sText_HoldEffectDeepSeaTooth[] = _("Abysszahn");
static const u8 sText_HoldEffectDeepSeaScale[] = _("Abyssplatte");
static const u8 sText_HoldEffectCanAlwaysRun[] = _("Kann immer fliehen");
static const u8 sText_HoldEffectPreventEvolve[] = _("Verhindert Entwicklung");
static const u8 sText_HoldEffectFocusBand[] = _("Fokus-Band");
static const u8 sText_HoldEffectLuckyEgg[] = _("Glücks-Ei");
static const u8 sText_HoldEffectScopeLens[] = _("Scope-Linse");
static const u8 sText_HoldEffectSteelPower[] = _("Stahlkraft");
static const u8 sText_HoldEffectLeftovers[] = _("Überreste");
static const u8 sText_HoldEffectDragonScale[] = _("Drachenschuppe");
static const u8 sText_HoldEffectLightBall[] = _("Lichtball");
static const u8 sText_HoldEffectTypePower[] = _("Typkraft");
static const u8 sText_HoldEffectGroundPower[] = _("Bodenkraft");
static const u8 sText_HoldEffectRockPower[] = _("Gesteinskraft");
static const u8 sText_HoldEffectGrassPower[] = _("Pflanzenkraft");
static const u8 sText_HoldEffectDarkPower[] = _("Unlichtkraft");
static const u8 sText_HoldEffectFightingPower[] = _("Kampfkraft");
static const u8 sText_HoldEffectElectricPower[] = _("Elektrokraft");
static const u8 sText_HoldEffectWaterPower[] = _("Wasserkraft");
static const u8 sText_HoldEffectFlyingPower[] = _("Flugkraft");
static const u8 sText_HoldEffectPoisonPower[] = _("Giftkraft");
static const u8 sText_HoldEffectIcePower[] = _("Eiskraft");
static const u8 sText_HoldEffectGhostPower[] = _("Geisterkraft");
static const u8 sText_HoldEffectPsychicPower[] = _("Psycho-Kraft");
static const u8 sText_HoldEffectFirePower[] = _("Feuerkraft");
static const u8 sText_HoldEffectDragonPower[] = _("Drachen-Kraft");
static const u8 sText_HoldEffectNormalPower[] = _("Normalkraft");
static const u8 sText_HoldEffectUpgrade[] = _("Upgrade");
static const u8 sText_HoldEffectShellBell[] = _("Schalenglocke");
static const u8 sText_HoldEffectLuckyPunch[] = _("Glückspilz");
static const u8 sText_HoldEffectMetalPowder[] = _("Metallpuder");
static const u8 sText_HoldEffectThickClub[] = _("Kampfknochen");
static const u8 sText_HoldEffectLeek[] = _("Lauchstange");
static const u8 sText_HoldEffectChoiceScarf[] = _("Wahlschal");
static const u8 sText_HoldEffectChoiceSpecs[] = _("Wahlglas");
static const u8 sText_HoldEffectDampRock[] = _("Nassbrocken");
static const u8 sText_HoldEffectGripClaw[] = _("Griffklaue");
static const u8 sText_HoldEffectHeatRock[] = _("Heißbrocken");
static const u8 sText_HoldEffectIcyRock[] = _("Eisbrocken");
static const u8 sText_HoldEffectLightClay[] = _("Lichtlehm");
static const u8 sText_HoldEffectSmoothRock[] = _("Glattbrocken");
static const u8 sText_HoldEffectPowerHerb[] = _("Kraftkraut");
static const u8 sText_HoldEffectBigRoot[] = _("Großwurzel");
static const u8 sText_HoldEffectExpertBelt[] = _("Expertengurt");
static const u8 sText_HoldEffectLifeOrb[] = _("Leben-Orb");
static const u8 sText_HoldEffectMetronome[] = _("Metronom");
static const u8 sText_HoldEffectMuscleBand[] = _("Muskelband");
static const u8 sText_HoldEffectWideLens[] = _("Weitlinse");
static const u8 sText_HoldEffectWiseGlasses[] = _("Weise Brille");
static const u8 sText_HoldEffectZoomLens[] = _("Zoomlinse");
static const u8 sText_HoldEffectLaggingTail[] = _("Schwerfeder");
static const u8 sText_HoldEffectFocusSash[] = _("Fokusgurt");
static const u8 sText_HoldEffectFlameOrb[] = _("Flammen-Orb");
static const u8 sText_HoldEffectToxicOrb[] = _("Toxik-Orb");
static const u8 sText_HoldEffectStickyBarb[] = _("Klebeklaue");
static const u8 sText_HoldEffectIronBall[] = _("Eisenkugel");
static const u8 sText_HoldEffectBlackSludge[] = _("Giftschleim");
static const u8 sText_HoldEffectDestinyKnot[] = _("Schicksalsknoten");
static const u8 sText_HoldEffectShedShell[] = _("Wechselhülle");
static const u8 sText_HoldEffectQuickPowder[] = _("Flottstaub");
static const u8 sText_HoldEffectAdamantOrb[] = _("Adamant-Orb");
static const u8 sText_HoldEffectLustrousOrb[] = _("Glanz-Orb");
static const u8 sText_HoldEffectGriseousOrb[] = _("Platin-Orb");
static const u8 sText_HoldEffectEnigmaBerry[] = _("Enigma-Beere");
static const u8 sText_HoldEffectResistBerry[] = _("Resistenz-Beere");
static const u8 sText_HoldEffectPowerItem[] = _("Kraft-Item");
static const u8 sText_HoldEffectRestorePctHp[] = _("KP-Prozente wiederherstellen");
static const u8 sText_HoldEffectMicleBerry[] = _("Micle-Beere");
static const u8 sText_HoldEffectCustapBerry[] = _("Custap-Beere");
static const u8 sText_HoldEffectJabocaBerry[] = _("Jaboca-Beere");
static const u8 sText_HoldEffectRowapBerry[] = _("Rowap-Beere");
static const u8 sText_HoldEffectKeeBerry[] = _("Kee-Beere");
static const u8 sText_HoldEffectMarangaBerry[] = _("Maranga-Beere");
static const u8 sText_HoldEffectFloatStone[] = _("Schwebestein");
static const u8 sText_HoldEffectEviolite[] = _("Evolith");
static const u8 sText_HoldEffectAssaultVest[] = _("Offensivweste");
static const u8 sText_HoldEffectDrive[] = _("Modul");
static const u8 sText_HoldEffectGems[] = _("Edelsteine");
static const u8 sText_HoldEffectRockyHelmet[] = _("Rauhelm");
static const u8 sText_HoldEffectAirBalloon[] = _("Luftballon");
static const u8 sText_HoldEffectRedCard[] = _("Rote Karte");
static const u8 sText_HoldEffectRingTarget[] = _("Zielscheibe");
static const u8 sText_HoldEffectBindingBand[] = _("Klammerband");
static const u8 sText_HoldEffectEjectButton[] = _("Ausstoßknopf");
static const u8 sText_HoldEffectAbsorbBulb[] = _("Absorbbirne");
static const u8 sText_HoldEffectCellBattery[] = _("Zellbatterie");
static const u8 sText_HoldEffectFairyPower[] = _("Feenkraft");
static const u8 sText_HoldEffectMegaStone[] = _("Mega-Stein");
static const u8 sText_HoldEffectSafetyGoggles[] = _("Schutzbrille");
static const u8 sText_HoldEffectLuminousMoss[] = _("Leuchtmoos");
static const u8 sText_HoldEffectSnowball[] = _("Schneeball");
static const u8 sText_HoldEffectWeaknessPolicy[] = _("Schwächenschutz");
static const u8 sText_HoldEffectPrimalOrb[] = _("Urzeit-Orb");
static const u8 sText_HoldEffectProtectivePads[] = _("Schutzpolster");
static const u8 sText_HoldEffectTerrainExtender[] = _("Feld-Verlängerer");
static const u8 sText_HoldEffectSeeds[] = _("Samen");
static const u8 sText_HoldEffectAdrenalineOrb[] = _("Adrenalin-Orb");
static const u8 sText_HoldEffectMemory[] = _("Speicher");
static const u8 sText_HoldEffectZCrystal[] = _("Z-Kristall");
static const u8 sText_HoldEffectPlate[] = _("Tafel");
static const u8 sText_HoldEffectUtilityUmbrella[] = _("Nutzschirm");
static const u8 sText_HoldEffectEjectPack[] = _("Ausstoßpack");
static const u8 sText_HoldEffectRoomService[] = _("Zimmerservice");
static const u8 sText_HoldEffectBlunderPolicy[] = _("Patzerpolice");
static const u8 sText_HoldEffectHeavyDutyBoots[] = _("Schwerlaststiefel");
static const u8 sText_HoldEffectThroatSpray[] = _("Hals-Spray");
static const u8 sText_HoldEffectAbilityShield[] = _("Fähigkeitsschild");
static const u8 sText_HoldEffectClearAmulet[] = _("Klaramulett");
static const u8 sText_HoldEffectMirrorHerb[] = _("Spiegelkraut");
static const u8 sText_HoldEffectPunchingGlove[] = _("Schlaghandschuh");
static const u8 sText_HoldEffectCovertCloak[] = _("Tarnumhang");
static const u8 sText_HoldEffectLoadedDice[] = _("Ladewürfel");
static const u8 sText_HoldEffectBoosterEnergy[] = _("Energiebooster");
static const u8 sText_HoldEffectBerserkGene[] = _("Berserker-Gen");
static const u8 sText_HoldEffectOgerponMask[] = _("Ogerpon-Maske");
