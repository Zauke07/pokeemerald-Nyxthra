...
static u8 const sMenuName_Back[] = _("Zurück");
static u8 const sMenuName_SaveAndExit[] = _("Speichern & Beenden");
static u8 const sMenuName_DifficultySubmenu[] = _("Schwierigkeit bearbeiten");
static u8 const sMenuName_AdventureSubmenu[] = _("Abenteuer");
static u8 const sMenuName_TrainersSubmenu[] = _("Trainer");
static u8 const sMenuName_GameModesSubmenu[] = _("Spielmodi");

static u8 const sMenuName_BattleFormat[] = _("Kampfform");
static u8 const sMenuName_BattleFormatSingles[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Einzel");
static u8 const sMenuName_BattleFormatDoubles[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Doppel");
static u8 const sMenuName_BattleFormatMixed[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Gemischt");

//static u8 const sMenuName_TrainerOrder[] = _("Trainer Reihenfolge");
//static u8 const sMenuName_TrainerOrderDefault[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Standard");
//static u8 const sMenuName_TrainerOrderRainbow[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Regenbogen");
//static u8 const sMenuName_TrainerOrderOfficial[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Offiziell");

static u8 const sMenuName_GameMode_Standard[] = _("Standard");
static u8 const sMenuName_GameMode_Rainbow[] = _("Regenbogen");
static u8 const sMenuName_GameMode_Official[] = _("Offiziell");
static u8 const sMenuName_GameMode_Gauntlet[] = _("Herausforderung");
static u8 const sMenuName_GameMode_RainbowGauntlet[] = _("Regenbogen-Herausforderung");

static u8 const sMenuName_Affection[] = _("Zuneigung FX");
static u8 const sMenuName_ReleaseMons[] = _("Freilassen bei Ohnmacht");
static u8 const sMenuName_TrainerDiversity[] = _("Vielfältige Trainer {PKMN}");
...
static u8 const sText_ErrorInvalidSelection[] = _("Fehler: {COLOR GREEN}{SHADOW LIGHT_GREEN}Ungültige Auswahl.");

const u8 sMenuNameDesc_PresetDescription_Easy[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Für diejenigen, die ein entspanntes Erlebnis\n"
    "wollen, vergleichbar mit modernen {PKMN}-Spielen."
);
const u8 sMenuNameDesc_PresetDescription_Average[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Empfohlen für diejenigen, die gute {PKMN}-\n"
    "Kenntnisse haben und eine Herausforderung mögen."
);
const u8 sMenuNameDesc_PresetDescription_Hard[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Ein hartes Erlebnis für diejenigen, die\n"
    "eine erhöhte Schwierigkeit genießen."
);
const u8 sMenuNameDesc_PresetDescription_Brutal[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Ein noch härteres Erlebnis als 'Schwer',\n"
    "für diejenigen, die leiden wollen."
);
...
const u8 sMenuNameDesc_DifficultyOverLvlOff[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "{PKMN} werden aufhören, Level zu gewinnen,\n"
    "sobald sie das Level Cap erreichen."
);
const u8 sMenuNameDesc_DifficultyOverLvlOn[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "{PKMN} können Level über das Level Cap hinaus\n"
    "gewinnen. (Nach dem Level Cap langsamer)"
);
...
static u8 const sMenuNameDesc_TrainersSubmenu[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviere oder deaktiviere Gruppen von Trainern,\n"
    "denen du begegnen möchtest."
);

static u8 const sMenuNameDesc_GameModesSubmenu[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Wähle benutzerdefinierte Regelsets oder Szenarien,\n"
    "mit denen du spielen möchtest."
);

static u8 const sMenuNameDesc_BattleFormatSingles[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Trainerkämpfe werden immer 1v1 sein."
);
static u8 const sMenuNameDesc_BattleFormatDoubles[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Trainerkämpfe werden immer 2v2 sein."
);
static u8 const sMenuNameDesc_BattleFormatMixed[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Trainerkämpfe werden zufällig 1v1 oder\n"
    "2v2 sein. (Gleiche Chance für beide)"
);
...
const u8 sMenuNameDesc_Affection[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "{PKMN} mit hoher Freundschaft können spezielle\n"
    "Effekte haben, z.B. aushalten, extra Krits etc."
);

const u8 sMenuNameDesc_ReleaseMonsOn[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Wenn {PKMN} ohnmächtig werden, werden sie\n"
    "aus deinem Team freigelassen."
);

const u8 sMenuNameDesc_ReleaseMonsOff[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Ohnmächtige {PKMN} bleiben in deinem Team,\n"
    "können aber nur von Krankenschwestern oder\n"
    "durch Beleber geheilt werden."
);
...
const u8 sMenuNameDesc_TrainerDiversityOff[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Trainer bleiben größtenteils bei ihren\n"
    "Typspezialitäten, z.B. hat Rocko nur Gestein."
);
const u8 sMenuNameDesc_TrainerDiversityOn[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Trainer können breitere Typspezialitäten haben,\n"
    "z.B. hat Rocko eine Mischung aus Gestein & Stahl."
);
...
static u8 const sMenuNameDesc_Rogue[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der… Rogue-Region?\n"
    "(Regenbogenmodus nicht unterstützt)\n"
);

static u8 const sMenuNameDesc_Kanto[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der Kanto-Region.\n"
);

static u8 const sMenuNameDesc_Johto[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der Johto-Region.\n"
);

static u8 const sMenuNameDesc_Hoenn[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der Hoenn-Region.\n"
);

#ifdef ROGUE_EXPANSION
static u8 const sMenuNameDesc_Sinnoh[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der Sinnoh-Region.\n"
);

static u8 const sMenuNameDesc_Unova[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der Einall-Region.\n"
);

static u8 const sMenuNameDesc_Kalos[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der Kalos-Region.\n"
);

static u8 const sMenuNameDesc_Alola[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der Alola-Region.\n"
);

static u8 const sMenuNameDesc_Galar[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der Galar-Region.\n"
);

static u8 const sMenuNameDesc_Paldea[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Aktiviert Trainer aus der Paldea-Region.\n"
);
#endif

static u8 const sMenuNameDesc_GameMode_Standard[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Typisches Abenteuer ohne benutzerdefinierte Regeln."
);
static u8 const sMenuNameDesc_GameMode_Rainbow[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Mächtige Trainer erscheinen in beliebiger Reihenfolge,\n"
    "wiederholen aber nie ihre Typspezialitäten.\n"
    "z.B. können E4 Gym-Leiter sein und umgekehrt."
);
static u8 const sMenuNameDesc_GameMode_Official[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Mächtige Trainer erscheinen in der Reihenfolge,\n"
    "in der sie in ihren offiziellen Spielen erscheinen.\n"
    "(Deaktiviert Herausforderungen)"
);
static u8 const sMenuNameDesc_GameMode_Gauntlet[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Bereite dein Team vor und kämpfe dann gegen\n"
    "mächtige Trainer ohne die Möglichkeit, {PKMN}\n"
    "zu fangen. (Deaktiviert Herausforderungen)"
);
static u8 const sMenuNameDesc_GameMode_RainbowGauntlet[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Kombinierte Effekte von Regenbogen- und\n"
    "Gauntlet-Modus."
);
...
static const u8 sText_DifficultyExpAllDescOff[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Nur {PKMN}, die in den Kampf geschickt werden,\n"
    "erhalten EP. (Nicht empfohlen)"
);
static const u8 sText_DifficultyExpAllDescOn[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Alle {PKMN} im Team erhalten EP, auch wenn\n"
    "sie nicht am Kampf teilgenommen haben."
);
...
static const u8 sText_DifficultyOverworldMonsDescOff[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Wilde {PKMN} erscheinen zufällig, während du dich\n"
    "bewegst. (Klassische {PKMN}-Spielbegegnungen)"
);
static const u8 sText_DifficultyOverworldMonsDescOn[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Wilde {PKMN} können in der Oberwelt angetroffen\n"
...
const u8 sText_DifficultyEVGainDescOff[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Alle {PKMN} haben niemals EVs."
);
const u8 sText_DifficultyEVGainDescOn[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "{PKMN} erhalten EVs aus Trainerkämpfen basierend\n"
    "auf ihrer Natur. (Trainer haben niemals EVs)"
);
...
const u8 sText_DifficultySwitchModeDescOff[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Nach dem Besiegen eines gegnerischen {PKMN}\n"
    "kannst du nicht sofort wechseln, bis du an der Reihe bist."
);
const u8 sText_DifficultySwitchModeDescOn[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Nach dem Besiegen eines gegnerischen {PKMN}\n"
    "kannst du sofort wechseln."
);
...
const u8 sText_DifficultyBagWipeDescOff[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Du kannst alle Meta-Progression in Abenteuer\n"
    "mitnehmen. (z.B. Items, Tagespflege)"
);
const u8 sText_DifficultyBagWipeDescOn[] = _(
    "{COLOR GREEN}{SHADOW LIGHT_GREEN}"
    "Nur dein Partner-{PKMN} und Schlüsselitems\n"
    "werden in Abenteuer mitgenommen."
);
...
static u8 const sMenuName_DebugToggleStealTeam[] = _("TEAM STEHLEN");
static u8 const sMenuName_DebugToggleLvl5[] = _("TRAINER LVL5");
static u8 const sMenuName_DebugToggleAllowSaveScum[] = _("SAVE SCUM ERLAUBEN");
static u8 const sMenuName_DebugToggleInstantCapture[] = _("SOFORT FANGEN");
static u8 const sMenuName_DebugToggleTodTintUsePlayerColour[] = _("SPIELER TOD TINT");
static u8 const sMenuName_DebugToggleDebugShops[] = _("DEBUG SHOPS");
static u8 const sMenuName_DebugToggleDebugLegends[] = _("DEBUG LEGENDEN");
static u8 const sMenuName_DebugToggleDebugMonQuery[] = _("MON ABFRAGE");
static u8 const sMenuName_DebugToggleDebugItemQuery[] = _("ITEM ABFRAGE");
static u8 const sMenuName_DebugToggleHideFollower[] = _("BEGLEITER VERBERGEN");
static u8 const sMenuName_DebugToggleStopWildSpawning[] = _("WILDE SPAWNS STOPPEN");
static u8 const sMenuName_DebugToggleDisableAssistantTimeout[] = _("ASSIST TIMEOUT DEAKT.");

static u8 const sMenuName_DebugRangeStartDifficulty[] = _("START-SCHWIERIGKEIT");
static u8 const sMenuName_DebugRangeForcedRoute[] = _("ERZWUNGENER WEG");
static u8 const sMenuName_DebugRangeForcedEvilTeam[] = _("ERZWUNGENES TEAM");
#endif
