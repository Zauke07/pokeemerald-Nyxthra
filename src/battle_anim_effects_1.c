...
void AnimGrantingStars(struct Sprite *sprite)
{
    ...
    SetAnimSpriteInitialXOffset(sprite, gBattleAnimArgs[0]); // unk0
    sprite->y += gBattleAnimArgs[1];                         // unk1
    sprite->data[0] = gBattleAnimArgs[5];                   // unk5
    sprite->data[1] = gBattleAnimArgs[3];                   // unk3
    sprite->data[2] = gBattleAnimArgs[4];                   // unk4
    StoreSpriteCallbackInData6(sprite, DestroyAnimSprite);
    sprite->callback = TranslateSpriteLinearFixedPoint;
}
...
static void AnimSparklingStars(struct Sprite *sprite)
{
    ...
    {
        // gBattleAnimArgs[6] entspricht unk6
