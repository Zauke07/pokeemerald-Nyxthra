...
static const struct SinglesTrainerInfo sSingleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_BLACK_BELT,  FACILITY_CLASS_BLACK_BELT_FRLG,    MALE},
...
static const struct DoublesTrainerInfo sDoubleBattleTrainerInfo[] = {
    ...
    {OBJ_EVENT_GFX_CRUSH_GIRL,       OBJ_EVENT_GFX_BLACK_BELT,  FACILITY_CLASS_CRUSH_KIN_FRLG,    FEMALE, MALE},
