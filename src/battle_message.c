...
static const u8 sText_TryToLearnMove3[] = _("Soll eine Attacke zu Gunsten von\n{B_BUFF2} vergessen werden?");
...
static const u8 sText_PlayerLostToEnemyTrainer[] = _("{B_PLAYER_NAME} hat keine\nnkampffähigen Pokémon mehr!\pSpieler hat gegen\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME} verloren!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerPaidPrizeMoney[] = _("{B_PLAYER_NAME} zahlt ¥{B_BUFF1} als Preisgeld\n…\p… … … …\p{B_PLAYER_NAME} fällt in Ohnmacht!{PAUSE_UNTIL_PRESS}");
static const u8 sText_PlayerWhiteout[] = _("{B_PLAYER_NAME} hat kein\nkampffähiges Pokémon mehr!\p");
#if B_WHITEOUT_MONEY >= GEN_4
static const u8 sText_PlayerWhiteout2[] = _("{B_PLAYER_NAME} fällt in panik und verliert ¥{B_BUFF1}…\p… … … …\p{B_PLAYER_NAME} fällt in Ohnmacht!{PAUSE_UNTIL_PRESS}");
#else
...
static const u8 sText_StatsWontIncrease[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1} kann nicht\lmehr erhöht werden!");
static const u8 sText_StatsWontDecrease[] = _("{B_DEF_NAME_WITH_PREFIX}'s {B_BUFF1} kann nicht\lweiter gesenkt werden!");
...
static const u8 sText_PkmnCoveredByVeil[] = _("{B_ATK_PREFIX2} wird von\neinem Schleier umhüllt!");
static const u8 sText_PkmnUsedSafeguard[] = _("{B_DEF_NAME_WITH_PREFIX} wird durch\nBODYGUARD geschützt!");
...
static const u8 sText_PkmnDugHole[] = _("{B_ATK_NAME_WITH_PREFIX} räbt sich\nein!");
static const u8 sText_PkmnHidUnderwater[] = _("{B_ATK_NAME_WITH_PREFIX} taucht\nunter!");
static const u8 sText_PkmnSprangUp[] = _("{B_ATK_NAME_WITH_PREFIX} springt auf!");
static const u8 sText_PkmnSqueezedByBind[] = _("{B_ATK_NAME_WITH_PREFIX} setzt bei\n{B_DEF_NAME_WITH_PREFIX} KLAMMERGRIFF ein!");
...
static const u8 sText_PkmnCantSleepInUproar2[] = _("But {B_DEF_NAME_WITH_PREFIX} kann bei dem\nAUFRUHR nicht schlafen!");
...
static const u8 sText_SpikesScattered[] = _("Gegnerisches Team verteilt\nSTACHELN um sich!");
...
static const u8 sText_PkmnBlewAwaySpikes[] = _("{B_ATK_NAME_WITH_PREFIX} blies den\nSTACHLER weg!");
...
static const u8 sText_PkmnHasNoMovesLeft[] = _("{B_ATK_NAME_WITH_PREFIX} hat keine\nAttacken mehr übrig!\p");
static const u8 sText_PkmnMoveIsDisabled[] = _("{B_ATK_NAME_WITH_PREFIX}'s {B_CURRENT_MOVE}\nist blockiert!\p");
static const u8 sText_PkmnCantUseMoveTorment[] = _("{B_ATK_NAME_WITH_PREFIX} kann\naufgrund von FOLTERKNECHT\pdie Attacke nicht 2-mal\nhintereinander einsetzen!");
static const u8 sText_PkmnCantUseMoveTaunt[] = _("{B_ATK_NAME_WITH_PREFIX} kann\n{B_CURRENT_MOVE} nach VERHÖHNER\lnicht einsetzen!\p");
static const u8 sText_PkmnCantUseMoveSealed[] = _("{B_ATK_NAME_WITH_PREFIX} kann die ver-\nsiegelte Attacke {B_CURRENT_MOVE}\lnicht einsetzen!\p");
...
static const u8 sText_123Poof[] = _("{PAUSE 32}1, {PAUSE 15}2, und{PAUSE 15}… {PAUSE 15}… {PAUSE 15}… {PAUSE 15}{PLAY_SE 0x0038}Schwupps!\p");
...
static const u8 sText_GotAwaySafely[] = _("{PLAY_SE 0x0011}Du bist entkommen!\p");
static const u8 sText_PkmnFledUsingIts[] = _("{PLAY_SE 0x0011}{B_ATK_NAME_WITH_PREFIX}floh\ndurch Einsatz von {B_LAST_ITEM}!\p");
static const u8 sText_PkmnFledUsing[] = _("{PLAY_SE 0x0011}{B_ATK_NAME_WITH_PREFIX}floh\ndurch Einsatz von {B_ATK_ABILITY}!\p");
static const u8 sText_WildPkmnFled[] = _("{PLAY_SE 0x0011}Wildes {B_BUFF1} floh!");
static const u8 sText_PlayerDefeatedLinkTrainer[] = _("Spieler besiegte\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_TwoLinkTrainersDefeated[] = _("Spieler besiegte\n{B_LINK_OPPONENT1_NAME}\nund {B_LINK_OPPONENT2_NAME}!");
static const u8 sText_PlayerLostAgainstLinkTrainer[] = _("Spieler verlor gegen\n{B_LINK_OPPONENT1_NAME}!");
static const u8 sText_PlayerLostToTwo[] = _("Spieler verlor gegen\n{B_LINK_OPPONENT1_NAME}\nund {B_LINK_OPPONENT2_NAME}!");
...
static const u8 sText_WildFled[] = _("{PLAY_SE 0x0011}{B_LINK_OPPONENT1_NAME} floh!");
static const u8 sText_TwoWildFled[] = _("{PLAY_SE 0x0011}{B_LINK_OPPONENT1_NAME} und\n{B_LINK_OPPONENT2_NAME} flohen!");
...
static const u8 sText_DontLeaveBirch[] = _("PROF. BIRK: Du… Du kannst mich doch\nnicht einfach im Stich lassen!\p");
...
static const u8 sText_StartedSnow[] = _("Es fängt an zu Schneien!");
static const u8 sText_SnowContinues[] = _("Es fällt weiterhin Schnee.");
static const u8 sText_SnowStopped[] = _("TEs hat aufgehört zu Schneien.");
...
static const u8 sText_CoinsScattered[] = _("Es liegen überall Münzen verstreut!");
...
static const u8 sText_OutOfSafariBalls[] = _("{PLAY_SE 0x0049}ANSAGE: Du hast keine\nSAFARIBÄLLE mehr! Game over!\p");
...
static const u8 sText_TrainerBlockedBall[] = _("Der TRAINER hat den BALL abgeblockt!");
...
static const u8 sText_GiveNicknameCaptured[] = _("Möchtest du dem {B_DEF_NAME}\neinen Spitznamen geben?");
static const u8 sText_PkmnSentToPC[] = _("{B_DEF_NAME} wurde auf\n{B_PC_CREATOR_NAME} PC übertragen.");
static const u8 sText_Someones[] = _("einen");
static const u8 sText_Lanettes[] = _("LANETTES");
static const u8 sText_PkmnDataAddedToDex[] = _("Für {B_DEF_NAME} wurde ein Eintrag\nim Pokédex angelegt.\p");
...
static const u8 sText_PkmnsItemRestoredPP[] = _("{B_LAST_ITEM} füllte\nAP von {B_BUFF1} auf!");
...
static const u8 sText_PkmnHungOnWithX[] = _("{B_DEF_NAME_WITH_PREFIX} hält\nmit Hilfe von {B_LAST_ITEM} durch!");
const u8 gText_EmptyString3[] = _("");
static const u8 sText_YouThrowABallNowRight[] = _("Nun muss man einen BALL werfen, oder?\nIch… Ich werde mein Bestes geben!");
...
static const u8 sText_IonDelugeOn[] = _("Eine Flut von Ionen überschüttet\ndas Schlachtfeld!");
static const u8 sText_TopsyTurvySwitchedStats[] = _("{B_DEF_NAME_WITH_PREFIX}'s stat changes were\nall reversed!");
static const u8 sText_TerrainBecomesMisty[] = _("Nebel wirbelte über\ndas Schlachtfeld!");
static const u8 sText_TerrainBecomesGrassy[] = _("Gras wuchs und bedeckte\ndas Schlachtfeld!");
...
const u8 gText_WhichMoveToForget4[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Welche Attacke soll\nVergessen werden?");
const u8 gText_BattleYesNoChoice[] = _("{PALETTE 5}{COLOR_HIGHLIGHT_SHADOW DYNAMIC_COLOR4 DYNAMIC_COLOR5 DYNAMIC_COLOR6}Jo\nNe");
...
static const u8 sText_Semifinal[] = _("Halbfinale");
...
static const u8 sText_TwoTrainersWantToBattle[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} und\n{B_TRAINER2_CLASS} {B_TRAINER2_NAME}\lmöchten kämpfen!\p");
static const u8 sText_InGamePartnerSentOutZGoN[] = _("{B_PLAYER_MON2_NAME} wird von\n{B_PARTNER_CLASS} {B_PARTNER_NAME} in den\lKampf geschickt!\pLos, {B_PLAYER_MON1_NAME}!");
static const u8 sText_TwoInGameTrainersDefeated[] = _("{B_TRAINER1_CLASS} {B_TRAINER1_NAME} und\n{B_TRAINER2_CLASS} {B_TRAINER2_NAME}\lwurden besiegt!\p");
...
static const u8 sText_QuestionForfeitMatch[] = _("Möchtest du aufgeben\nund beenden?");
static const u8 sText_ForfeitedMatch[] = _("{B_PLAYER_NAME} hat aufgegeben!");
static const u8 sText_Trainer1WinText[] = _("{B_TRAINER1_WIN_TEXT}");
static const u8 sText_Trainer2WinText[] = _("{B_TRAINER2_WIN_TEXT}");
static const u8 sText_Trainer1Fled[] = _( "{PLAY_SE 0x0011}{B_TRAINER1_CLASS} {B_TRAINER1_NAME} ist geflohen!");
static const u8 sText_PlayerLostAgainstTrainer1[] = _("Spieler hat gegen\n{B_TRAINER1_CLASS} {B_TRAINER1_NAME} verloren!");
static const u8 sText_PlayerBattledToDrawTrainer1[] = _("Spieler hat bis zum Unentschieden\ngegen {B_TRAINER1_CLASS} {B_TRAINER1_NAME} gekämpft!");
const u8 gText_RecordBattleToPass[] = _("Möchtest du den Kampf auf\ndeinen FRONTIER PASS aufzeichnen?");
const u8 gText_BattleRecordedOnPass[] = _("Kampf von {B_PLAYER_NAME} wurde auf\ndem FRONTIER PASS aufgezeichnet.");
static const u8 sText_LinkTrainerWantsToBattlePause[] = _("{B_LINK_OPPONENT1_NAME}\nmöchte kämpfen!{PAUSE 49}");
