...
{
    #define RIVAL_GRAPHICS_BY_ACTION(baseNormal, mach, acro, surf) \
        do { \
            switch (action) \
            { \
    ...
    switch (rivalId)
    {
        case OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_BRENDAN_NORMAL, OBJ_EVENT_GFX_RIVAL_BRENDAN_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_BRENDAN_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_BRENDAN_SURFING);
        case OBJ_EVENT_GFX_RIVAL_MAY_NORMAL:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_MAY_NORMAL, OBJ_EVENT_GFX_RIVAL_MAY_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_MAY_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_MAY_SURFING);
        case OBJ_EVENT_GFX_RIVAL_RED:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_RED, OBJ_EVENT_GFX_RIVAL_RED_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_RED_ACRO_BIKE, OBJ_EVENT_GFX_RED_SURFING);
        case OBJ_EVENT_GFX_RIVAL_LEAF:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_LEAF, OBJ_EVENT_GFX_RIVAL_LEAF_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_LEAF_ACRO_BIKE, OBJ_EVENT_GFX_LEAF_SURFING);
        case OBJ_EVENT_GFX_RIVAL_ETHAN:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_ETHAN, OBJ_EVENT_GFX_RIVAL_ETHAN_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_ETHAN_ACRO_BIKE, OBJ_EVENT_GFX_ETHAN_SURFING);
        case OBJ_EVENT_GFX_RIVAL_LYRA:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_LYRA, OBJ_EVENT_GFX_RIVAL_LYRA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_LYRA_ACRO_BIKE, OBJ_EVENT_GFX_LYRA_SURFING);
        case OBJ_EVENT_GFX_RIVAL_LUCAS:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_LUCAS, OBJ_EVENT_GFX_RIVAL_LUCAS_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_LUCAS_ACRO_BIKE, OBJ_EVENT_GFX_LUCAS_SURFING);
        case OBJ_EVENT_GFX_RIVAL_DAWN:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_DAWN, OBJ_EVENT_GFX_RIVAL_DAWN_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_DAWN_ACRO_BIKE, OBJ_EVENT_GFX_DAWN_SURFING);
        case OBJ_EVENT_GFX_RIVAL_HILBERT:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_HILBERT, OBJ_EVENT_GFX_RIVAL_HILBERT_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_HILBERT_ACRO_BIKE, OBJ_EVENT_GFX_HILBERT_SURFING);
        case OBJ_EVENT_GFX_RIVAL_HILDA:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_HILDA, OBJ_EVENT_GFX_RIVAL_HILDA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_HILDA_ACRO_BIKE, OBJ_EVENT_GFX_HILDA_SURFING);
        case OBJ_EVENT_GFX_RIVAL_NATE:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_NATE, OBJ_EVENT_GFX_RIVAL_NATE_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_NATE_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_NATE_SURFING);
        case OBJ_EVENT_GFX_RIVAL_ROSA:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_ROSA, OBJ_EVENT_GFX_RIVAL_ROSA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_ROSA_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_ROSA_SURFING);
        case OBJ_EVENT_GFX_RIVAL_CALEM:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_CALEM, OBJ_EVENT_GFX_RIVAL_CALEM_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_CALEM_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_CALEM_SURFING);
        case OBJ_EVENT_GFX_RIVAL_SERENA:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_SERENA, OBJ_EVENT_GFX_RIVAL_SERENA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_SERENA_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_SERENA_SURFING);
        case OBJ_EVENT_GFX_RIVAL_ELIO:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_ELIO, OBJ_EVENT_GFX_RIVAL_ELIO_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_ELIO_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_ELIO_SURFING);
        case OBJ_EVENT_GFX_RIVAL_SELENE:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_SELENE, OBJ_EVENT_GFX_RIVAL_SELENE_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_SELENE_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_SELENE_SURFING);
        case OBJ_EVENT_GFX_RIVAL_VICTOR:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_VICTOR, OBJ_EVENT_GFX_RIVAL_VICTOR_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_VICTOR_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_VICTOR_SURFING);
        case OBJ_EVENT_GFX_RIVAL_GLORIA:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_GLORIA, OBJ_EVENT_GFX_RIVAL_GLORIA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_GLORIA_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_GLORIA_SURFING);
        case OBJ_EVENT_GFX_RIVAL_FLORIAN:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_FLORIAN, OBJ_EVENT_GFX_RIVAL_FLORIAN_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_FLORIAN_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_FLORIAN_SURFING);
        case OBJ_EVENT_GFX_RIVAL_JULIANA:
            RIVAL_GRAPHICS_BY_ACTION(OBJ_EVENT_GFX_RIVAL_JULIANA, OBJ_EVENT_GFX_RIVAL_JULIANA_MACH_BIKE, OBJ_EVENT_GFX_RIVAL_JULIANA_ACRO_BIKE, OBJ_EVENT_GFX_RIVAL_JULIANA_SURFING);
        case OBJ_EVENT_GFX_RIVAL_ASH:
        case OBJ_EVENT_GFX_RIVAL_WES:
            RIVAL_GRAPHICS_BY_ACTION(rivalId, rivalId, rivalId, rivalId);
    ...
    #undef RIVAL_GRAPHICS_BY_ACTION
}
...
{
    const struct MapHeader *const *groupMapHeaders;

    if (mapGroup >= MAP_GROUPS_COUNT)
        return gMapGroups[MAP_GROUP(MAP_LITTLEROOT_TOWN)][MAP_NUM(MAP_LITTLEROOT_TOWN)];

    if (mapNum >= MAP_GROUP_COUNT[mapGroup])
        return gMapGroups[MAP_GROUP(MAP_LITTLEROOT_TOWN)][MAP_NUM(MAP_LITTLEROOT_TOWN)];

    groupMapHeaders = gMapGroups[mapGroup];
    if (groupMapHeaders == NULL || groupMapHeaders[mapNum] == NULL)
        return gMapGroups[MAP_GROUP(MAP_LITTLEROOT_TOWN)][MAP_NUM(MAP_LITTLEROOT_TOWN)];

    return groupMapHeaders[mapNum];
}
