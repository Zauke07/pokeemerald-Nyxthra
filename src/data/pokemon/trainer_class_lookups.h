const u16 gFacilityClassToPicIndex[] =
{
    ...
    // --- Nyxthra Custom Pic Mappings (Aktualisiert auf neues Schema ohne FRONT_ Präfix) ---
    [FACILITY_CLASS_CHATGPT] = TRAINER_PIC_COOLTRAINER_M,
    ...
    [FACILITY_CLASS_HILDA] = TRAINER_PIC_HILDA,
    [FACILITY_CLASS_OFFICER] = TRAINER_PIC_ROCKY,
    ...
    [FACILITY_CLASS_JAMES_ROCKET] = TRAINER_PIC_JAMES_ROCKET,
    [FACILITY_CLASS_JESSIE_ROCKET] = TRAINER_PIC_JESSIE_ROCKET,
    [FACILITY_CLASS_ADMIN_PROTON] = TRAINER_PIC_ADMIN_PROTON,
    [FACILITY_CLASS_GALACTIC_GRUNT_M] = TRAINER_PIC_GALACTIC_GRUNT_M,
    [FACILITY_CLASS_GALACTIC_GRUNT_F] = TRAINER_PIC_GALACTIC_GRUNT_F,
    [FACILITY_CLASS_ASH] = TRAINER_PIC_ASH,
    [FACILITY_CLASS_KLARA] = TRAINER_PIC_KLARA,
    [FACILITY_CLASS_NATE] = TRAINER_PIC_NATE,
    [FACILITY_CLASS_ROSA] = TRAINER_PIC_ROSA,
    [FACILITY_CLASS_CALEM] = TRAINER_PIC_CALEM,
    [FACILITY_CLASS_SERENA] = TRAINER_PIC_SERENA,
    [FACILITY_CLASS_ELIO] = TRAINER_PIC_ELIO,
    [FACILITY_CLASS_SELENE] = TRAINER_PIC_SELENE,
    [FACILITY_CLASS_VICTOR] = TRAINER_PIC_VICTOR,
    [FACILITY_CLASS_GLORIA] = TRAINER_PIC_GLORIA,
    [FACILITY_CLASS_FLORIAN] = TRAINER_PIC_FLORIAN,
    [FACILITY_CLASS_JULIANA] = TRAINER_PIC_JULIANA,
