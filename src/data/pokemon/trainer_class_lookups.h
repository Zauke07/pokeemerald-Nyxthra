const u16 gFacilityClassToPicIndex[] =
{
    ...
    // --- Nyxthra Custom Pic Mappings (Mit neuem FRONT-Präfix) ---
    [FACILITY_CLASS_CHATGPT] = TRAINER_PIC_FRONT_COOLTRAINER_M,
    [FACILITY_CLASS_LUCAS] = TRAINER_PIC_FRONT_LUCAS,
    [FACILITY_CLASS_DAWN] = TRAINER_PIC_FRONT_DAWN,
    [FACILITY_CLASS_ETHAN] = TRAINER_PIC_FRONT_ETHAN,
    [FACILITY_CLASS_LYRA] = TRAINER_PIC_FRONT_LYRA,
    [FACILITY_CLASS_HILBERT] = TRAINER_PIC_FRONT_HILBERT,
    [FACILITY_CLASS_HILDA] = TRAINER_PIC_FRONT_HILDA,
    [FACILITY_CLASS_OFFICER] = TRAINER_PIC_FRONT_ROCKY,
    [FACILITY_CLASS_NURSE] = TRAINER_PIC_FRONT_NURSE,
    [FACILITY_CLASS_BACKPACKER_F] = TRAINER_PIC_FRONT_BACKPACKER_F,
    [FACILITY_CLASS_BACKPACKER_M] = TRAINER_PIC_FRONT_BACKPACKER_M,
    [FACILITY_CLASS_JAMES_ROCKET] = TRAINER_PIC_FRONT_JAMES_ROCKET,
    [FACILITY_CLASS_JESSIE_ROCKET] = TRAINER_PIC_FRONT_JESSIE_ROCKET,
    [FACILITY_CLASS_ADMIN_PROTON] = TRAINER_PIC_FRONT_ADMIN_PROTON,
    [FACILITY_CLASS_GALACTIC_GRUNT_M] = TRAINER_PIC_FRONT_GALACTIC_GRUNT_M,
    [FACILITY_CLASS_GALACTIC_GRUNT_F] = TRAINER_PIC_FRONT_GALACTIC_GRUNT_F,
    [FACILITY_CLASS_ASH] = TRAINER_PIC_FRONT_ASH,
    [FACILITY_CLASS_KLARA] = TRAINER_PIC_FRONT_KLARA,
    [FACILITY_CLASS_NATE] = TRAINER_PIC_FRONT_NATE,
    [FACILITY_CLASS_ROSA] = TRAINER_PIC_FRONT_ROSA,
    [FACILITY_CLASS_CALEM] = TRAINER_PIC_FRONT_CALEM,
    [FACILITY_CLASS_SERENA] = TRAINER_PIC_FRONT_SERENA,
    [FACILITY_CLASS_ELIO] = TRAINER_PIC_FRONT_ELIO,
    [FACILITY_CLASS_SELENE] = TRAINER_PIC_FRONT_SELENE,
    [FACILITY_CLASS_VICTOR] = TRAINER_PIC_FRONT_VICTOR,
    [FACILITY_CLASS_GLORIA] = TRAINER_PIC_FRONT_GLORIA,
    [FACILITY_CLASS_FLORIAN] = TRAINER_PIC_FRONT_FLORIAN,
    [FACILITY_CLASS_JULIANA] = TRAINER_PIC_FRONT_JULIANA,
    [FACILITY_CLASS_DP_COWGIRL] = TRAINER_PIC_FRONT_DP_COWGIRL,
...
const enum TrainerClassID gFacilityClassToTrainerClass[] =
{
    ...
    // --- Nyxthra Custom Trainer Class Mappings ---
    [FACILITY_CLASS_CHATGPT] = TRAINER_CLASS_CHATGPT,
    ...
    [FACILITY_CLASS_HILDA] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_ROCKET_GRUNT_M] = TRAINER_CLASS_TEAM_ROCKET,
    [FACILITY_CLASS_ROCKET_GRUNT_F] = TRAINER_CLASS_TEAM_ROCKET,
    [FACILITY_CLASS_OFFICER] = TRAINER_CLASS_OFFICER,
    [FACILITY_CLASS_NURSE] = TRAINER_CLASS_NURSE,
    [FACILITY_CLASS_BACKPACKER_F] = TRAINER_CLASS_BACKPACKER_F,
    [FACILITY_CLASS_BACKPACKER_M] = TRAINER_CLASS_BACKPACKER_M,
    [FACILITY_CLASS_JAMES_ROCKET] = TRAINER_CLASS_TEAM_ROCKET,
    [FACILITY_CLASS_JESSIE_ROCKET] = TRAINER_CLASS_TEAM_ROCKET,
    [FACILITY_CLASS_GALACTIC_GRUNT_M] = TRAINER_CLASS_TEAM_GALACTIC,
    [FACILITY_CLASS_GALACTIC_GRUNT_F] = TRAINER_CLASS_TEAM_GALACTIC,
    [FACILITY_CLASS_ASH] = TRAINER_CLASS_ASH,
    [FACILITY_CLASS_KLARA] = TRAINER_CLASS_KLARA,
    [FACILITY_CLASS_NATE] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_ROSA] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_CALEM] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_SERENA] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_ELIO] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_SELENE] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_VICTOR] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_GLORIA] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_FLORIAN] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_JULIANA] = TRAINER_CLASS_RIVAL,
    [FACILITY_CLASS_DP_COWGIRL] = TRAINER_CLASS_COWGIRL,
