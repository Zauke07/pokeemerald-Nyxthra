...
const struct SpeciesInfo gSpeciesInfoGen9[] =
{
    ...
    [SPECIES_SPRIGATITO] =
    {
        ...
        .categoryName = _("Graskatze"),
        .height = 4,
        .weight = 41,
        .description = POKEDEX_DESC_STRING(
            "Der süße Duft, den sein Körper verströmt,\n"
            "fasziniert die Menschen in seiner\n"
            "Umgebung. Der Duft wird dabei stärker"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLORAGATO] =
    {
        ...
        .weight = 122,
        .description = POKEDEX_DESC_STRING(
            "Floragato schwingt geschickt die Ranke,\n"
            "die unter ihrem langen Fell verborgen ist,\n"
            "und schlägt die harte Blütenknospe dagegen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MEOWSCARADA] =
    {
        ...
        .weight = 312,
        .description = POKEDEX_DESC_STRING(
            "Dieses Pokémon nutzt das reflektierende\n"
            "Fell, das seinen Umhang auskleidet, um den\n"
            "Stiel seiner Blume zu tarnen und so das zu\n"
            "erschaffen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_FUECOCO] =
    {
        ...
        .weight = 98,
        .description = POKEDEX_DESC_STRING(
            "Sein Flammensack ist klein, sodass ständig\n"
            "Energie austritt. Diese Energie wird von\n"
            "der Delle oben abgegeben"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CROCALOR] =
    {
        ...
        .weight = 307,
        .description = POKEDEX_DESC_STRING(
            "Die Kombination aus Crocalors Feuerenergie\n"
            "und überfließender Vitalität hat einen\n"
            "eiförmigen Feuerball entstehen lassen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SKELEDIRGE] =
    {
        ...
        .weight = 3265,
        .description = POKEDEX_DESC_STRING(
            "Skeledirges sanfter Gesang beruhigt die\n"
            "Seelen aller, die ihn hören. Es verbrennt\n"
            "seine Feinde bis zur Kruste"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_QUAXLY] =
    {
        ...
        .weight = 61,
        .description = POKEDEX_DESC_STRING(
            "Dank seiner kräftigen Beine kann er selbst\n"
            "in schnell fließenden Flüssen problemlos\n"
            "schwimmen. Er sorgt gerne für Ordnung und\n"
            "das ist er auch"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_QUAXWELL] =
    {
        ...
        .weight = 215,
        .description = POKEDEX_DESC_STRING(
            "Der fleißige Quaxwell beobachtet Menschen\n"
            "und Pokémon aus verschiedenen Regionen und\n"
            "bezieht ihre ein"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_QUAQUAVAL] =
    {
        ...
        .weight = 619,
        .description = POKEDEX_DESC_STRING(
            "Ein einziger Tritt von einem Quaquaval\n"
            "kann einen Lastwagen ins Rollen bringen.\n"
            "Dieses Pokémon nutzt seine kräftigen Beine\n"
            "für seine Leistung"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_LECHONK] =
    {
        ...
        .weight = 102,
        .description = POKEDEX_DESC_STRING(
            "Es sucht den ganzen Tag nach Nahrung. Es\n"
            "besitzt einen ausgeprägten Geruchssinn,\n"
            "nutzt ihn aber für nichts anderes"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define OINKOLOGNE_MISC_INFO                                \
    ...
    [SPECIES_OINKOLOGNE_MALE] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            "Fragrunz ist stolz auf seine feine,\n"
            "glänzende Haut. Es verströmt einen\n"
            "intensiven Duft von der Spitze\n"
            "seines Schweifs."),
    ...
    [SPECIES_OINKOLOGNE_FEMALE] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            "Dieses akribische Pokémon liebt\n"
            "Ordnung und Sauberkeit. Es umhüllt\n"
            "sich mit einem blumigen Duft, der\n"
            "die Pokémon in seiner Nähe beruhigt."),
    ...
    [SPECIES_TAROUNTULA] =
    {
        ...
        .weight = 40,
        .description = POKEDEX_DESC_STRING(
            "Der Faden, den es von hinten absondert,\n"
            "ist so stark wie Draht. Das Geheimnis\n"
            "hinter der Stärke des Fadens ist die"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SPIDOPS] =
    {
        ...
        .weight = 165,
        .description = POKEDEX_DESC_STRING(
            "Mit seinen Fäden hält er sich an Ästen und\n"
            "Decken fest und bewegt sich lautlos. Es\n"
            "erlegt seine Beute"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_NYMBLE] =
    {
        ...
        .weight = 10,
        .description = POKEDEX_DESC_STRING(
            "Der dritte Satz Beine ist hochgeklappt.\n"
            "Wenn es an einer schwierigen Stelle ist,\n"
            "springt dieses Pokémon mit dem über 9\n"
            "Meter weit"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_LOKIX] =
    {
        ...
        .weight = 175,
        .description = POKEDEX_DESC_STRING(
            "Wenn es sich entscheidet, mit aller Kraft\n"
            "zu kämpfen, stellt es sich auf seine zuvor\n"
            "gefalteten Beine, um in den Showdown-Modus\n"
            "zu wechseln. Es"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_PAWMI] =
    {
        ...
        .weight = 25,
        .description = POKEDEX_DESC_STRING(
            "Die Ballen seiner Pfoten sind elektrisch\n"
            "ableitende Organe. Pawmi feuert dabei\n"
            "Elektrizität aus seinen Vorderpfoten ab"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PAWMO] =
    {
        ...
        .weight = 65,
        .description = POKEDEX_DESC_STRING(
            "Wenn seine Gruppe angegriffen wird, stürzt\n"
            "sich Pawmo als erster in die Schlacht und\n"
            "besiegt die Feinde im Kampf"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_PAWMOT] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "eintritt, schlägt es seine Feinde nieder"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TANDEMAUS] =
    {
        ...
        .weight = 18,
        .description = POKEDEX_DESC_STRING(
            "In großartiger Teamarbeit schneiden sie\n"
            "mit ihren Schneidezähnen Stücke aus jedem\n"
            "Material heraus, das nützlich sein könnte"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define MAUSHOLD_SPECIES_INFO                                                           \
    ...
    [SPECIES_MAUSHOLD_FAMILY_OF_THREE] =
    {
        ...
        .weight = 23,
        .description = POKEDEX_DESC_STRING(
            "Das Kleine tauchte eines Tages\n"
            "einfach auf. Sie leben wie eine\n"
            "Familie zusammen, doch die Beziehung\n"
            "zwischen den dreien ist unklar."),
    ...
    [SPECIES_MAUSHOLD_FAMILY_OF_FOUR] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "im Kampf. Treffen sie auf starke\n"
            "Gegner, greift die ganze Gruppe\n"
            "gemeinsam an."),
    ...
    [SPECIES_FIDOUGH] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "an. Hefe in Fidoughs Atem initiiert die\n"
            "Gärung"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_DACHSBUN] =
    {
        ...
        .weight = 149,
        .description = POKEDEX_DESC_STRING(
            "Der angenehme Duft, der vom Körper dieses\n"
            "Pokémon ausgeht, fördert das\n"
            "Weizenwachstum, so Dachsbun"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SMOLIV] =
    {
        ...
        .weight = 65,
        .description = POKEDEX_DESC_STRING(
            "Dieses Pokémon wandelt Nährstoffe in Öl\n"
            "um, das es in der Frucht auf seinem Kopf\n"
            "speichert. Es kann leicht ein Ganzes\n"
            "ergeben"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_DOLLIV] =
    {
        ...
        .weight = 119,
        .description = POKEDEX_DESC_STRING(
            "Dolliv teilt sein leckeres, frisch\n"
            "duftendes Öl mit anderen. Seitdem lebt\n"
            "diese Art neben dem Menschen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARBOLIVA] =
    {
        ...
        .weight = 482,
        .description = POKEDEX_DESC_STRING(
            "Dieses Pokémon treibt Feinde zurück, indem\n"
            "es sein reichhaltiges, aromatisches Öl mit\n"
            "genug Kraft auf sie abfeuert, um sie zu\n"
            "zerschmettern"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
...
#define SQUAWKABILLY_MISC_INFO                                  \
    ...
    [SPECIES_SQUAWKABILLY_GREEN_PLUMAGE] =
    {
        ...
        .bodyColor = BODY_COLOR_GREEN,
        .description = POKEDEX_DESC_STRING(
            "Schwärme mit grünen Federn haben\n"
            "den größten Einfluss. Wenn sie morgens\n"
            "und abends auf Futtersuche sind,\n"
            "wird es sehr laut."),
    ...
    [SPECIES_SQUAWKABILLY_BLUE_PLUMAGE] =
    {
        ...
        .bodyColor = BODY_COLOR_BLUE,
        .description = POKEDEX_DESC_STRING(
            "Die größten Schwärme umfassen\n"
            "mehr als 50 Individuen. Sie fliegen\n"
            "durch Städte und Wälder auf\n"
            "Futtersuche und machen dabei Krach."),
    ...
    [SPECIES_SQUAWKABILLY_YELLOW_PLUMAGE] =
    {
        ...
        .bodyColor = BODY_COLOR_YELLOW,
        .description = POKEDEX_DESC_STRING(
            "Diese Krawalloro sind hitzköpfig\n"
            "und kämpfen äußerst erbittert.\n"
            "Sie springen direkt in Reichweite\n"
            "ihrer Gegner, um Nahkampf zu suchen."),
    ...
    [SPECIES_SQUAWKABILLY_WHITE_PLUMAGE] =
    {
        ...
        .bodyColor = BODY_COLOR_WHITE,
        .description = POKEDEX_DESC_STRING(
            "Obwohl diese Krawalloro am\n"
            "seltensten sind, leben sie problemlos\n"
            "in Städten, da sie mit weißen\n"
            "Gebäuden optisch verschmelzen."),
    ...
    [SPECIES_NACLI] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "seinem Körper, wodurch Salz zurückbleibt.\n"
            "Salz entsteht ständig"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_NACLSTACK] =
    {
        ...
        .weight = 1050,
        .description = POKEDEX_DESC_STRING(
            "Es komprimiert Steinsalz in seinem Körper\n"
            "und schießt mit genügend Kraft gehärtete\n"
            "Salzkügelchen heraus"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GARGANACL] =
    {
        ...
        .weight = 2400,
        .description = POKEDEX_DESC_STRING(
            "Garganacl reibt seine Fingerspitzen\n"
            "aneinander und bestreut verletzte Pokémon\n"
            "mit Salz. Sogar schwere Wunden werden es\n"
            "tun"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_CHARCADET] =
    {
        ...
        .weight = 105,
        .description = POKEDEX_DESC_STRING(
            "Verbrannte Holzkohle erwachte zum Leben\n"
            "und wurde zu einem Pokémon. Charcadet\n"
            "verfügt über einen feurigen Kampfgeist und\n"
            "wird es tun"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_ARMAROUGE] =
    {
        ...
        .weight = 850,
        .description = POKEDEX_DESC_STRING(
            "Armarouge entstand durch die Verwendung\n"
            "einer Rüstung, die einem angesehenen\n"
            "Krieger gehörte. Das"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_CERULEDGE] =
    {
        ...
        .categoryName = _("Feuerklingen"),
        .height = 16,
        .weight = 620,
        .description = POKEDEX_DESC_STRING(
            "Die feurigen Klingen an seinen Armen\n"
            "brennen heftig mit dem anhaltenden Groll\n"
            "eines gefallenen Schwertträgers"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TADBULB] =
    {
        ...
        .weight = 4,
        .description = POKEDEX_DESC_STRING(
            "Kaulzwiebel schüttelt ihren Schwanz, um\n"
            "Strom zu erzeugen. Wenn es Gefahr wittert,\n"
            "blinkt es mit dem Kopf"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BELLIBOLT] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "entsteht der Bauchnabeldynamo in seinem\n"
            "Magen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_WATTREL] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "erzeugen die Knochen darin Strom. Dieses\n"
            "Pokémon taucht in den Ozean,"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KILOWATTREL] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "seinen Flügeln erzeugte Elektrizität zu\n"
            "speichern. In seinen Federn ist kaum Öl,"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MASCHIFF] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "Felsbrocken zu knirschen, und sein dickes\n"
            "Fett macht es möglich"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_MABOSSTIFF] =
    {
        ...
        .weight = 610,
        .description = POKEDEX_DESC_STRING(
            "Mabosstiff liebt es, mit Kindern zu\n"
            "spielen. Obwohl es normalerweise sanft\n"
            "ist, wirkt es einschüchternd, wenn es\n"
            "passiert"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_SHROODLE] =
    {
        ...
        .weight = 7,
        .description = POKEDEX_DESC_STRING(
            "Um Feinde von seinem Revier fernzuhalten,\n"
            "malt er mit einer giftigen Flüssigkeit\n"
            "Markierungen rund um sein Nest"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GRAFAIAI] =
    {
        ...
        .weight = 272,
        .description = POKEDEX_DESC_STRING(
            "Jeder Grafaiai malt sein eigenes,\n"
            "individuelles Muster, und er wird immer\n"
            "wieder dasselbe Muster malen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRAMBLIN] =
    {
        ...
        .weight = 6,
        .description = POKEDEX_DESC_STRING(
            "Eine Seele, die nicht in der Lage war, ins\n"
            "Jenseits zu gelangen, wurde vom Wind\n"
            "umhergeweht, bis sie sich in getrockneter\n"
            "Form verfing"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_BRAMBLEGHAST] =
    {
        ...
        .weight = 60,
        .description = POKEDEX_DESC_STRING(
            "Es öffnet die Äste seines Kopfes, um seine\n"
            "Beute einzuhüllen. Sobald es die gesamte\n"
            "Lebensenergie absorbiert hat, die es\n"
            "benötigt, wird es"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_TOEDSCOOL] =
    {
        ...
        .weight = 330,
        .description = POKEDEX_DESC_STRING(
            "Obwohl es wie Tentacool aussieht, ist\n"
            "Toedscool eine völlig andere Spezies.\n"
            "Seine Beine mögen dünn sein, aber es"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TOEDSCRUEL] =
    {
        ...
        .weight = 580,
        .description = POKEDEX_DESC_STRING(
            "Diese Pokémon schließen sich in Gruppen\n"
            "zusammen und bilden Kolonien tief in den\n"
            "Wäldern. Sie hassen es absolut, wenn"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KLAWF] =
    {
        ...
        .weight = 790,
        .description = POKEDEX_DESC_STRING(
            "Klawf hängt kopfüber an Klippen und wartet\n"
            "auf Beute. Doch lange kann Klawf in dieser\n"
            "Position nicht bleiben"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CAPSAKID] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "genießt, desto mehr scharfe Chemikalien\n"
            "produziert sein Körper und desto mehr"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RELLOR] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "Schlammball, indem es Sand und Erde mit\n"
            "psychischer Energie vermischt. Es schätzt\n"
            "seinen Schlammball mehr"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_RABSCA] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "sich kaum. Daher wird angenommen, dass es\n"
            "sich um den wahren Körper dieses Pokémon\n"
            "handelt"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_FLITTLE] =
    {
        ...
        .weight = 15,
        .description = POKEDEX_DESC_STRING(
            "Flittles Zehen schweben aufgrund der von\n"
            "ihm ausgehenden psychischen Kraft etwa\n"
    ...
    [SPECIES_ESPATHRA] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "sie aus seinen großen Augen mit\n"
            "psychischer Kraft badet. Trotz seines\n"
            "Aussehens ist es"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_TINKATINK] =
    {
        ...
        .weight = 89,
        .description = POKEDEX_DESC_STRING(
            "Dieses Pokémon schlägt Eisenreste zu einem\n"
            "Hammer zusammen. Es wird den Hammer immer\n"
            "wieder neu machen, bis"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TINKATUFF] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "Schrotthaufen. Sie testen die Stärke der\n"
            "Hämmer des anderen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_TINKATON] =
    {
        ...
        .weight = 1128,
        .description = POKEDEX_DESC_STRING(
            "Der Hammer wiegt mehr als 220 Pfund, lässt\n"
            "sich jedoch von Tinkaton leicht hin und\n"
            "her schwingen und stiehlt, was ihm gefällt"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WIGLETT] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "Veluza aus knapp über 20 Metern Entfernung\n"
            "wahrnehmen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_WUGTRIO] =
    {
        ...
        .weight = 54,
        .description = POKEDEX_DESC_STRING(
            "Wugtrio, eine Art Fisch-Pokémon, galt\n"
            "einst als eines"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_BOMBIRDIER] =
    {
        ...
        .weight = 429,
        .description = POKEDEX_DESC_STRING(
            "Bombirdier nutzt die Schürze auf seiner\n"
            "Brust, um Futter zu bündeln, das es zu\n"
            "seinem Nest zurückträgt. Es macht Spaß"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FINIZEN] =
    {
        ...
        .weight = 602,
        .description = POKEDEX_DESC_STRING(
            "Sein Wasserring besteht aus Meerwasser,\n"
            "gemischt mit einer klebrigen Flüssigkeit"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define PALAFIN_MISC_INFO                                       \
    ...
    [SPECIES_PALAFIN_ZERO] =
    {
        ...
        .weight = 602,
        .description = POKEDEX_DESC_STRING(
            "Dieses Pokémon verändert sein Aussehen,\n"
            "wenn es seine Verbündeten um Hilfe rufen\n"
            "hört. Palafin wird nie auftauchen"),
    ...
    [SPECIES_PALAFIN_HERO] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "sind erwacht. Es ist nun so\n"
            "außergewöhnlich stark, dass es mit\n"
            "einer Flosse ein Kreuzfahrtschiff hebt."),
    ...
    [SPECIES_VAROOM] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "klammert sich an Steine und wandelt die\n"
            "darin enthaltenen Mineralien um"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_REVAVROOM] =
    {
        ...
        .weight = 1200,
        .description = POKEDEX_DESC_STRING(
            "Es erzeugt ein Gas aus Gift und Mineralien\n"
            "aus Gesteinen. Dann lässt es das Gas in\n"
            "seinen Zylindern explodieren â€" jetzt"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CYCLIZAR] =
    {
        ...
        .weight = 630,
        .description = POKEDEX_DESC_STRING(
            "Es kann mit einer Geschwindigkeit von über\n"
            "70 Meilen pro Stunde sprinten, während es\n"
            "einen Menschen trägt. Die Körperwärme des\n"
            "Fahrers wärmt den Rücken von Cyclizar undâ€¦"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ORTHWORM] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "schwingt es die Ranken an seinem Körper\n"
            "wie Fäuste und bewirft den Gegner mit\n"
            "einem"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_GLIMMET] =
    {
        ...
        .weight = 80,
        .description = POKEDEX_DESC_STRING(
            "Die giftigen Mineralkristalle von Glimmet\n"
            "sehen aus wie BlütenBlätter. Dieses\n"
            "Pokémon verstreut giftiges Pulver"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GLIMMORA] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "kristallisierter Giftenergie. Es hat sich\n"
            "kürzlich gezeigt, dass diese"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GREAVARD] =
    {
        ...
        .weight = 350,
        .description = POKEDEX_DESC_STRING(
            "Dieses freundliche Pokémon mag es nicht,\n"
            "allein zu sein. Schenken Sie ihm auch nur\n"
            "die geringste Aufmerksamkeit, und das wird\n"
            "es"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_HOUNDSTONE] =
    {
        ...
        .weight = 150,
        .description = POKEDEX_DESC_STRING(
            "Houndstone verbringt die meiste Zeit\n"
            "schlafend auf Friedhöfen. Unter allen\n"
            "Hunde-Pokémon ist dieses das meiste"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLAMIGO] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "â€žSynchronisierenâ€œ bekannt ist, kann ein\n"
            "ganzer Schwarm dieser Pokémon angreifen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_CETODDLE] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "leben. Es scheint eng miteinander\n"
            "verbunden zu sein"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_CETITAN] =
    {
        ...
        .weight = 7000,
        .description = POKEDEX_DESC_STRING(
            "Im Horn baut sich an seinem Oberkiefer\n"
            "Eisenergie auf, die dazu führt, dass das\n"
            "Horn kryogene Temperaturen erreicht"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_VELUZA] =
    {
        ...
        .weight = 900,
        .description = POKEDEX_DESC_STRING(
            "Veluza verfügt über hervorragende\n"
            "Regenerationsfähigkeiten. Es wirft\n"
            "überschüssiges Fleisch von seinem Körper\n"
            "ab, um seine Beweglichkeit zu steigern."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_DONDOZO] =
    {
        ...
        .weight = 2200,
        .description = POKEDEX_DESC_STRING(
            "Es behandelt Tatsugiri wie seinen Chef und\n"
            "folgt ihm treu. Obwohl Dondozo mächtig\n"
            "ist, ist er offenbar nicht sehr stark"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define TATSUGIRI_MISC_INFO                                                     \
    ...
    [SPECIES_GREAT_TUSK] =
    {
        ...
        .weight = 3200,
        .description = POKEDEX_DESC_STRING(
            "Dieses Pokémon wurde in den letzten Jahren\n"
            "gesichtet. Der Name Great Tusk wurde von\n"
            "einer Kreatur übernommen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SCREAM_TAIL] =
    {
        ...
        .weight = 80,
        .description = POKEDEX_DESC_STRING(
            "Es wurde nur eine einzige Sichtung dieses\n"
            "Pokémon gemeldet. Es ähnelt einer\n"
            "geheimnisvollen Kreatur"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_BRUTE_BONNET] =
    {
        ...
        .weight = 210,
        .description = POKEDEX_DESC_STRING(
            "Es hat eine leichte Ähnlichkeit mit einem\n"
            "Pokémon, das in einer dubiosen Zeitschrift\n"
            "als eine Kreuzung zwischen einem\n"
            "Dinosaurier und einem Dinosaurierâ€¦"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FLUTTER_MANE] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "einer paranormalen Zeitschrift berichtet\n"
            "wurde, aber beides"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_SLITHER_WING] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "Ähnlichkeiten mit einer Kreatur, die ein"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_SANDY_SHOCKS] =
    {
        ...
        .weight = 600,
        .description = POKEDEX_DESC_STRING(
            "Es ähnelt ein wenig einem Magneton, das\n"
            "10.000 Jahre lebte und in einem Artikel\n"
            "vorgestellt wurde"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_IRON_TREADS] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            "Dieses Pokémon wurde in den letzten Jahren\n"
            "gesichtet. Es ähnelt einem mysteriösen\n"
            "Objekt, das in einem beschrieben wird"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_IRON_BUNDLE] =
    {
        ...
        .weight = 110,
        .description = POKEDEX_DESC_STRING(
            "Seine Form ähnelt einem Roboter, der in\n"
            "einem paranormalen Zeitschriftenartikel\n"
            "vorgestellt wird. Der Roboter soll es\n"
            "gewesen sein"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_IRON_HANDS] =
    {
        ...
        .weight = 3807,
        .description = POKEDEX_DESC_STRING(
            "Es ist einem Cyborg sehr ähnlich, über den\n"
            "ausschließlich ein paranormales Magazin\n"
            "berichtet. Der Cyborg soll der gewesen\n"
            "sein"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_IRON_JUGULIS] =
    {
        ...
        .weight = 1110,
        .description = POKEDEX_DESC_STRING(
            "Es ähnelt einem bestimmten Pokémon, das in\n"
            "einer paranormalen Zeitschrift vorgestellt\n"
            "wurde und als Nachkomme eines beschrieben\n"
            "wird"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_IRON_MOTH] =
    {
        ...
        .weight = 360,
        .description = POKEDEX_DESC_STRING(
            "Es liegen keine Aufzeichnungen über den\n"
            "Fang dieser Art vor. Es fehlen Daten, aber\n"
            "die Eigenschaften des Pokémon stimmen mit\n"
            "einem überein"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_IRON_THORNS] =
    {
        ...
        .weight = 3030,
        .description = POKEDEX_DESC_STRING(
            "Es weist einige Ähnlichkeiten mit einem\n"
            "Pokémon auf, das in einer dubiosen\n"
            "Zeitschrift als Tyranitar aus einer\n"
            "Milliarde vorgestellt wurde"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FRIGIBAX] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "felsigen Gebieten. Mit der Kraft seiner\n"
            "Rückenflosse kühlt es sein Inneres"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ARCTIBAX] =
    {
        ...
        .weight = 300,
        .description = POKEDEX_DESC_STRING(
            "Arctibax friert die Luft um ihn herum ein,\n"
            "schützt sein Gesicht mit einer Eismaske\n"
            "und verwandelt seine Rückenflosse in einen"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define GIMMIGHOUL_MISC_INFO                                                            \
    ...
    [SPECIES_GIMMIGHOUL_CHEST] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "Manchmal bleibt es in der Ladenecke\n"
            "liegen, weil es niemandem auffällt"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GIMMIGHOUL_ROAMING] =
    {
        ...
        .bodyColor = BODY_COLOR_GRAY,
        .categoryName = _("Münzsucher"),
        .height = 1,
        .weight = 1,
        .description = POKEDEX_DESC_STRING(
            "Es streift umher und trägt eine alte\n"
            "Münze auf dem Rücken. Es überlebt,\n"
            "indem es Menschen Lebensenergie entzieht,\n"
            "die nach seiner Münze greifen."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_GHOLDENGO] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "gestapelten Münzen besteht. Gholdengo\n"
            "überwältigt seine Feinde, indem er eine\n"
            "Münze nach der anderen abfeuert"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_WO_CHIEN] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "wird, dass sie die bösen Taten des Königs\n"
            "auf Holztafeln niedergeschrieben hat, hat\n"
            "sich verstärkt"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_CHIEN_PAO] =
    {
        ...
        .weight = 1522,
        .description = POKEDEX_DESC_STRING(
            "Dieses Pokémon kann 100 Tonnen gefallenen\n"
            "Schnee kontrollieren. Es spielt unschuldig\n"
            "herum, indem es hinein- und herausspringt"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_TING_LU] =
    {
        ...
        .weight = 6997,
        .description = POKEDEX_DESC_STRING(
            "Langsam senkt es seinen überaus schweren\n"
            "Kopf auf den Boden und spaltet die Erde\n"
            "gewaltig auf"),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_CHI_YU] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "5.400 Grad Fahrenheit brennen. Es schwimmt\n"
            "lässig durch das Lavameer, das durch das\n"
            "Schmelzen von Gestein und Sand entsteht."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_ROARING_MOON] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "Magazin hat dieses Pokémon eine Verbindung\n"
            "zur Mega-Entwicklung, die in Hoenn\n"
            "stattfindet."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_IRON_VALIANT] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            ...
            "Wissenschaftlers auf, über die in einem\n"
            "paranormalen Magazin berichtet wird."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_KORAIDON] =
    {
        ...
        .weight = 3030,
        .description = POKEDEX_DESC_STRING(
            "Dieses Pokémon ähnelt Cyclizar, ist aber\n"
            "weitaus kräftiger und wilder. Über seine\n"
            "Ökologie oder andere Merkmale ist nichts\n"
            "bekannt."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
    ...
    [SPECIES_MIRAIDON] =
    {
        ...
        .weight = 2400,
        .description = POKEDEX_DESC_STRING(
            "Dies scheint die Eiserne Schlange zu sein,\n"
            "die in einem Violetten Buch erwähnt wird.\n"
            "Die Eiserne Schlange soll mit ihrem Blitz\n"
            "das Land in Asche verwandelt haben."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define POLTCHAGEIST_MISC_INFO                                                  \
    ...
    [SPECIES_POLTCHAGEIST_COUNTERFEIT] =
    {
        ...
        .description = POKEDEX_DESC_STRING(
            "Angeblich blieben die Reuegefühle\n"
            "eines Teemeisters, der vor der\n"
            "Vollendung seines Handwerks starb,\n"
            "in Matcha zurück und wurden zu Pokémon."),
    ...
    [SPECIES_POLTCHAGEIST_ARTISAN] =
    {
        POLTCHAGEIST_MISC_INFO,
        .description = POKEDEX_DESC_STRING(
            "Es hat in einer sehr teuren\n"
            "Teedose Quartier bezogen. Nur\n"
            "Experten können kostbare von\n"
            "billigen Teedosen unterscheiden."),
...
#define SINISTCHA_MISC_INFO                                                     \
    ...
    [SPECIES_SINISTCHA_UNREMARKABLE] =
    {
        SINISTCHA_MISC_INFO,
        .description = POKEDEX_DESC_STRING(
            "Es gibt sich als Tee aus und versucht,\n"
            "Menschen zum Trinken zu verleiten, um\n"
            "ihnen Lebensenergie zu entziehen.\n"
            "Dieser Trick misslingt meist."),
    },
    [SPECIES_SINISTCHA_MASTERPIECE] =
    {
        SINISTCHA_MISC_INFO,
        .description = POKEDEX_DESC_STRING(
            "Je mehr es mit dem Teebesen auf\n"
            "seinem Kopf rührt, desto mehr\n"
            "Energie sammelt es. So bereitet\n"
            "es sich auf den Kampf vor."),
    },
    ...
    [SPECIES_MUNKIDORI] =
    {
        ...
        .weight = 122,
        .description = POKEDEX_DESC_STRING(
            "Die Kette besteht aus Giftstoffen, die die\n"
            "Fähigkeiten verbessern. Es stimulierte\n"
            "Munkidoris Gehirn und ließ die psychischen\n"
            "Kräfte des Pokémon aufblühen."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_FEZANDIPITI] =
    {
        ...
        .weight = 301,
        .description = POKEDEX_DESC_STRING(
            "Fezandipiti verdankt sein wunderschönes\n"
            "Aussehen und seine schöne Stimme den\n"
            "giftigen Stimulanzien, die von der um\n"
            "seinen Körper gewickelten Kette ausgehen."),
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
...
#define OGERPON_SPECIES_INFO(Form, type, ability, color, iconpalette, isTeraform)       \
    ...
    [SPECIES_GOUGING_FIRE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Es gibt kaum Berichte darüber, dass diese\n"
            "Kreatur gesichtet wurde. Ein kurzes Video\n"
            "zeigt, wie es tobt und Flammensäulen\n"
            "ausstößt."),
        .pokemonScale = 259,
        .pokemonOffset = 0,
        .trainerScale = 345,
    ...
    [SPECIES_RAGING_BOLT] =
    {
        ...
        .weight = 4800,
        .description = COMPOUND_STRING(
            "Es hat Ähnlichkeit mit einem Pokémon, das\n"
            "für kurze Zeit ein heißes Thema wurde,\n"
            "nachdem eine paranomale Zeitschrift es als\n"
            "Raikous Vorfahren angepriesen hatte."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 345,
        .trainerOffset = 7,
    ...
    [SPECIES_IRON_CROWN] =
    {
        ...
        .weight = 1560,
        .description = COMPOUND_STRING(
            "Es ähnelt einem mysteriösen Objekt, das in\n"
            "einem paranormalen Magazin als hochmoderne\n"
            "Waffe in der Form von Cobalion vorgestellt\n"
            "wurde."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 365,
    ...
    [SPECIES_TERAPAGOS_NORMAL] =
    {
        ...
        .weight = 65,
        .description = COMPOUND_STRING(
            "Terapagos schützt sich selbst, indem es\n"
            "Energie in harte Kristalle umwandelt.\n"
            "Dieses Pokémon ist die Quelle des\n"
            "Terastal-Phänomens."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 365,
    ...
    [SPECIES_PECHARUNT] =
    {
        ...
        .categoryName = _("Unterwerfung"),
        .height = 3,
        .weight = 3,
        .description = COMPOUND_STRING(
            "Es füttert andere mit giftigem Mochi, das\n"
            "Wünsche und Fähigkeiten hervorruft.\n"
            "Diejenigen, die das Mochi essen, fallen\n"
            "unter Pecharunts Kontrolle und sind anâ€¦"),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 365,
        .trainerOffset = 7,
