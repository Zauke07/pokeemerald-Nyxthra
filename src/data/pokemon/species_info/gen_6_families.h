...
#define FLORGES_MISC_INFO(Form, iconPal)                                        \
    ...
    [SPECIES_FLOETTE_MEGA] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "gezüchtet hat. Je schöner ihre Blüte,\n"
            "desto stärker die Macht, die sie birgt."),
...
#define FURFROU_MISC_INFO(_form, _noFlip, frontWidth, frontYOffset, backWidth, backYOffset, _iconIdx)   \
    ...
    [SPECIES_MEOWSTIC_M] =
    {
        ...
        .categoryName = _("Fassungs"),
        .height = 6,
        .weight = 85,
        .description = COMPOUND_STRING(
            "Über das Augenmuster auf der Innenseite\n"
            "seiner Ohren kann es seine Psycho-Kräfte\n"
            "freisetzen. Für gewöhnlich hält es sie\n"
            "aber verborgen."),
        .pokemonScale = 422,
        .pokemonOffset = 12,
        .trainerScale = 256,
...
#define AEGISLASH_MAIN_STAT (P_UPDATED_STATS >= GEN_8 ? 140 : 150)
    ...
    [SPECIES_PUMPKABOO_AVERAGE] =
    {
        ...
        .weight = 50,
        .description = COMPOUND_STRING(
            "Man sagt, es führe verlorene Seelen dem\n"
            "Ende ihres rastlosen irdischen Wandelns\n"
            "entgegen und geleite sie sicher ins\n"
            "Jenseits."),
        .pokemonScale = 491,
        .pokemonOffset = 12,
        .trainerScale = 256,
    ...
    [SPECIES_GOURGEIST_AVERAGE] =
    {
        ...
        .weight = 125,
        .description = COMPOUND_STRING(
            "Mit seinen haarähnlichen Armen erfasst es\n"
            "seine Beute und stimmt angesichts deren\n"
            "offenkundiger Qualen freudig ein Lied an."),
        .pokemonScale = 338,
        .pokemonOffset = 8,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [SPECIES_AVALUGG] =
    {
        ...
        .weight = 5050,
        .description = COMPOUND_STRING(
            "Mit unzähligen Arktip auf dem Rücken\n"
            "schwimmt es wie ein Eisberg durch die\n"
            "kalten Meere hoher Breitengrade."),
        .pokemonScale = 261,
        .pokemonOffset = 1,
        .trainerScale = 334,
        .trainerOffset = 4,
    ...
    [SPECIES_ZYGARDE_COMPLETE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "beobachtet und über geheime Kräfte\n"
            "verfügt."),
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 721,
    ...
    [SPECIES_DIANCIE] =
    {
        ...
        .weight = 88,
        .description = COMPOUND_STRING(
            "Es kann im Nu viele Diamanten erzeugen,\n"
            "indem es luftgebundene Kohlenstoffpartikel\n"
            "mit seinen Händen komprimiert."),
        .pokemonScale = 365,
        .pokemonOffset = 12,
        .trainerScale = 256,
        .trainerOffset = 0,
