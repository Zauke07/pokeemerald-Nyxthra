...
const struct SpeciesInfo gSpeciesInfoGen7[] =
{
    ...
    [SPECIES_DECIDUEYE] =
    {
        ...
        .weight = 366,
        .description = COMPOUND_STRING(
            "Im Grunde ein vorsichtiges und gelassenes\n"
    ...
    [SPECIES_LYCANROC_MIDDAY] =
    {
        ...
        .weight = 250,
        .description = COMPOUND_STRING(
            "Ein ruhiges Pokémon, das stets mit Bedacht\n"
            "vorgeht. Seine Steinmähne ist\n"
            "rasiermesserscharf."),
        .pokemonScale = 366,
        .pokemonOffset = 7,
        .trainerScale = 257,
...
#define MINIOR_CORE_SPECIES_INFO(Form, color, iconPal, heldItem)\
    ...
    [SPECIES_SOLGALEO] =
    {
        ...
        .weight = 2300,
        .description = COMPOUND_STRING(
            "Einst wurde es Sonnenverschlinger\n"
    ...
    [SPECIES_LUNALA] =
    {
        ...
        .weight = 1200,
        .description = COMPOUND_STRING(
            "Ihm wurde der Name Mondbringer\n"
    ...
    [SPECIES_NECROZMA] =
    {
        ...
        .weight = 2300,
        .description = COMPOUND_STRING(
            "Dieses extrem grausame Lebewesen wandelt\n"
    ...
    [SPECIES_MAGEARNA] =
    {
        ...
        .categoryName = _("Fabrikats"),
        .height = 10,
        .weight = 805,
        .description = COMPOUND_STRING(
            "Sein mechanischer Körper ist nur ein\n"
            "Gefäß. Das eigentliche Pokémon ist eine\n"
            "künstlich erschaffene Seele namens\n"
            "Seelenherz."),
        .pokemonScale = 305,
        .pokemonOffset = 7,
        .trainerScale = 257,
