...
const u8 gMoveNames[MOVES_COUNT_DYNAMAX][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_EERIE_IMPULSE] = _("Gruselimpuls"),
    ...
    [MOVE_FREEZING_GLARE] = _("Frostblick"),
