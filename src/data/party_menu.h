...
static const u8 *const sActionStringTable[] =
{
    ...
    [PARTY_MSG_CHOOSE_FOLLOWER]        = gText_ChooseFollower,
    [PARTY_MSG_REPLACE_FOLLOWER]      = gText_ReplaceFollower,
    [PARTY_MSG_REMOVE_FOLLOWER]       = gText_RemoveFollower,
};
...
static const u8 sText_Trade4[] = _("Tauschen");
...
} static const sCursorOptions[MENU_FIELD_MOVES] =
{
    ...
    [MENU_GIVE]            = {COMPOUND_STRING("Geben"),               CursorCb_Give},
    ...
    [MENU_SEND_OUT]        = {COMPOUND_STRING("Einsetzen"),           CursorCb_SendMon},
    [MENU_ENTER]           = {COMPOUND_STRING("Eintragen"),           CursorCb_Enter},
    [MENU_NO_ENTRY]        = {COMPOUND_STRING("Nicht eintragen"),     CursorCb_NoEntry},
    [MENU_STORE]           = {COMPOUND_STRING("Ablegen"),             CursorCb_Store},
    [MENU_REGISTER]        = {COMPOUND_STRING("Registrieren"),        CursorCb_Register},
    [MENU_TRADE1]          = {sText_Trade4,                           CursorCb_Trade1},
    [MENU_TRADE2]          = {sText_Trade4,                           CursorCb_Trade2},
    [MENU_TOSS]            = {COMPOUND_STRING("Wegwerfen"),           CursorCb_Toss},
    [MENU_LEVEL_UP_MOVES]  = {COMPOUND_STRING("Level-Att."),     CursorCb_ChangeLevelUpMoves},
	[MENU_EGG_MOVES]       = {COMPOUND_STRING("Ei-Att."),       CursorCb_ChangeEggMoves},
	[MENU_TM_MOVES]        = {COMPOUND_STRING("Tm-Att."),        CursorCb_ChangeTMMoves},
	[MENU_TUTOR_MOVES]     = {COMPOUND_STRING("Att.-lerner"),     CursorCb_ChangeTutorMoves},
    [MENU_SUB_MOVES]       = {COMPOUND_STRING("Lern-Att."),     CursorCb_LearnMovesSubMenu},
...
static const u8 sPartyMenuAction_SummarySwitchCancel[] = {MENU_SUMMARY, MENU_SWITCH, MENU_SET_FOLLOWER, MENU_CANCEL1};
...
static const u8 sPartyMenuAction_SummaryCancel[] = {MENU_SUMMARY, MENU_SET_FOLLOWER, MENU_CANCEL1};
