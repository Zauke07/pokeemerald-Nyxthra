...
static const u8 sHyperBeamDescription[] = _(
    "Kraftvoll, aber der Anwender\n"
    "ist in der nächsten Runde \n"
    "bewegungsunfähig.");
#else
static const u8 sHyperBeamDescription[] = _(
    "Macht den Anwender bewegungs-\n"
    "unfähig, falls das Ziel nicht \n"
    "besiegt wird.");
#endif
...
static const u8 sProtectDescription[] = _(
    "Weicht Angriffen aus, kann aber\n"
    "bei mehrmaliger Nutzung fehlschlagen.");

static const u8 sGMaxOneBlowDescription[] = _(
    "G-Max-Urshifu-Attacke.\n"
    "Ignoriert Dynaschutz.");
...
const struct MoveInfo gMovesInfo[MOVES_COUNT_ALL] =
{
    ...
    [MOVE_SURF] =
    {
        ...
        #if B_UPDATED_MOVE_DATA >= GEN_4
            "die aufs Feld niedergeht."),
        #else
            "die auf die Gegner niedergeht."),
        #endif
        .effect = EFFECT_HIT,
        .power = B_UPDATED_MOVE_DATA >= GEN_6 ? 90 : 95,
        .type = TYPE_WATER,
    ...
    [MOVE_LOW_KICK] =
    {
        ...
        #else
            .description = COMPOUND_STRING(
                "Ein niedriger Tritt, der\n"
                "den Gegner evtl. zurückschrecken lässt."),
            .effect = EFFECT_HIT,
            .additionalEffects = ADDITIONAL_EFFECTS({
                .moveEffect = MOVE_EFFECT_FLINCH,
                .chance = 30,
    ...
    [MOVE_MINIMIZE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Verringert die Größe des Anwenders,\n"
        #if B_MINIMIZE_EVASION >= GEN_5
            "erhöht stark den Fluchtwert."),
        #else
            "erhöht den Fluchtwert."),
        #endif
    ...
    [MOVE_POISON_GAS] =
    {
        ...
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_5
            "Hüllt die Gegner in giftiges\n"
        #else
            "Hüllt den Gegner in giftiges\n"
        #endif
            "Gas, das vergiften kann."),
        #if B_UPDATED_MOVE_DATA >= GEN_6
            .accuracy = 90,
        #elif B_UPDATED_MOVE_DATA == GEN_5
            .accuracy = 80,
    ...
    [MOVE_DIZZY_PUNCH] =
    {
        .name = COMPOUND_STRING("Irrschlag"),
            ...
            .description = COMPOUND_STRING(
                "Der Gegner wird mit\n"
                "rhythmischen Schlägen getroffen."),
        #endif
        .effect = EFFECT_HIT,
        .power = 70,
        .type = TYPE_NORMAL,
    ...
    [MOVE_CONVERSION] =
    {
        ...
        .description = COMPOUND_STRING(
            "Ändert den Typ des Anwenders\n"
        #if B_UPDATED_CONVERSION >= GEN_6
            "in den Typ der ersten bekannten Attacke."),
        #else
            "in den Typ einer bekannten Attacke."),
        #endif
    ...
    [MOVE_TRI_ATTACK] =
    {
        ...
        #if B_UPDATED_MOVE_DATA >= GEN_2
            .description = COMPOUND_STRING(
                "Feuert drei verschiedene Strahlen ab.\n"
                #if B_USE_FROSTBITE == TRUE
                    "Kann verb, para oder eis verursachen."),
                #else
                    "Kann verb, para oder eis."),
                #endif
        #else
            .description = COMPOUND_STRING(
                "Erstellt ein dreieckiges Energiefeld\n"
                "und schleudert es fort."),
        #endif
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_NORMAL,
    ...
    [MOVE_COTTON_SPORE] =
    {
        ...
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_6
            "Sporen haften an den Gegnern,\n"
        #else
            "Sporen haften am Gegner,\n"
        #endif
            "senken stark die Initiative."),
    ...
    [MOVE_SPITE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Reduziert die AP der\n"
        #if B_PP_REDUCED_BY_SPITE >= GEN_4
            "letzten Attacke des Gegners um 4."),
        #else
            "letzten Attacke des Gegners um 2-5."),
        #endif
        .effect = EFFECT_SPITE,
        .power = 0,
        .type = TYPE_GHOST,
    ...
    [MOVE_DRAGON_BREATH] =
    {
        .name = COMPOUND_STRING("Drachenodem"),
        .description = COMPOUND_STRING(
            "Trifft den Gegner mit einem\n"
            "Atemstoß. Kann paralysieren."),
        .effect = EFFECT_HIT,
        .power = 60,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    [MOVE_SWEET_SCENT] =
    {
        ...
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_6
            "Lockt die Gegner an und senkt\n"
            "ihren Fluchtwert stark."),
        #else
            "Lockt die Gegner an und senkt\n"
            "ihren Fluchtwert."),
        #endif
    ...
    [MOVE_HIDDEN_POWER] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "je nach Anwender."),
        #else
            "Typ und Effektivität\n"
            "variieren je nach Anwender."),
        #endif
    ...
    [MOVE_HAIL] =
    {
        .name = COMPOUND_STRING("Hagelsturm"),
            ...
            .description = COMPOUND_STRING(
            "Beschwört einen Schneesturm,\n"
            "der fünf Runden anhält."),
        #else
            .description = COMPOUND_STRING(
    ...
    [MOVE_TAIL_GLOW] =
    {
        ...
        .description = COMPOUND_STRING(
        #if B_UPDATED_MOVE_DATA >= GEN_5
            "Blitzendes Licht, das den SPEZ.\n"
        #else
            "Blitzendes Licht, das stark den SPEZ.\n"
        #endif
            "ANGR.-Wert erhöht."),
    ...
    [MOVE_VOLT_TACKLE] =
    {
        ...
        #if B_UPDATED_MOVE_DATA >= GEN_4
        .description = COMPOUND_STRING(
            "Ein riskanter Angriff, der\n"
            "dem Anwender schadet. Kann para.."),
        #else
        .description = COMPOUND_STRING(
            "Ein riskanter Angriff, der\n"
            "dem Anwender leicht schadet."),
        #endif
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_TAILWIND] =
    {
        ...
        .description = COMPOUND_STRING(
            "Beschwört eine Brise herauf, die\n"
        #if B_TAILWIND_TURNS >= GEN_5
            "die Init. der teans 4 Runden lang verdoppelt."),
        #else
            "die Init. der teams 3 Runden lang verdoppelt."),
        #endif
    ...
    [MOVE_FLARE_BLITZ] =
    {
        ...
        .description = COMPOUND_STRING(
            "Ein Sturmangriff, der den\n"
            "Gegner verbr. kann. Verletzt auch den Anwender."),
        .effect = EFFECT_RECOIL,
        .power = 120,
        .type = TYPE_FIRE,
        .accuracy = 100,
    ...
    [MOVE_GIGA_IMPACT] =
    {
        .name = COMPOUND_STRING("Giga-Stoß"),
        .description = sHyperBeamDescription,
        .effect = EFFECT_HIT,
        .power = 150,
        .type = TYPE_NORMAL,
    ...
    [MOVE_LAVA_PLUME] =
    {
        .name = COMPOUND_STRING("Lavasäule"),
    ...
    [MOVE_STORM_THROW] =
    {
        .name = COMPOUND_STRING("Schlagwurf"),
    ...
    [MOVE_BULLDOZE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Stampft den Boden nieder.\n"
            "Trifft alle und senkt INIT."),
        .effect = EFFECT_EARTHQUAKE,
        .power = 60,
        .type = TYPE_GROUND,
        .accuracy = 100,
    ...
    [MOVE_HORN_LEECH] =
    {
        .name = COMPOUND_STRING("Hornsauger"),
        .description = sMegaDrainDescription,
        .effect = EFFECT_ABSORB,
        .power = 75,
        .type = TYPE_GRASS,
    ...
    [MOVE_SEARING_SHOT] =
    {
        .name = COMPOUND_STRING("Loderkanonade"),
        .description = sLavaPlumeDescription,
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIRE,
    ...
    [MOVE_FLYING_PRESS] =
    {
        .name = COMPOUND_STRING("Flugpress"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PARABOLIC_CHARGE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Trifft benachbarte Pokémon\n"
            "und heilt die Hälfte davon."),
        .effect = EFFECT_ABSORB,
    ...
    [MOVE_FLOWER_SHIELD] =
    {
        .name = COMPOUND_STRING("Blütenschutz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_EERIE_IMPULSE] =
    {
        .name = COMPOUND_STRING("Gruselimpuls"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_LIGHT_OF_RUIN] =
    {
        .name = COMPOUND_STRING("Lux Calamitas"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Erste Impression"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DARKEST_LARIAT] =
    {
        .name = COMPOUND_STRING("Finsterer Lariat"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THROAT_CHOP] =
    {
        .name = COMPOUND_STRING("Kehlenschlag"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_POWER_TRIP] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "Werteerhöhungen der Benutzer hat."),
        .effect = EFFECT_STORED_POWER,
        .power = 20,
        .type = TYPE_DARK,
        .accuracy = 100,
    ...
    [MOVE_AURORA_VEIL] =
    {
        .name = COMPOUND_STRING("Polarlicht"),
        #if B_PREFERRED_ICE_WEATHER == B_ICE_WEATHER_SNOW
        .description = COMPOUND_STRING(
            "Schwächt alle Angriffe, aber\n"
            "nur bei Schnee einsetzbar."),
        #elif B_PREFERRED_ICE_WEATHER == B_ICE_WEATHER_BOTH
        .description = COMPOUND_STRING(
            "Schwächt alle Angriffe, wenn\n"
            "bei Hagel oder Schnee eingesetzt."),
        #else
        .description = COMPOUND_STRING(
            "Schwächt alle Angriffe, aber\n"
            "nur bei Hagel einsetzbar."),
        #endif
    ...
    [MOVE_SPECTRAL_THIEF] =
    {
        ...
        .description = COMPOUND_STRING(
            "Stiehlt die Werteerhöhungen des\n"
    ...
    [MOVE_MOONGEIST_BEAM] =
    {
        .name = COMPOUND_STRING("Mondgeiststrahl"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PLASMA_FISTS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Greift mit Elektrofäusten an.\n"
            "Normal-Attacken werden Elektro."),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_SPLISHY_SPLASH] =
    {
        .name = COMPOUND_STRING("Plätscherplatsch"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BOUNCY_BUBBLE] =
    {
        .name = COMPOUND_STRING("Blubbsprudel"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SPARKLY_SWIRL] =
    {
        .name = COMPOUND_STRING("Funkelwirbel"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VEEVEE_VOLLEY] =
    {
        .name = COMPOUND_STRING("Evoli-Finale"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Doppel-Eisenwumme"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DYNAMAX_CANNON] =
    {
        .name = COMPOUND_STRING("Dyna-Kanone"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_DARTS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Der Benutzer greift zweimal an.\n"
            "Zwei Ziele je einmal."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    {
        .name = COMPOUND_STRING("Seelenkrach"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BODY_PRESS] =
    {
        .name = COMPOUND_STRING("Presskörper"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_STRANGE_STEAM] =
    {
        .name = COMPOUND_STRING("Seltsamer Dampf"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Unterwerfung"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Entfesselte Kraft"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SKITTER_SMACK] =
    {
        .name = COMPOUND_STRING("Krabbelklatscher"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Eifersucht"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_CORROSIVE_GAS] =
    {
        .name = COMPOUND_STRING("Korrosives Gas"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Heißer Sand"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Wogenhiebe"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_DRAGON_ENERGY] =
    {
        .name = COMPOUND_STRING("Drachenenergie"),
        .description = COMPOUND_STRING(
            "Je mehr KP der Benutzer hat,\n"
            "desto höher ist die Kraft."),
        .effect = EFFECT_POWER_BASED_ON_USER_HP,
    ...
    [MOVE_FREEZING_GLARE] =
    {
        .name = COMPOUND_STRING("Frostblick"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Donnerkick"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLACIAL_LANCE] =
    {
        .name = COMPOUND_STRING("Eislanze"),
        .description = COMPOUND_STRING(
            "Schleudert eine von Schnee\n"
            "umhüllte Eislanzette auf Gegner."),
        .effect = EFFECT_HIT,
    ...
    [MOVE_ASTRAL_BARRAGE] =
    {
        .name = COMPOUND_STRING("Astraloffensive"),
        .description = COMPOUND_STRING(
            "Schickt eine furchterregende Menge\n"
            "kleiner Geister auf Gegner los."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_GHOST,
        .accuracy = 100,
    ...
    [MOVE_EERIE_SPELL] =
    {
        ...
        .description = COMPOUND_STRING(
            "Greift mit psychischer Kraft an.\n"
            "Die letzte Attacke des Gegners verliert 3 AP."),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_PSYCHIC,
        .accuracy = 100,
    ...
    {
        .name = COMPOUND_STRING("Frühlingsflutsturm"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_MYSTICAL_POWER] =
    {
        .name = COMPOUND_STRING("Mystische Kraft"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_VICTORY_DANCE] =
    {
        .name = COMPOUND_STRING("Triumphtanz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_HEADLONG_RUSH] =
    {
        .name = COMPOUND_STRING("Kopfsturz"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_GLAIVE_RUSH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Gegn Angr können im nächsten Zug\n"
            "nicht verfehlen und 2x Schaden anrichten."),
        .effect = EFFECT_HIT,
        .power = 120,
        .type = TYPE_DRAGON,
        .accuracy = 100,
    ...
    {
        .name = COMPOUND_STRING("Genesungssegen"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_SALT_CURE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Fügt pro Runde Schaden zu.\n"
            "Doppelt gegen Stahl und Wasser."),
        .effect = EFFECT_HIT,
        .power = 40,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_KOWTOW_CLEAVE] =
    {
        .name = COMPOUND_STRING("Fußfallhieb"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_AQUA_STEP] =
    {
        ...
        .description = COMPOUND_STRING(
            "Trifft mit leichten, fließenden Tanz-\n"
    ...
    [MOVE_COLLISION_COURSE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Prähistorischer Aufprall, der\n"
            "bei sehr effektivem Treffer stärker wird."),
    ...
    [MOVE_ELECTRO_DRIFT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Futuristische Elektrizität. Wird\n"
            "stärker bei sehr effektivem Treffer."),
        .effect = EFFECT_COLLISION_COURSE,
        .power = 100,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    [MOVE_GIGATON_HAMMER] =
    {
        .name = COMPOUND_STRING("Gigatonnenhammer"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_BLAZING_TORQUE] =
    {
        .name = COMPOUND_STRING("Feuerantrieb"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_FIRE,
    ...
    [MOVE_WICKED_TORQUE] =
    {
        .name = COMPOUND_STRING("Finsterantrieb"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 80,
        .type = TYPE_DARK,
    ...
    [MOVE_NOXIOUS_TORQUE] =
    {
        .name = COMPOUND_STRING("Giftantrieb"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_POISON,
    ...
    [MOVE_COMBAT_TORQUE] =
    {
        .name = COMPOUND_STRING("Kampfantrieb"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_MAGICAL_TORQUE] =
    {
        .name = COMPOUND_STRING("Magieantrieb"),
        .description = COMPOUND_STRING("---"),
        .effect = EFFECT_HIT,
        .power = 100,
        .type = TYPE_FAIRY,
    ...
    [MOVE_MATCHA_GOTCHA] =
    {
        .name = COMPOUND_STRING("Matcha-Heilung"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_ELECTRO_SHOT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Sammelt Elektrizität und feuert\n"
            "einen Hochspannungsschuss ab."),
        .effect = EFFECT_TWO_TURNS_ATTACK,
        .power = 130,
        .type = TYPE_ELECTRIC,
        .accuracy = 100,
    ...
    {
        .name = COMPOUND_STRING("Brennende Schutzmauer"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_THUNDERCLAP] =
    {
        .name = COMPOUND_STRING("Donnerklatsche"),
        .description = COMPOUND_STRING(
            "Greift zuerst an, wenn der Gegner\n"
    ...
    [MOVE_MIGHTY_CLEAVE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Trifft auch, wenn das Ziel sich schützt."),
        .effect = EFFECT_HIT,
        .power = 95,
        .type = TYPE_ROCK,
        .accuracy = 100,
    ...
    [MOVE_TACHYON_CUTTER] =
    {
        .name = COMPOUND_STRING("Tachyon-Schneider"),
        .description = COMPOUND_STRING(
            "Schleudert Partikelklingen auf\n"
            "das Ziel. Trifft zweimal."),
        .effect = EFFECT_HIT,
        .power = 50,
        .type = TYPE_STEEL,
        .accuracy = 0,
    ...
    [MOVE_HARD_PRESS] =
    {
        .name = COMPOUND_STRING("Harter Druck"),
        .description = sWringOutDescription,
        .effect = EFFECT_POWER_BASED_ON_TARGET_HP,
        .power = 100,
        .type = TYPE_STEEL,
    ...
    [MOVE_SUPERCELL_SLAM] =
    {
        .name = COMPOUND_STRING("Superzellen-Schlag"),
        .description = COMPOUND_STRING(
    ...
    [MOVE_PSYCHIC_NOISE] =
    {
        .name = COMPOUND_STRING("Psycho-Lärm"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Üble Kette"),
        .description = COMPOUND_STRING(
    ...
    {
        .name = COMPOUND_STRING("Tempo-Tempo-Turbo"),
        .description = COMPOUND_STRING(
            "Sammelt Schwung und rammt\n"
            "in den Gegner. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_ALL_OUT_PUMMELING] =
    {
        ...
        .description = COMPOUND_STRING(
            "Rammt eine Energiekugel in\n"
            "das Ziel. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
    ...
    [MOVE_ACID_DOWNPOUR] =
    {
        ...
        .description = COMPOUND_STRING(
            "Versenkt das Ziel in einem\n"
            "Giftsumpf. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_POISON,
        .accuracy = 0,
    ...
    [MOVE_CONTINENTAL_CRUSH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Lässt einen riesigen Felsenberg\n"
            "auf den Gegner fallen. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_ROCK,
        .accuracy = 0,
    ...
    [MOVE_SAVAGE_SPIN_OUT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Spuckt Seidenfäden, um den\n"
            "Gegner zu fesseln. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_BUG,
        .accuracy = 0,
    ...
    [MOVE_NEVER_ENDING_NIGHTMARE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Tief sitzende Grolls fangen\n"
            "das Ziel ein. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_GHOST,
        .accuracy = 0,
    ...
    [MOVE_CORKSCREW_CRASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Dreht sich sehr schnell und rammt\n"
            "das Ziel. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_STEEL,
    ...
    [MOVE_HYDRO_VORTEX] =
    {
        ...
        .description = COMPOUND_STRING(
            "Ein riesiger Strudel verschlingt\n"
            "das Ziel. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_WATER,
    ...
    [MOVE_BLOOM_DOOM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Nutzt Pflanzenenergie, um das\n"
            "Ziel anzugreifen. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_GRASS,
        .accuracy = 0,
    ...
    [MOVE_GIGAVOLT_HAVOC] =
    {
        ...
        .description = COMPOUND_STRING(
            "Trifft den Gegner mit starker\n"
            "Elektrizität. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
    ...
    [MOVE_SHATTERED_PSYCHE] =
    {
        ...
        .description = COMPOUND_STRING(
            ...
            "ihm zu schaden. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_PSYCHIC,
        .accuracy = 0,
    ...
    [MOVE_SUBZERO_SLAMMER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Senkt die Temperatur und friert\n"
            "das Ziel ein. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_ICE,
    ...
    [MOVE_DEVASTATING_DRAKE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Entwickelt Aura und greift\n"
            "das Ziel an. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_DRAGON,
        .accuracy = 0,
    ...
    [MOVE_TWINKLE_TACKLE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Spielt mit dem Ziel in einem\n"
            "charmanten Raum. Stärke variiert."),
        .effect = EFFECT_HIT,
        .power = 1,
        .type = TYPE_FAIRY,
        .accuracy = 0,
    ...
    [MOVE_CATASTROPIKA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Pikachu nutzt maximale Elektrizität\n"
            "und springt auf das Ziel."),
        .effect = EFFECT_HIT,
        .power = 210,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
    ...
    [MOVE_10000000_VOLT_THUNDERBOLT] =
    {
        ...
        .description = COMPOUND_STRING(
            "Kappen-Pikachu entfesselt einen Stromstoß.\n"
            "Hohe Volltrefferquote."),
        .effect = EFFECT_HIT,
        .power = 195,
        .type = TYPE_ELECTRIC,
    ...
    [MOVE_STOKED_SPARKSURFER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Alola-Raichu greift mit voller\n"
            "Kraft an. Führt zu Paralyse."),
        .effect = EFFECT_HIT,
        .power = 175,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Extremer Evoschub"),
        .description = COMPOUND_STRING(
            "Evoli erhält Energie von\n"
            "seinen Freunden. Steigert Werte."),
    ...
    [MOVE_PULVERIZING_PANCAKE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Relaxo bewegt sich energisch\n"
            "und greift mit voller Kraft an."),
        .effect = EFFECT_HIT,
        .power = 210,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_GENESIS_SUPERNOVA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Mew greift mit voller Kraft an.\n"
            "Lädt das Terrain psychisch auf."),
        .effect = EFFECT_HIT,
        .power = 185,
        .type = TYPE_PSYCHIC,
        .accuracy = 0,
    ...
    [MOVE_SINISTER_ARROW_RAID] =
    {
        ...
        .description = COMPOUND_STRING(
            "Silvarro schießt unzählige\n"
            "Pfeile mit voller Kraft."),
        .effect = EFFECT_HIT,
        .power = 180,
        .type = TYPE_GHOST,
        .accuracy = 0,
    ...
    [MOVE_SPLINTERED_STORMSHARDS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Wolwerock greift mit voller\n"
            "Kraft an. Entfernt alle Felder."),
        .effect = EFFECT_ICE_SPINNER,
        .power = 190,
        .type = TYPE_ROCK,
        .accuracy = 0,
    ...
    [MOVE_CLANGOROUS_SOULBLAZE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Grandiras greift mit voller\n"
            "Kraft an. Steigert alle Werte."),
        .effect = EFFECT_HIT,
        .power = 185,
        .type = TYPE_DRAGON,
        .accuracy = 0,
    ...
    [MOVE_GUARDIAN_OF_ALOLA] =
    {
        ...
        .description = COMPOUND_STRING(
            "Das Schutzpatron-Pokémon\n"
            "reduziert die KP des Gegners stark."),
        .effect = EFFECT_FIXED_PERCENT_DAMAGE,
        .power = 1,
        .type = TYPE_FAIRY,
        .accuracy = 0,
    ...
    [MOVE_SEARING_SUNRAZE_SMASH] =
    {
        ...
        .description = COMPOUND_STRING(
            "Solgaleo greift mit voller\n"
            "Kraft an. Ignoriert Fähigkeiten."),
        .effect = EFFECT_HIT,
        .power = 200,
        .type = TYPE_STEEL,
        .accuracy = 0,
    ...
    [MOVE_MAX_FLARE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Feuer-Dynamax-Attacke.\n"
            "Verstärkt 5 Runden die Sonne."),
    ...
    [MOVE_MAX_FLUTTERBY] =
    {
        .name = COMPOUND_STRING("Dyna-Käferflug"),
        .description = COMPOUND_STRING(
            "Käfer-Dynamax-Attacke.\n"
            "Senkt SP. ANGR. der Gegner."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_BUG,
        .accuracy = 0,
    ...
    [MOVE_MAX_LIGHTNING] =
    {
        .name = COMPOUND_STRING("Dyna-Blitz"),
        .description = COMPOUND_STRING(
            "Elektro-Dynamax-Attacke.\n"
            "Erzeugt ein Elektrofeld."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
    ...
    [MOVE_MAX_STRIKE] =
    {
        ...
        .description = COMPOUND_STRING(
            "Normal-Dynamax-Attacke.\n"
            "Senkt INIT. der Gegner."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_MAX_KNUCKLE] =
    {
        .name = COMPOUND_STRING("Dyna-Boxer"),
        .description = COMPOUND_STRING(
            "Kampf-Dynamax-Attacke.\n"
            "Hebt ANGR. des Teams."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_FIGHTING,
    ...
    [MOVE_MAX_PHANTASM] =
    {
        ...
        .description = COMPOUND_STRING(
            "Geist-Dynamax-Attacke.\n"
            "Senkt VERT. der Gegner."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_GHOST,
        .accuracy = 0,
    ...
    [MOVE_MAX_OOZE] =
    {
        .name = COMPOUND_STRING("Dyna-Gift"),
        .description = COMPOUND_STRING(
            "Gift-Dynamax-Attacke.\n"
            "Hebt SP. ANGR. des Teams."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_POISON,
        .accuracy = 0,
    ...
    [MOVE_MAX_GEYSER] =
    {
        ...
        .description = COMPOUND_STRING(
            "Wasser-Dynamax-Attacke.\n"
            "Beschwört 5 Runden Regen."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_WATER,
        .accuracy = 0,
    ...
    [MOVE_MAX_STARFALL] =
    {
        .name = COMPOUND_STRING("Dyna-Sternenfall"),
        .description = COMPOUND_STRING(
            "Fee-Dynamax-Attacke.\n"
            "Erzeugt ein Nebelfeld."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_FAIRY,
        .accuracy = 0,
    ...
    [MOVE_MAX_WYRMWIND] =
    {
        .name = COMPOUND_STRING("Dyna-Drachenwind"),
        .description = COMPOUND_STRING(
            "Drachen-Dynamax-Attacke.\n"
            "Senkt ANGR. der Gegner."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_DRAGON,
        .accuracy = 0,
    ...
    [MOVE_MAX_MINDSTORM] =
    {
        .name = COMPOUND_STRING("Dyna-Psycho"),
        .description = COMPOUND_STRING(
            "Psycho-Dynamax-Attacke.\n"
    ...
    [MOVE_MAX_ROCKFALL] =
    {
        .name = COMPOUND_STRING("Dyna-Steinfall"),
        .description = COMPOUND_STRING(
            "Gesteins-Dynamax-Attacke.\n"
    ...
    [MOVE_MAX_QUAKE] =
    {
        .name = COMPOUND_STRING("Dyna-Beben"),
        .description = COMPOUND_STRING(
            "Boden-Dynamax-Attacke.\n"
            "Hebt SP. VERT. des Teams."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_GROUND,
        .accuracy = 0,
    ...
    [MOVE_MAX_DARKNESS] =
    {
        ...
        .description = COMPOUND_STRING(
            "Unlicht-Dynamax-Attacke.\n"
            "Senkt SP. VERT. der Gegner."),
        .effect = EFFECT_MAX_MOVE,
        .power = 1,
        .type = TYPE_DARK,
        .accuracy = 0,
    ...
    [MOVE_MAX_OVERGROWTH] =
    {
        .name = COMPOUND_STRING("Dyna-Wuchs"),
        .description = COMPOUND_STRING(
            "Pflanzen-Dynamax-Attacke.\n"
            "Erzeugt ein Grasfeld."),
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_GRASS,
        .accuracy = 0,
    ...
    [MOVE_MAX_STEELSPIKE] =
    {
        .name = COMPOUND_STRING("Dyna-Stahlstachel"),
        .description = COMPOUND_STRING(
            "Stahl-Dynamax-Attacke.\n"
            "Hebt VERT. des Teams."),
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_STEEL,
    ...
    {
        .name = COMPOUND_STRING("Giga-Rankenhieb"),
        .description = COMPOUND_STRING(
            "Gigadynamax-Bisaflor-Attacke.\n"
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Kanone"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Turtok-Attacke.\n"
            "Fügt 4 Runden lang Schaden zu."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_WATER,
    ...
    [MOVE_G_MAX_BEFUDDLE] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Verwirrung"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Smettbo-Attacke.\n"
            "Vergiftet, paralysiert oder schläfert ein."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_BUG,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Voltschlag"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Pikachu-Attacke.\n"
            "Lähmt die Gegner."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Goldrausch"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Mauzi-Attacke.\n"
            "Verwirrt und bringt Geld ein."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Chi-Schlag"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Machomei-Attacke.\n"
            "Erhöht die Volltrefferquote."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_FIGHTING,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_TERROR] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Terror"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Gengar-Attacke.\n"
            "Verhindert Flucht der Gegner."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_GHOST,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Schaumexplosion"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Kingler-Attacke.\n"
            "Senkt die Initiative des Gegners stark."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_WATER,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Resonanz"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Lapras-Attacke.\n"
            "Reduziert 5 Runden lang Schaden."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_ICE,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_CUDDLE] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Knuddel"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Evoli-Attacke.\n"
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Auffrischung"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Relaxo-Attacke.\n"
            "Stellt gegessene Beeren wieder her."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_NORMAL,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_MALODOR] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Mief"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Deponitox-Attacke.\n"
    ...
    [MOVE_G_MAX_MELTDOWN] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Schmelze"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Melmetal-Attacke.\n"
            "Verhindert wiederholte Zugnutzung."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_STEEL,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Drumsolo"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Gortrom-Attacke.\n"
            "Ignoriert Fähigkeiten des Ziels."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_GRASS,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_FIREBALL] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Feuerball"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Liberlo-Attacke.\n"
            "Ignoriert Fähigkeiten des Ziels."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_FIRE,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Hydroschuss"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Intelleon-Attacke.\n"
            "Ignoriert Fähigkeiten des Ziels."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_WATER,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Wutwind"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Krarmor-Attacke.\n"
            "Entfernt gegnerische Barrieren."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_FLYING,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_GRAVITAS] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Gravitas"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Maritellit-Attacke.\n"
            "Verändert die Schwerkraft für 5 Runden."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_PSYCHIC,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Felsen"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Drednaw-Attacke.\n"
            "Verstreut scharfe Felsen."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_WATER,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Vulkaloith"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Montecarbo-Attacke.\n"
            "Fügt 4 Runden lang Schaden zu."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_ROCK,
    ...
    [MOVE_G_MAX_TARTNESS] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Säure"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Appletun-Attacke.\n"
            "Senkt die Flinkheit des Gegners."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_GRASS,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Süße"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Schlapfel-Attacke.\n"
            "Heilt Statusprobleme der Verbündeten."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_GRASS,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Sandgrab"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Sanaconda-Attacke.\n"
            "Fängt Gegner im Sandsturm ein."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_GROUND,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Schockwelle"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Riffex-Attacke.\n"
            "Vergiftet oder paralysiert Gegner."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_ELECTRIC,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Feuerwalze"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Infernopod-Attacke.\n"
            "Fängt Gegner in Flammen ein."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_FIRE,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_SMITE] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Zauber"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Silembrim-Attacke.\n"
    ...
    [MOVE_G_MAX_SNOOZE] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Schnarcher"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Olangaar-Attacke.\n"
            "Versetzt Gegner in Schlaf."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_DARK,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_FINALE] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Finale"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Mortipot-Attacke.\n"
            "Heilt die KP der Verbündeten."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_FAIRY,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Stahlwelle"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Copperajah-Attacke.\n"
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Reduktion"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Duraludon-Attacke.\n"
            "Reduziert die AP des Ziels."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_DRAGON,
        .accuracy = 0,
    ...
    [MOVE_G_MAX_ONE_BLOW] =
    {
        .name = COMPOUND_STRING("Giga-Dyna-Einzelhieb"),
        .description = COMPOUND_STRING(
            "Giga-Dyna-Wulaosu-Fokussierter-Stil-Attacke.\n"
            "Durchdringt Schutz."),    //ANIM TODO
        .effect = EFFECT_MAX_MOVE,
        .power = 10,
        .type = TYPE_DARK,
        .accuracy = 0,
    ...
    {
        .name = COMPOUND_STRING("Giga-Dyna-Fließender-Stil"),
