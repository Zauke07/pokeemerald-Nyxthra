...
static void DisplayTrainerInfoOnCard(u8 flags, u8 trainerTourneyId)
{
    ...
    sInfoCard->spriteIds[arrId] = CreateTrainerPicSprite(gSaveBlock2Ptr->playerStyles[0], TRUE, x + 48, y + 64, palSlot + 12, TAG_NONE);
...
static void DisplayMatchInfoOnCard(u8 flags, u8 matchNo)
{
    ...
    sInfoCard->spriteIds[arrId] = CreateTrainerPicSprite(gSaveBlock2Ptr->playerStyles[0], TRUE, x + 48, y + 88, palSlot + 12, TAG_NONE);
    ...
    sInfoCard->spriteIds[1 + arrId] = CreateTrainerPicSprite(gSaveBlock2Ptr->playerStyles[0], TRUE, x + 192, y + 88, palSlot + 13, TAG_NONE);
