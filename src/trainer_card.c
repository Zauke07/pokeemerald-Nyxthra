...
static const u16 sHoennTrainerCardBadges_Pal[]   = INCGFX_U16("graphics/trainer_card/palletes/badges.pal", ".gbapal");
...
static void SetPlayerCardData(struct TrainerCard *trainerCard, u8 cardType)
{
    ...
    trainerCard->style = gSaveBlock2Ptr->playerStyles[0]; // Änderung: `playerGender` → `playerStyle`
...
static u8 SetCardBgsAndPals(void)
{
    ...
    {
    case 0:
        LoadBgTiles(3, sData->badgeTiles, 0x80 * NUM_BADGES, 0);
        break;
    case 1:
