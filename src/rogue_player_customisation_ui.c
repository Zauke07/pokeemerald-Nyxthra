...
static const u8 sText_RoguePlayerUITitle_Main[] = _("Spieler Outfit");
static const u8 sText_RoguePlayerUITitle_EditAppearance[] = _("Aussehen");
static const u8 sText_RoguePlayerUITitle_EditPrimary[] = _("Primärfarbe");
static const u8 sText_RoguePlayerUITitle_EditSecondary[] = _("Sekundärfarbe");
...
static const u8 sText_RoguePlayerUIEditFast[] = _("Schnell");
static const u8 sText_RoguePlayerUIEditAccurate[] = _("Genau");
static const u8 sText_RoguePlayerUIEditPrompt[] = _("{R_BUTTON} Modus: {STR_VAR_1}");
static const u8 sText_RoguePlayerMissingBacksprites[] = _("{COLOR LIGHT_BLUE}{SHADOW LIGHT_GRAY}(Fehlende Rücksprites)");
