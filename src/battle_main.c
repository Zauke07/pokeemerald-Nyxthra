...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_COLLECTOR] = { _("Sammler"), 15, BALL_PREMIER },
    ...
    [TRAINER_CLASS_HEX_MANIAC] = { _("Hexenmeister"), 6 },
    ...
    [TRAINER_CLASS_TUBER_F] = { _("Kleinkind"), 1 },
    [TRAINER_CLASS_TUBER_M] = { _("Kleinkind"), 1 },
    [TRAINER_CLASS_LADY] = { _("Dame"), 50 },
    ...
    [TRAINER_CLASS_KINDLER] = { _("Feuerspucker"), 8 },
    ...
    [TRAINER_CLASS_SR_AND_JR] = { _("Sen und Jun"), 4 },
    ...
    [TRAINER_CLASS_NINJA_BOY] = { _("Ninja-Junge"), 3 },
    [TRAINER_CLASS_BATTLE_GIRL] = { _("Kampfmädchen"), 6 },
    [TRAINER_CLASS_PARASOL_LADY] = { _("Parasol Lady"), 10 },
    [TRAINER_CLASS_SWIMMER_F] = { _("Schwimmerin♀"), 2, BALL_DIVE },
    [TRAINER_CLASS_TWINS] = { _("Zwillinge"), 3 },
    ...
    [TRAINER_CLASS_LASS] = { _("Mädchen"), 4 },
    [TRAINER_CLASS_YOUNG_COUPLE] = { _("Junges paar"), 8 },
    ...
    [TRAINER_CLASS_LASS_FRLG] =            { _("Mädchen"), 4 },
    ...
    [TRAINER_CLASS_TAMER_FRLG] =           { _("Bändiger"), 10 },
    ...
    [TRAINER_CLASS_TWINS_FRLG] =           { _("Zwillinge"), 3 },
    [TRAINER_CLASS_COOL_COUPLE_FRLG] =     { _("Cooles Paar"), 6 },
    [TRAINER_CLASS_YOUNG_COUPLE_FRLG] =    { _("Junges Paar"), 7 },
    [TRAINER_CLASS_CRUSH_KIN_FRLG] =       { _("Starke Sippe"), 6 },
    ...
    [TRAINER_CLASS_CRUSH_GIRL_FRLG] =      { _("Power-Girl"), 6 },
    [TRAINER_CLASS_TUBER_FRLG] =           { _("Kleinkind"), 1 },
    ...
    [TRAINER_CLASS_LADY_FRLG] =            { _("Dame"), 50 },
...
u8 CreateNPCTrainerPartyFromTrainer(struct Pokemon *party, const struct Trainer *trainer, bool32 halfTeam, u32 battleTypeFlags)
{
                                                                        ...
                                                                        | BATTLE_TYPE_TRAINER_HILL)))
    {
        ...
        for (s32 i = 0; i < monsCount; i++)
        {
            ...
            trainerSpecies = Randomizer_GetSpecies(partyData[monIndex].species, RANDOMIZER_MODE_TRAINER);
            ...
            trainerItem = partyData[monIndex].heldItem;
            if (trainerItem != ITEM_NONE)
                trainerItem = Randomizer_GetItem(trainerItem, RANDOMIZER_MODE_TRAINER);
            if (trainerItem >= ITEMS_COUNT)
                trainerItem = ITEM_NONE;
            SetMonData(&party[i], MON_DATA_HELD_ITEM, &trainerItem);
            ...
            if (partyData[monIndex].ability != ABILITY_NONE && trainerSpecies == partyData[monIndex].species)
            {
