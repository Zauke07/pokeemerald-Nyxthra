...
const u16 sEvilTeam_Palette[] = INCGFX_U16("graphics/battle_transitions/evil_team.pal", ".gbapal");
const u32 sTeamAqua_Tileset[] = INCGFX_U32("graphics/battle_transitions/team_aqua.png", ".4bpp.smol");
const u32 sTeamAqua_Tilemap[] = INCGFX_U32("graphics/battle_transitions/team_aqua.bin", ".smolTM");
...
static bool8 Mugshot_SetGfx(struct Task *task)
{
    ...
    // Nutzt die neuen Expansion-Konstanten für den Gegner
    LoadPalette(sOpponentMugshotsPals[mugshotColor], BG_PLTT_ID(15), PLTT_SIZE_4BPP);
    
    // Nutzt dein Nyxthra-Style-System für den Spieler
