...
STATIC_ASSERT(sizeof(struct SaveBlock2) <= SECTOR_DATA_SIZE ? 0 : SECTOR_DATA_SIZE - sizeof(struct SaveBlock2), SaveBlock2FreeSpace);
STATIC_ASSERT(sizeof(struct SaveBlock1) <= SECTOR_DATA_SIZE * (SECTOR_ID_SAVEBLOCK1_END - SECTOR_ID_SAVEBLOCK1_START + 1) ? 0 : (SECTOR_DATA_SIZE * (SECTOR_ID_SAVEBLOCK1_END - SECTOR_ID_SAVEBLOCK1_START + 1)) - sizeof(struct SaveBlock1), SaveBlock1FreeSpace);
