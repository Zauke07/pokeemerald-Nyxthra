...
const u8 gText_SizeSlash[] = _("Größe /");
const u8 gText_FirmSlash[] = _("Härte /");
...
const u8 gText_Defense[] = _("Verteidigung");
const u8 gText_Speed[] = _("Initiative");
const u8 gText_SpAtk[] = _("Spez. Angriff");
const u8 gText_SpDef[] = _("Spez. Verteidigung");
...
const u8 gText_NormanMatchCallDesc[] = _("Verlässlicher");
