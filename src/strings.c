...
const u8 gText_MainMenuMysteryEvents[] = _("GEHEIMES EVENT");
const u8 gText_WirelessNotConnected[] = _("The Wireless Adapter is not\nconnected.");
const u8 gText_MysteryGiftCantUse[] = _("GEHEIMGESCHEHEN can't be used while\nthe Wireless Adapter is attached.");
const u8 gText_MysteryEventsCantUse[] = _("GEHEIMES EVENT can't be used while\nthe Wireless Adapter is attached.");
...
const u8 gText_PokeBallsPocket[] = _("POKé Bälle");
