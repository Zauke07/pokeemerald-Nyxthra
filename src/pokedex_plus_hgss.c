        ...
        for (i = 0; i <= 10; i++)
        {
            ...
            else
            {
                ...
                if (sPokedexView->pokedexList[entryNum].seen)
                {
                    ...
                    CreateMonName(sPokedexView->pokedexList[entryNum].dexNum, entryNum, MON_LIST_X + 5, i * 2);
                }
                else
                {
                    CreateMonDexNum(entryNum, MON_LIST_X+1, i * 2, ignored);
                    CreateCaughtBall(FALSE, MON_LIST_X, i * 2, ignored);
                    CreateMonName(0, entryNum, MON_LIST_X + 5, i * 2);
                }
            }
            entryNum++;
        }
    ...
    case 1: // Up
        ...
        else
        {
            ...
            if (sPokedexView->pokedexList[entryNum].seen)
            {
                ...
                CreateMonName(sPokedexView->pokedexList[entryNum].dexNum, entryNum, MON_LIST_X + 5, sPokedexView->listVOffset * 2);
            }
            else
            {
                CreateMonDexNum(entryNum, MON_LIST_X+1, sPokedexView->listVOffset * 2, ignored);
                CreateCaughtBall(FALSE, MON_LIST_X, sPokedexView->listVOffset * 2, ignored);
                CreateMonName(0, entryNum, MON_LIST_X + 5, sPokedexView->listVOffset * 2);
            }
        }
        break;
    case 2: // Down
        ...
        else
        {
            ...
            if (sPokedexView->pokedexList[entryNum].seen)
            {
                ...
                CreateMonName(sPokedexView->pokedexList[entryNum].dexNum, entryNum, MON_LIST_X + 5, vOffset * 2);
            }
            else
            {
                CreateMonDexNum(entryNum, MON_LIST_X+1, vOffset * 2, ignored);
                CreateCaughtBall(FALSE, MON_LIST_X, vOffset * 2, ignored);
                CreateMonName(0, entryNum, MON_LIST_X + 5, vOffset * 2);
            }
        }
        break;
    }
