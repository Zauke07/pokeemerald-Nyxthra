...
static const u8 gText_PkmnIsSelected[] = _("{} ist ausgewählt.");
...
static const struct StorageMessage sMessages[] =
{
    ...
    [MSG_PICK_A_WALLPAPER]     = {COMPOUND_STRING("Wähle das Hintergrundbild."),        MSG_VAR_NONE},
    ...
    [MSG_BYE_BYE]              = {COMPOUND_STRING("Tschüss, {DYNAMIC 0}!"),      MSG_VAR_RELEASE_MON_3},
    ...
    [MSG_CANT_RELEASE_EGG]     = {COMPOUND_STRING("Du kannst kein EI freilassen."),  MSG_VAR_NONE},
    [MSG_CONTINUE_BOX]         = {COMPOUND_STRING("BOX-Vorgänge fortsetzen?"),   MSG_VAR_NONE},
    [MSG_CAME_BACK]            = {COMPOUND_STRING("{DYNAMIC 0} ist zurückgekommen!"),     MSG_VAR_MON_NAME_1},
    [MSG_WORRIED]              = {COMPOUND_STRING("War es besorgt um dich?"),  MSG_VAR_NONE},
    [MSG_SURPRISE]             = {COMPOUND_STRING("… … … … !"),                  MSG_VAR_NONE},
    [MSG_PLEASE_REMOVE_MAIL]   = {COMPOUND_STRING("Bitte entferne das MAIL."),    MSG_VAR_NONE},
    [MSG_IS_SELECTED2]         = {gText_PkmnIsSelected,                          MSG_VAR_ITEM_NAME},
    [MSG_GIVE_TO_MON]          = {COMPOUND_STRING("GIB einem POKéMON?"),         MSG_VAR_NONE},
    [MSG_PLACED_IN_BAG]        = {COMPOUND_STRING("Item wurde in die TASCHEN gelegt."),    MSG_VAR_ITEM_NAME},
    [MSG_BAG_FULL]             = {COMPOUND_STRING("Die TASCHEN sind voll."),           MSG_VAR_NONE},
    [MSG_PUT_IN_BAG]           = {COMPOUND_STRING("Dieses Item in die TASCHEN legen?"),  MSG_VAR_NONE},
...
static const u8 gPCText_Give[] = _("Gebe");
...
static const u8 *const sMenuTexts[] =
{
    ...
    [MENU_PLACE]      = COMPOUND_STRING("Platzieren"),
    ...
    [MENU_SCENERY_1]  = COMPOUND_STRING("Szenerie 1"),
    [MENU_SCENERY_2]  = COMPOUND_STRING("Szenerie 2"),
    [MENU_SCENERY_3]  = COMPOUND_STRING("Szenerie 3"),
    ...
    [MENU_CRAG]       = COMPOUND_STRING("Fels"),
