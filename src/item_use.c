...
static const u8 sText_CantThrowPokeBall_TwoMons[] = _("Kann keinen Ball werfen!\nEs gibt zwei Pokémon da draußen!\p");
static const u8 sText_CantThrowPokeBall_SemiInvulnerable[] = _("Kann keinen Ball werfen!\nEs ist kein Pokémon in Sicht!\p");
static const u8 sText_CantThrowPokeBall_Disabled[] = _("Pokébälle können derzeit nicht\nverwendet werden!\p");
