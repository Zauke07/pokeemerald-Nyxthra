...
const struct Berry gBerries[] =
{
    [ITEM_CHERI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Blüht mit zierlichen, hübschen Blüten."),
        .description2 = COMPOUND_STRING("Die leuchtend rote Beere ist scharf."),
    ...
    [ITEM_CHESTO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 20),
        .minYield = YIELD_RATE(2, 2, 4, 4),
        .description1 = COMPOUND_STRING("Die dicke Schale und das Fruchtfleisch"),
        .description2 = COMPOUND_STRING("sind sehr zäh und trocken im Geschmack."),
        .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_PECHA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 20),
        .minYield = YIELD_RATE(2, 2, 4, 4),
        .description1 = COMPOUND_STRING("Sehr süß und lecker."),
    ...
    [ITEM_RAWST_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 20),
        .minYield = YIELD_RATE(2, 2, 4, 4),
        .description1 = COMPOUND_STRING("Wenn die Blätter lang und lockig sind,"),
        .description2 = COMPOUND_STRING("schmeckt die Beere sehr bitter."),
        .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_ASPEAR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 20),
        .minYield = YIELD_RATE(2, 2, 4, 4),
        .description1 = COMPOUND_STRING("Die harte Beere ist reich an Saft."),
        .description2 = COMPOUND_STRING("Sie ist ziemlich sauer."),
        .growthDuration = GROWTH_DURATION(12, 12, 18, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_LEPPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Wächst langsamer als andere Beeren."),
        .description2 = COMPOUND_STRING("Je kleiner die Beere, desto leckerer."),
    ...
    [ITEM_ORAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 20),
        .minYield = YIELD_RATE(2, 2, 4, 4),
        .description1 = COMPOUND_STRING("Eine merkwürdige Beere mit gemischtem"),
        .description2 = COMPOUND_STRING("Geschmack. Wächst in einem halben Tag."),
    ...
    [ITEM_PERSIM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 20),
        .minYield = YIELD_RATE(2, 2, 4, 4),
        .description1 = COMPOUND_STRING("Liebt Sonnenlicht. Die Beere wird"),
        .description2 = COMPOUND_STRING("in der Sonne leuchtend bunt."),
        .growthDuration = GROWTH_DURATION(12, 16, 24, 24, 16, 24),
        .spicy = 10,
        .dry = 10,
        .sweet = 10,
    ...
    [ITEM_LUM_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Langsam wachsend. Mit liebevoller"),
        .description2 = COMPOUND_STRING("Pflege trägt sie vielleicht zwei."),
    ...
    [ITEM_SITRUS_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Mit Oran verwandt. Die große Beere"),
        .description2 = COMPOUND_STRING("hat einen ausgewogenen Geschmack."),
    ...
    [ITEM_FIGY_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Die angebissen wirkende Beere"),
        .description2 = COMPOUND_STRING("ist voll scharfer Substanzen."),
    ...
    [ITEM_WIKI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 15),
        .minYield = YIELD_RATE(2, 1, 3, 3),
        .description1 = COMPOUND_STRING("Die Beere soll bucklig geworden sein,"),
        .description2 = COMPOUND_STRING("damit Pokémon sie besser halten."),
        .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_MAGO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 15),
        .minYield = YIELD_RATE(2, 1, 3, 3),
        .description1 = COMPOUND_STRING("Die Beere biegt sich beim Wachsen."),
        .description2 = COMPOUND_STRING("Je gebogener, desto süßer und leckerer."),
        .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_AGUAV_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 15),
        .minYield = YIELD_RATE(2, 1, 3, 3),
        .description1 = COMPOUND_STRING("Die Blüte ist zierlich. Sie kann"),
        .description2 = COMPOUND_STRING("selten auch ohne Licht wachsen."),
        .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_IAPAPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(3, 5, 15, 15),
        .minYield = YIELD_RATE(2, 1, 3, 3),
        .description1 = COMPOUND_STRING("Die Beere ist sehr groß und sauer."),
        .description2 = COMPOUND_STRING("Sie braucht mindestens einen Tag."),
        .growthDuration = GROWTH_DURATION(24, 20, 30, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_RAZZ_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Die rote Beere ist leicht scharf."),
        .description2 = COMPOUND_STRING("Sie wächst in nur vier Stunden."),
    ...
    [ITEM_BLUK_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 20),
        .minYield = YIELD_RATE(3, 2, 3, 4),
        .description1 = COMPOUND_STRING("Die Beere ist außen blau, aber"),
        .description2 = COMPOUND_STRING("ihr Saft schwärzt den Mund."),
        .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
        .spicy = 0,
        .dry = 10,
        .sweet = 10,
    ...
    [ITEM_NANAB_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 20),
        .minYield = YIELD_RATE(3, 2, 3, 4),
        .description1 = COMPOUND_STRING("Die siebte weltweit entdeckte Beere."),
        .description2 = COMPOUND_STRING("Sie ist sehr süß."),
        .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_WEPEAR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 20),
        .minYield = YIELD_RATE(3, 2, 3, 4),
        .description1 = COMPOUND_STRING("Die Blüte ist klein und weiß. Sie"),
        .description2 = COMPOUND_STRING("hat bitter-sauren Mischgeschmack."),
        .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_PINAP_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 10, 15, 20),
        .minYield = YIELD_RATE(3, 2, 3, 4),
        .description1 = COMPOUND_STRING("Anfällig gegen Wind und Kälte."),
        .description2 = COMPOUND_STRING("Fruchtfleisch scharf, Schale sauer."),
        .growthDuration = GROWTH_DURATION(4, 8, 12, 24, 16, 24),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_POMEG_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Egal wie viel gegossen wird,"),
        .description2 = COMPOUND_STRING("sie trägt nur bis zu sechs Beeren."),
    ...
    [ITEM_KELPSY_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 20, 26),
        .minYield = YIELD_RATE(2, 1, 1, 2),
        .description1 = COMPOUND_STRING("Eine seltene, wurzelartige Sorte."),
        .description2 = COMPOUND_STRING("Treibt eine sehr große Blüte."),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_QUALOT_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 20, 26),
        .minYield = YIELD_RATE(2, 1, 1, 2),
        .description1 = COMPOUND_STRING("Liebt Wasser. Gedeiht sogar an"),
        .description2 = COMPOUND_STRING("Orten mit ständigem Regen."),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 10,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_HONDEW_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 20, 26),
        .minYield = YIELD_RATE(2, 1, 1, 2),
        .description1 = COMPOUND_STRING("Eine sehr wertvolle und seltene"),
        .description2 = COMPOUND_STRING("Beere. Sie ist sehr lecker."),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 10,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_GREPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(6, 5, 20, 26),
        .minYield = YIELD_RATE(2, 1, 1, 2),
        .description1 = COMPOUND_STRING("Trotz Weichheit und runder Form"),
        .description2 = COMPOUND_STRING("ist die Beere unvorstellbar sauer."),
        .growthDuration = GROWTH_DURATION(12, 32, 48, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 10,
    ...
    [ITEM_TAMATO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(2, 1, 1, 2),
        .description1 = COMPOUND_STRING("Die Beere ist unglaublich scharf."),
        .description2 = COMPOUND_STRING("Ihr Wachstum dauert einige Zeit."),
        .growthDuration = GROWTH_DURATION(24, 32, 48, 48, 32, 48),
        .spicy = 20,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_CORNN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(2, 2, 3, 3),
        .description1 = COMPOUND_STRING("Eine Beere aus alten Zeiten."),
        .description2 = COMPOUND_STRING("Wächst besser wenn viele gepflanzt."),
    ...
    [ITEM_MAGOST_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(4, 10, 15, 15),
        .minYield = YIELD_RATE(2, 2, 3, 3),
        .description1 = COMPOUND_STRING("Eine Beere, bekannt für ihren"),
        .description2 = COMPOUND_STRING("ausgewogenen, feinen Geschmack."),
        .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 20,
    ...
    [ITEM_RABUTA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(4, 10, 15, 15),
        .minYield = YIELD_RATE(2, 2, 3, 3),
        .description1 = COMPOUND_STRING("Eine seltene, borstige Sorte."),
        .description2 = COMPOUND_STRING("Sie ist ziemlich bitter."),
        .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_NOMEL_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(4, 10, 15, 15),
        .minYield = YIELD_RATE(2, 2, 3, 3),
        .description1 = COMPOUND_STRING("Sehr sauer. Ein Biss und man"),
        .description2 = COMPOUND_STRING("schmeckt drei Tage lang nichts mehr."),
        .growthDuration = GROWTH_DURATION(24, 24, 36, 24, 16, 24),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_SPELON_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Die leuchtend rote Beere ist scharf."),
        .description2 = COMPOUND_STRING("Warzen sondern scharfe Stoffe ab."),
    ...
    [ITEM_PAMTRE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Treibt irgendwo auf dem Meer."),
        .description2 = COMPOUND_STRING("Es heißt, sie wächst woanders."),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 0,
        .dry = 40,
        .sweet = 10,
    ...
    [ITEM_WATMEL_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 15, 15, 15),
        .minYield = YIELD_RATE(1, 2, 3, 3),
        .description1 = COMPOUND_STRING("Eine riesige Beere, manche über"),
        .description2 = COMPOUND_STRING("50 cm groß. Extrem süß."),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 40,
    ...
    [ITEM_DURIN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 15, 15, 15),
        .minYield = YIELD_RATE(1, 3, 3, 3),
        .description1 = COMPOUND_STRING("Schon der Anblick macht bitter."),
        .description2 = COMPOUND_STRING("Niemand hat sie je roh gegessen."),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_BELUE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 15, 15, 15),
        .minYield = YIELD_RATE(1, 2, 3, 3),
        .description1 = COMPOUND_STRING("Sie glänzt und sieht lecker aus,"),
        .description2 = COMPOUND_STRING("ist aber sehr sauer. Braucht Zeit."),
        .growthDuration = GROWTH_DURATION(72, 60, 90, 24, 16, 24),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_CHILAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Sie kann zu einer Pfeife geformt"),
        .description2 = COMPOUND_STRING("werden, die seltsame Töne macht."),
    ...
    [ITEM_OCCA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Soll früher in den Tropen gewachsen"),
        .description2 = COMPOUND_STRING("sein. Besitzt intensive Schärfe."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 15,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_PASSHO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Ihr Fleisch ist voller kleiner"),
        .description2 = COMPOUND_STRING("Bläschen, die ihr Auftrieb geben."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 15,
        .sweet = 0,
    ...
    [ITEM_WACAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Energie aus Blitzen lässt diese"),
        .description2 = COMPOUND_STRING("Beere groß und reichhaltig werden."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 15,
    ...
    [ITEM_RINDO_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Hat gemüseartigen Geschmack, ist"),
        .description2 = COMPOUND_STRING("aber reich an gesunden Ballaststoffen."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_YACHE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Hat einen erfrischend trockenen"),
        .description2 = COMPOUND_STRING("Geschmack. Kühl am besten genießen."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_CHOPLE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Enthält eine wärmeerzeugende"),
        .description2 = COMPOUND_STRING("Substanz. Wärmt selbst kalte Herzen."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 15,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_KEBIA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Außen leuchtend grün, innen"),
        .description2 = COMPOUND_STRING("schwarz gefärbtes Fruchtfleisch."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 15,
        .sweet = 0,
    ...
    [ITEM_SHUCA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Das süße Fruchtfleisch hat einen"),
        .description2 = COMPOUND_STRING("leicht würzigen, aromatischen Biss."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 10,
        .dry = 0,
        .sweet = 15,
    ...
    [ITEM_COBA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Soll eine Kreuzung aus zwei"),
        .description2 = COMPOUND_STRING("weit entfernten Beeren sein."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_PAYAPA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Soll Gefühle wahrnehmen können."),
        .description2 = COMPOUND_STRING("Bläht sich auf, wenn man naht."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_TANGA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Treibt eine Blüte an der Spitze,"),
        .description2 = COMPOUND_STRING("die Käfer-Pokémon mit Fäden lockt."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 20,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_CHARTI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Oft für Eingelegtes verwendet"),
        .description2 = COMPOUND_STRING("wegen des trockenen Geschmacks."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 10,
        .dry = 20,
        .sweet = 0,
    ...
    [ITEM_KASIB_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Alte Überlieferungen: Sie hat eine"),
        .description2 = COMPOUND_STRING("seltsame Kraft. Gilt als Glücksbringer."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 10,
        .sweet = 20,
    ...
    [ITEM_HABAN_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Weniger bitter, wenn man sie"),
        .description2 = COMPOUND_STRING("kocht. Ergibt gute Konfiture."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 10,
    ...
    [ITEM_COLBUR_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Kleine Haken auf der Oberfläche"),
        .description2 = COMPOUND_STRING("heften sich an Pokémon an."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_BABIRI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("Sehr zäh mit starkem Geschmack."),
        .description2 = COMPOUND_STRING("Wurde früher als Medizin genutzt."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 25,
        .dry = 10,
        .sweet = 0,
    ...
    [ITEM_ROSELI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(5, 5, 20, 10),
        .minYield = YIELD_RATE(2, 1, 3, 2),
        .description1 = COMPOUND_STRING("In der Natur wachsen sie in"),
        .description2 = COMPOUND_STRING("weiten Ringen aus unbekanntem Grund."),
        .growthDuration = GROWTH_DURATION(84, 72, 108, 48, 32, 48),
        .spicy = 0,
        .dry = 0,
        .sweet = 25,
    ...
    [ITEM_LIECHI_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Eine mysteriöse Beere. Sie soll"),
        .description2 = COMPOUND_STRING("die Kraft des Meeres enthalten."),
    ...
    [ITEM_GANLON_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(1, 1, 1, 2),
        .description1 = COMPOUND_STRING("Eine mysteriöse Beere. Sie soll"),
        .description2 = COMPOUND_STRING("die Kraft des Landes enthalten."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 0,
        .dry = 40,
        .sweet = 0,
    ...
    [ITEM_SALAC_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(1, 1, 1, 2),
        .description1 = COMPOUND_STRING("Eine mysteriöse Beere. Sie soll"),
        .description2 = COMPOUND_STRING("die Kraft des Himmels enthalten."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 0,
        .dry = 0,
        .sweet = 40,
    ...
    [ITEM_PETAYA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(1, 1, 1, 2),
        .description1 = COMPOUND_STRING("Eine mysteriöse Beere. Sie soll"),
        .description2 = COMPOUND_STRING("die Kraft aller Wesen enthalten."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 40,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_APICOT_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 10, 13),
        .minYield = YIELD_RATE(1, 1, 1, 2),
        .description1 = COMPOUND_STRING("Eine sehr rätselhafte Beere."),
        .description2 = COMPOUND_STRING("Niemand weiß, wozu sie dient."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 0,
        .dry = 40,
        .sweet = 0,
    ...
    [ITEM_LANSAT_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .description1 = COMPOUND_STRING("Gilt als legendäre Beere."),
        .description2 = COMPOUND_STRING("Das Tragen soll Freude bringen."),
    ...
    [ITEM_STARF_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 5, 7),
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("So stark, dass sie am Weltrand"),
        .description2 = COMPOUND_STRING("aufgegeben wurde. Gilt als Illusion."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 120, 48, 72),
        .spicy = 10,
        .dry = 10,
        .sweet = 10,
    ...
    [ITEM_ENIGMA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("Eine vollkommen rätselhafte Beere."),
        .description2 = COMPOUND_STRING("Sie soll Sternenkraft besitzen."),
    ...
    [ITEM_MICLE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 5, 13),
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("Lässt andere Speisen, die"),
        .description2 = COMPOUND_STRING("gleichzeitig gegessen, süß wirken."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 0,
        .dry = 40,
        .sweet = 10,
    ...
    [ITEM_CUSTAP_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 5, 13),
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("Das Fruchtfleisch unter der"),
        .description2 = COMPOUND_STRING("Schale ist süß und cremig weich."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 0,
        .dry = 0,
        .sweet = 40,
    ...
    [ITEM_JABOCA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 5, 13),
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("Die Früchtchen, aus denen sie"),
        .description2 = COMPOUND_STRING("besteht, platzen bei Erschütterung."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 0,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_ROWAP_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 5, 13),
        .minYield = YIELD_RATE(1, 1, 1, 1),
        .description1 = COMPOUND_STRING("Menschen schnitten früher Kreisel"),
        .description2 = COMPOUND_STRING("aus dieser Beere als Spielzeug."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 72, 48, 72),
        .spicy = 10,
        .dry = 0,
        .sweet = 0,
    ...
    [ITEM_KEE_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 10, 13),
        .minYield = YIELD_RATE(1, 1, 1, 2),
        .description1 = COMPOUND_STRING("Zunächst unglaublich scharf,"),
        .description2 = COMPOUND_STRING("dann extrem bitter im Abgang."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 30,
        .dry = 30,
        .sweet = 10,
    ...
    [ITEM_MARANGA_BERRY - FIRST_BERRY_INDEX] =
    {
        ...
        .maxYield = YIELD_RATE(2, 5, 10, 13),
        .minYield = YIELD_RATE(1, 1, 1, 2),
        .description1 = COMPOUND_STRING("Die Außenseite ist sehr bitter,"),
        .description2 = COMPOUND_STRING("das Innere süß wie ein Getränk."),
        .growthDuration = GROWTH_DURATION(96, 96, 144, 96, 48, 72),
        .spicy = 10,
        .dry = 10,
        .sweet = 30,
