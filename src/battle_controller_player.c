...
enum TrainerPicID LinkPlayerGetTrainerPicId(u32 multiplayerId)
{
    ...
    {
        // Für dich selbst: Nutze dein individuelles Style-System
...
// Deine Custom-Funktion für die 20 Styles - Namen an RHH 1.15.0 angepasst
...
static void PlayerHandleDrawTrainerPic(enum BattlerId battler)
{
    ...
    if (gBattleTypeFlags & BATTLE_TYPE_INGAME_PARTNER && gPartnerTrainerId < TRAINER_PARTNER(PARTNER_NONE))
    {
        trainerPicId = gSaveBlock2Ptr->playerStyles[0];
        isFrontPic = TRUE;
    }
