...
static void SafariHandleDrawTrainerPic(u32 battler)
{
    u32 trainerPicId = gSaveBlock2Ptr->playerStyles[0];
...
static void SafariHandleChooseAction(u32 battler)
{
    ...
    BreakStringAutomatic(gDisplayedStringBattle, WindowWidthPx(B_WIN_ACTION_PROMPT), 2, FONT_NORMAL, HIDE_SCROLL_PROMPT);
